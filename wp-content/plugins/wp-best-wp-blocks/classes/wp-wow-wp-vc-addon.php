...
if (class_exists('WOW_VC_Helpers')) {
	if (!class_exists('wowVC_Addons_WOW_Blocks_Init')) {

	class wowVC_Addons_WOW_Blocks_Init extends WOW_VC_Helpers {
...
new wowVC_Addons_WOW_Blocks_Init;
}