...
!function (t, e, i, s) {
  ...
  n.Defaults = {
    ...
    if (i.loop) s = this._clones.length / 2 + this._items.length - 1;else if (i.autoWidth || i.merge) for (; s - o > 1;) {
    ...
    return this.each(function () {
      ...
      o || (o = new n(this, "object" == _typeof(e) && e), s.data("owl.vccarousel", o), t.each(["next", "prev", "to", "destroy", "refresh", "replace", "add", "remove"], function (e, i) {
        o.register({
          type: n.Type.Event,
          name: i
