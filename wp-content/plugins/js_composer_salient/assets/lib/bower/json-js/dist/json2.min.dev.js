...
"object" != (typeof JSON === "undefined" ? "undefined" : _typeof(JSON)) && (JSON = {}), function () {
  ...
  function str(key, holder) {
    ...
    switch (value && "object" == _typeof(value) && "function" == typeof value.toJSON && (value = value.toJSON(key)), "function" == typeof rep && (value = rep.call(holder, key, value)), _typeof(value)) {
      case "string":
        return quote(value);
      ...
      case "object":
        ...
        if (rep && "object" == _typeof(rep)) for (length = rep.length, i = 0; i < length; i += 1) {
  ...
  "function" != typeof JSON.stringify && (JSON.stringify = function (value, replacer, space) {
    var i;
    if (indent = gap = "", "number" == typeof space) for (i = 0; i < space; i += 1) {
      indent += " ";
    } else "string" == typeof space && (indent = space);
    if ((rep = replacer) && "function" != typeof replacer && ("object" != _typeof(replacer) || "number" != typeof replacer.length)) throw new Error("JSON.stringify");
    return str("", {
      "": value
    });
    ...
    function walk(holder, key) {
      var k,
          v,
          value = holder[key];
      if (value && "object" == _typeof(value)) for (k in value) {
