...
(function (window, document, undefined) {
   ...
   */
  var absPos = function absPos(element) {
  ...
  var ProgressCircle = function ProgressCircle(params) {
  ...
  var Circle = function Circle(params) {
    ...
    this.outerRadius = this.innerRadius + this.arcWidth; // If the info listener is not registered, then don't calculate
    // the related coordinates

    if (!this.infoListener) return; // calculate the info-line turning points
    ...
    style.left = this.infoLineEndX + absPos(this.canvas)[0] + 'px'; // style.top will be calculated in the `drawInfo` method. Since
