...
window.vc || (window.vc = {}), function () {
...
}(window.jQuery), window.vc || (window.vc = {}), function () {
...
}(), window._.isUndefined(window.vc) && (window.vc = {}), function (vc, _, $) {
  "use strict";
  ...
  void 0 === window.vc && (window.vc = {}), window.vc.ShortcodesBuilder = function (models) {
    ...
    build: function build(shortcodes, callback) {
      this.ajax({
    ...
    buildFromTemplate: function buildFromTemplate(html, data) {
    ...
    _renderBlockCallback: function _renderBlockCallback(model) {
      var $html = $(model);
    ...
    renderShortcode: function renderShortcode($html, model) {
      var update_inner,
    ...
    notifyParent: function notifyParent(parent) {
      parent = window.vc.shortcodes.get(parent);
      parent && parent.view && parent.view.changed();
    },
    remove: function remove() {},
    _getContainer: function _getContainer(parent_id) {
      var container,
          parent_id = parent_id.get("parent_id");
    ...
    checkNoContent: function checkNoContent() {
    ...
    parse: function parse(data, content, parent) {
    ...
    unescapeParams: function unescapeParams(params) {
      return _.object(_.map(params, function (value, key) {
        return [key, this.unescapeParam(value)];
      }, this));
    },
    setResultMessage: function setResultMessage(str) {
      this.message = str;
    },
    showResultMessage: function showResultMessage() {
  ...
  window.vc.TemplateWindowUIPanelBackendEditor = vc.TemplatesPanelViewBackend.vcExtendUI(vc.HelperPanelViewHeaderFooter).vcExtendUI(vc.HelperTemplatesPanelViewSearch).extend({
    ...
    show: function show() {
      ...
      $('body').append('<div class="modal-backdrop white"></div>'); //lazy load imgs
  ...
  window.vc.EditElementPanelView = vc.PanelView.vcExtendUI(vc.HelperAjax).vcExtendUI(vc.ExtendPresets).vcExtendUI(vc.ExtendTemplates).vcExtendUI(vc.HelperPrompts).extend({
    ...
    buildParamsContent: function buildParamsContent(data) {
      ...
      function verticallyCenterColumns() {
        ...
        if ($using_nectar_fspr && $('select#_nectar_full_screen_rows_row_bg_animation').val() == 'ken_burns') $('.vc_shortcode-param[data-vc-shortcode-param-name="disable_ken_burns"]').show();else {
      ...
      if ($('[data-vc-shortcode="nectar_image_with_hotspots"]').length > 0) {
        var updateHotSpotData = function updateHotSpotData(rel, x, y) {
          //update arr of objs
          $hotSpotData[rel - 1] = {
            'left': x,
            'top': y,
        ...
        ////turn into draggable
        var hotspotMakeDraggable = function hotspotMakeDraggable() {
        ...
        ////update numbers
        var hotspotUpdateNumbers = function hotspotUpdateNumbers() {
    ...
    save: function save() {
      if (this.panelInit) {
        ...
        if ($('[data-vc-shortcode="nectar_image_with_hotspots"]').length > 0 && this.$convertedData.length > 0) {
          ...
          if (hasTinymce) tinyMCE.activeEditor.setContent(''); //add content
  ...
  $hold_active: !1,
  data_changed: !1,
  setDataChanged: function setDataChanged() {
    var that;
  ...
  unsetDataChanged: function unsetDataChanged() {
    window.jQuery(window).unbind("beforeunload.vcSave"), this.data_changed = !1;
  },
  addTemplateFilter: function addTemplateFilter(callback) {
    _.isFunction(callback) && this.filters.templates.push(callback);
  },
  unsetHoldActive: function unsetHoldActive() {
  ...
  vc.map = {}, vc.setFrameSize = function (size) {
    ...
    return values = _.extend({}, paramsMap.defaults, values), paramsDependencies = _.extend({}, paramsMap.dependencyMap), _.each(values, function (value, key) {
      if ("content" !== key) {
        if (!_.isUndefined(paramsDependencies[key])) {
          ...
          var isDependedEmpty,
              rules = paramsDependencies[key].element,
    ...
    changeParentId: function changeParentId() {
    ...
    _getDefaultTemplate: function _getDefaultTemplate() {
      var controls;
    ...
    clone: function clone(new_model) {
    ...
    getParam: function getParam(param_name) {
    ...
    placeElement: function placeElement($el, activity) {
    ...
    updateKeyPress: function updateKeyPress(e) {
    ...
    setActiveHover: function setActiveHover(e) {
    ...
    unsetActiveHover: function unsetActiveHover(e) {
    ...
    noContent: function noContent(no) {
    ...
    addTextBlock: function addTextBlock(builder) {
    ...
    scrollTo: function scrollTo(model) {
      vc.frame_window.vc_iframe.scrollTo(model.get("id"));
    },
    addInlineScript: function addInlineScript(script) {
      return vc.frame_window.vc_iframe.addInlineScript(script);
    },
    addInlineScriptBody: function addInlineScriptBody(script) {
    ...
    editCloned: function editCloned(model) {
    ...
    placeElement: function placeElement($view, activity) {
    ...
    addShortcodes: function addShortcodes(models) {
      _.each(models, function (model) {
    ...
    createShortcodeHtml: function createShortcodeHtml(model) {
    ...
    createRow: function createRow(column_params) {
    ...
    openTemplatesEditor: function openTemplatesEditor(e) {
    ...
    dropButton: function dropButton() {},
    saveRowOrder: function saveRowOrder(event, ui) {
    ...
    saveElementOrder: function saveElementOrder(event, ui) {
    ...
    saveColumnOrder: function saveColumnOrder(event, ui) {
      _.defer(function (app, e, ui) {
  ...
  window.vc.events.on("shortcodeView:updated", function (modelId) {
    ...
    resetActive: function resetActive(e) {
      this.hold_active && window.clearTimeout(this.hold_active);
    },
    holdActive: function holdActive(e) {
    ...
    allowAddControl: function allowAddControl() {
      return "edit" !== vc_user_access().getState("shortcodes");
    },
    multi_edit: function multi_edit(e) {
      var children,
          models = [];
    ...
    allowAddControlOnEmpty: function allowAddControlOnEmpty() {
      return "edit" !== vc_user_access().getState("shortcodes");
    }
  });
}(window.jQuery), function ($) {
  ...
  window.InlineShortcodeViewContainerWithParent = window.InlineShortcodeViewContainer.extend({
    ...
    switchControls: function switchControls($current) {
  ...
  window.InlineShortcodeView_vc_section = window.InlineShortcodeViewContainer.extend({
    ...
    checkSectionWidth: function checkSectionWidth(e, data) {
  ...
  window.InlineShortcodeView_vc_row = window.InlineShortcodeView.extend({
    ...
    removeHoldActive: function removeHoldActive() {
      vc.unsetHoldActive();
    },
    ...
    convertToWidthsArray: function convertToWidthsArray(string) {
    ...
    addLayoutClass: function addLayoutClass() {
    ...
    convertRowColumns: function convertRowColumns(columns, builder) {
      if (!columns) return !1;
      var column_params,
          new_model,
          columns_contents = [],
  ...
  window.InlineShortcodeView_vc_column = window.InlineShortcodeViewContainerWithParent.extend({
    ...
    customCssClassReplace: function customCssClassReplace() {
    ...
    startChangeSize: function startChangeSize(e) {
    ...
    stopChangeSize: function stopChangeSize() {
    ...
    resize: function resize(old_width) {
    ...
    convertSize: function convertSize(width) {
  ...
  window.InlineShortcodeView_vc_basic_grid = vc.shortcode_view.extend({
    ...
    initGridJs: function initGridJs(useAddActivity) {
  ...
  window.InlineShortcodeView_vc_tta_accordion = window.InlineShortcodeViewContainer.extend({
    ...
    addSection: function addSection(prepend) {
      var i,
          params = {
      ...
      for (prepend && (vc.activity = "prepend", params.order = this.getSiblingsFirstPositionIndex()), vc.builder.create(params), i = vc.builder.models.length - 1; 0 <= i; i--) {
        vc.builder.models[i].get("shortcode");
      }

      vc.builder.render();
    },
    getSiblingsFirstPositionIndex: function getSiblingsFirstPositionIndex() {
      var order = 0,
    ...
    buildSortable: function buildSortable() {
    ...
    startSorting: function startSorting(event, ui) {
    ...
    getPanelsList: function getPanelsList() {
    ...
    getPaginationList: function getPaginationList() {
      var $accordions,
          classes,
          style_chunks,
          that,
  ...
  window.InlineShortcodeView_vc_tta_tabs = window.InlineShortcodeView_vc_tta_accordion.extend({
    ...
    addIcon: function addIcon(model, html) {
      var icon, icon_html;
    ...
    sectionUpdated: function sectionUpdated(model, justAppend) {
      var index,
          $element,
          tabAdded = !1,
    ...
    buildSortableNavigation: function buildSortableNavigation() {
    ...
    updateSortingNavigation: function updateSortingNavigation() {
      var self = this,
    ...
    updateTabsPositions: function updateTabsPositions(tabSortableData) {
      var $elements,
          $tabs = this.$el.find(".vc_tta-tabs-list");
    ...
    updatePanelsPositions: function updatePanelsPositions(tabSortableData) {
    ...
    renderSortingHelper: function renderSortingHelper(event, currentItemHeight) {
  ...
  window.vc.ttaSectionActivateOnClone = !1, window.InlineShortcodeView_vc_tta_section = window.InlineShortcodeViewContainerWithParent.extend({
    ...
    moveClasses: function moveClasses() {
      var panelClassName;
    ...
    refreshContent: function refreshContent(noSectionUpdate) {
      var $controlsIconsPositionEl,
          parentParams,
          $controlsIcon,
    ...
    setAsActiveSection: function setAsActiveSection(isActive) {
      this.model.set("isActiveSection", !!isActive);
    },
    isAsActiveSection: function isAsActiveSection() {
      return !!this.model.get("isActiveSection");
    },
    bindAccordionEvents: function bindAccordionEvents() {
      var that = this;
    ...
    destroy: function destroy(parentModel) {
      var parentId = this.model.get("parent_id");
  ...
  window.vc.cloneMethod_vc_tab = function (data, model) {
    ...
    tabsControls: function tabsControls() {
      /*nectar addition*/
      return this.$el.find(".wpb_tabs_nav");
      /*nectar addition end*/
    },
    buildTabs: function buildTabs(active_el) {
    ...
    updated: function updated() {
      ...
      window.InlineShortcodeView_vc_tabs.__super__.updated.call(this), this.$tabs.parent().find(".wpb_tabs_nav:first").remove(), this.buildNav(), vc.frame_window.vc_iframe.buildTabs(this.$tabs), this.setSorting();
      /*nectar addition end */
    },
    rowsColumnsConverted: function rowsColumnsConverted() {
    ...
    cloneTabAfter: function cloneTabAfter(model) {
      /*nectar addition*/
      this.$tabs.parent().find("> .wpb_tabs_nav > div").remove(), this.buildTabs(model);
      /*nectar addition end*/
    },
    updateIfExistTab: function updateIfExistTab(model) {
      /*nectar addition*/
    ...
    buildControlHtml: function buildControlHtml(model) {
      model.get("params");
    ...
    getDefaultTabTitle: function getDefaultTabTitle() {
    ...
    stopSorting: function stopSorting(event, ui) {
      ...
      this.tabsControls().find("> li[data-m-id]").each(function (key, value) {
        ...
        $this = $(this), modelId = $this.data("m-id"), shortcode = vc.shortcodes.get(modelId), shortcode.save({
          order: self.getIndex($this)
        }, {
          silent: !0
        });
  ...
  window.InlineShortcodeView_vc_tab = window.InlineShortcodeViewContainerWithParent.extend({
    ...
    render: function render() {
      /*nectar addition*/
      this.$tab = this.$el.find("> :first"); //don't show when duplicating/adding new item before switching to tab
...
(window.jQuery), function ($) {
  window.InlineShortcodeView_clients = window.InlineShortcodeView_vc_accordion.extend({
    render: function render() {
      return _.bindAll(this, "stopSorting"), this.$accordion = this.$el.find("> .clients"), window.InlineShortcodeView_vc_accordion.__super__.render.call(this), this;
    },
    addElement: function addElement(e) {
...
(window.jQuery), function ($) {
  window.InlineShortcodeView_nectar_icon_list = window.InlineShortcodeView_vc_accordion.extend({
    updateNumericalIcons: function updateNumericalIcons() {
      var $that = this;
      setTimeout(function () {
    ...
    render: function render() {
      return _.bindAll(this, "stopSorting"), this.$accordion = this.$el.find("> .nectar-icon-list"), window.InlineShortcodeView_vc_accordion.__super__.render.call(this), this;
    },
    addElement: function addElement(e) {
      e && e.preventDefault(), new vc.ShortcodesBuilder().create({
...
(window.jQuery), function ($) {
  window.InlineShortcodeView_page_submenu = window.InlineShortcodeView_vc_accordion.extend({
    render: function render() {
      return _.bindAll(this, "stopSorting"), this.$accordion = this.$el.find("> .page-submenu"), window.InlineShortcodeView_vc_accordion.__super__.render.call(this), this;
    },
    addElement: function addElement(e) {
      e && e.preventDefault(), new vc.ShortcodesBuilder().create({
        shortcode: "page_link",
...
(window.jQuery), function ($) {
  window.InlineShortcodeView_toggles = window.InlineShortcodeView_vc_accordion.extend({
    render: function render() {
      return _.bindAll(this, "stopSorting"), this.$accordion = this.$el.find("> .toggles"), window.InlineShortcodeView_vc_accordion.__super__.render.call(this), this;
    },
    addElement: function addElement(e) {
      e && e.preventDefault(), new vc.ShortcodesBuilder().create({
        shortcode: "toggle",
  ...
  window.InlineShortcodeView_carousel = window.InlineShortcodeView_vc_accordion.extend({
    render: function render() {
      if (this.$el.find('.owl-carousel').length > 0) {
        return _.bindAll(this, "stopSorting"), this.$accordion = this.$el.find(".owl-carousel .owl-stage"), window.InlineShortcodeView_vc_accordion.__super__.render.call(this), this;
      } else {
        return _.bindAll(this, "stopSorting"), this.$accordion = this.$el.find(".flickity-slider"), window.InlineShortcodeView_vc_accordion.__super__.render.call(this), this;
      }
    },
    addElement: function addElement(e) {
      e && e.preventDefault(), new vc.ShortcodesBuilder().create({
...
(window.jQuery), function ($) {
  window.InlineShortcodeView_pricing_table = window.InlineShortcodeView_vc_accordion.extend({
    render: function render() {
      return _.bindAll(this, "stopSorting"), this.$accordion = this.$el.find(".pricing-table"), window.InlineShortcodeView_vc_accordion.__super__.render.call(this), this;
    },
    pricingTableClassesAndCols: function pricingTableClassesAndCols() {
      var $that = this;
      setTimeout(function () {
  ...
  window.InlineShortcodeView_testimonial_slider = window.InlineShortcodeView_vc_accordion.extend({
    render: function render() {
      if (this.$el.find('.flickity-slider').length > 0) {
        ...
        return _.bindAll(this, "stopSorting"), this.$accordion = this.$el.find(".testimonial_slider > .slides"), window.InlineShortcodeView_vc_accordion.__super__.render.call(this), this;
      }
    },
    addElement: function addElement(e) {
      e && e.preventDefault(), new vc.ShortcodesBuilder().create({
...
function ($) {
  ...
  $(function () {
    ...
    window.vc && window.vc.events && ($undoControl = $("#vc_navbar-undo"), $redoControl = $("#vc_navbar-redo"), checkControls = function checkControls() {
      ...
      for (vc.createOverlaySpinner(); vc.shortcodes.models.length;) {
