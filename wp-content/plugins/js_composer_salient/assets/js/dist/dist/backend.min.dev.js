...
window.vc || (window.vc = {}), function () {
  ...
  vc.template = function (text, settings) {
    ...
    var render,
        argument = RegExp([(settings.escape || noMatch).source, (settings.interpolate || noMatch).source, (settings.evaluate || noMatch).source].join("|") + "|$", "g"),
        index = 0,
        source = "__p+='";
  ...
  _.isUndefined(window.vc) && (window.vc = {}), window.Vc_postSettingsEditor = Backbone.View.extend({
    ...
    sel: "wpb_csseditor",
    ace_enabled: !1,
    initialize: function initialize(sel) {
      sel && 0 < sel.length && (this.sel = sel), this.ace_enabled = !0;
    },
    aceEnabled: function aceEnabled() {
    ...
    setEditorAce: function setEditorAce(count) {
    ...
    setEditorTextarea: function setEditorTextarea(value) {
    ...
    setSizeResizable: function setSizeResizable() {
      var $editor = $("#" + this.sel),
  ...
  _.isUndefined(window.vc) && (window.vc = {}), vc.showSpinner = function () {
    ...
    buildFiltering: function buildFiltering() {
    ...
    render: function render(model, prepend) {
    ...
    createElement: function createElement(mapped) {
      var _this, i;
      ...
      if (!this.preventDoubleExecution) {
        ...
        })) && (params.order = shortcodeFirst.get("order") - 1), vc.activity = "prepend") : this.place_after_id && (params.place_after_id = this.place_after_id), this.builder.create(params), i = this.builder.models.length - 1; 0 <= i; i--) {
          this.builder.models[i].get("shortcode");
        }
    ...
    filterElements: function filterElements(name_filter) {
    ...
    createElement: function createElement(row_inner_params) {
    ...
    exit: function exit() {},
    getFirstPositionIndex: function getFirstPositionIndex() {
    ...
    addOpacity: function addOpacity() {
      this.clicked || this.$el.addClass("vc_panel-opacity");
    },
    removeOpacity: function removeOpacity() {
    ...
    setMediaSizeClass: function setMediaSizeClass() {
    ...
    fixElContainment: function fixElContainment() {
    ...
    setTabsSize: function setTabsSize() {
    ...
    resetMinimize: function resetMinimize() {
    ...
    setAlertOnDataChange: function setAlertOnDataChange() {
    ...
    removeTemplate: function removeTemplate(template_name) {
    ...
    loadTemplate: function loadTemplate($button) {
    ...
    ajaxData: function ajaxData($button) {
      return {
    ...
    loadDefaultTemplate: function loadDefaultTemplate($button) {
      $button && $button.preventDefault && $button.preventDefault();
      $button = $($button.currentTarget);
      $.ajax({
        type: "POST",
    ...
    saveTemplate: function saveTemplate(shortcodes) {
    ...
    reloadTemplateList: function reloadTemplateList(data) {
    ...
    removeTemplate: function removeTemplate(template_action) {
      ...
      var template_id,
          template_type,
          $template = $(template_action.target).closest("[data-template_id]"),
    ...
    reloadTemplateList: function reloadTemplateList(data, successCallback, errorCallback) {
      var _this = this;
    ...
    renderTemplate: function renderTemplate(html) {
      var models;
      _.each(vc.filters.templates, function (callback) {
        html = callback(html);
    ...
    buildTemplatePreview: function buildTemplatePreview(e) {
      ...
      try {
        ...
        if ($wrapper.hasClass("vc_active") || $wrapper.hasClass("vc_loading")) $el.vcAccordion("collapseTemplate");else {
          ...
          $el.vcAccordion("collapseTemplate", function () {
            var question,
                $frame = $wrapper.data("template_id"),
    ...
    setTemplatePreviewSize: function setTemplatePreviewSize(height) {
    ...
    addCurrentLayout: function addCurrentLayout() {
      vc.shortcodes.sort();
    ...
    isBuildComplete: function isBuildComplete() {
      return this.builder().isBuildComplete();
    },
    setLayout: function setLayout(columns) {
    ...
    updateFromInput: function updateFromInput(layout) {
    ...
    validateCellsList: function validateCellsList(split) {
      var num,
          denom,
          return_cells = [],
  ...
  var Plugin,
      old,
      TabsLine = function TabsLine(element, options) {
    var _this = this;
  ...
  TabsLine.DEFAULTS = {
    ...
    }), "function" == typeof this.options.onTabClick && (addClick = function addClick(el) {
    ...
    return this.each(function () {
      var $this = $(this),
          ...
          options = $.extend(!0, {}, TabsLine.DEFAULTS, $this.data(), action, "object" == _typeof(option) && option),
  ...
  window.vc.HelperAjax = {
    ajax: !1,
    checkAjax: function checkAjax() {
      this.ajax && this.ajax.abort();
    },
    resetAjax: function resetAjax() {
      this.ajax = !1;
    }
  };
}(), function () {
  ...
  window.vc.HelperPrompts = {
    ...
    removeAllPrompts: function removeAllPrompts() {
  ...
  window.vc.HelperPanelViewResizable = {
    ...
    setDefaultHeightSettings: function setDefaultHeightSettings() {
    ...
    setSavedSize: function setSavedSize() {
    ...
    saveUIPanelSizes: function saveUIPanelSizes() {
    ...
    setupOnMinimize: function setupOnMinimize() {
      this.$el.data("uiResizable") && this.$el.resizable("destroy"), this.$el.resizable({
        minWidth: 380,
        handles: "w, e",
  ...
  window.vc.HelperTemplatesPanelViewSearch = {
    ...
    searchTemplate: function searchTemplate($el) {
      $el = $($el.currentTarget);
  ...
  window.vc.HelperPanelViewHeaderFooter = {
    ...
    toggleOpacity: function toggleOpacity(styles) {
    ...
    setButtonMessage: function setButtonMessage(message, type, currentTextHtml) {
      var $saveBtn;
    ...
    clearButtonMessage: function clearButtonMessage() {
  ...
  window.vc.TemplateWindowUIPanelBackendEditor = vc.TemplatesPanelViewBackend.vcExtendUI(vc.HelperPanelViewHeaderFooter).vcExtendUI(vc.HelperTemplatesPanelViewSearch).extend({
    ...
    initTemplatesTabs: function initTemplatesTabs() {
    ...
    setPreviewFrameHeight: function setPreviewFrameHeight(templateID, height) {
  ...
  window.vc.element_start_index = 0, window.vc.AddElementUIPanelBackendEditor = vc.PanelView.vcExtendUI(vc.HelperPanelViewHeaderFooter).extend({
    ...
    filterElements: function filterElements(e) {
    ...
    createElement: function createElement(inner_column_params) {
    ...
    addCustomCssStyleTag: function addCustomCssStyleTag(customCss) {
    ...
    updateAddElementPopUp: function updateAddElementPopUp(id, shortcode, title, data) {
    ...
    removePresetFromAddElementPopUp: function removePresetFromAddElementPopUp(id) {
      this.$el.find('[data-preset="' + id + '"]').remove();
    },
    openPresetWindow: function openPresetWindow(e) {
    ...
    createElement: function createElement(inner_column_params) {
      ...
      for (inner_column_params && inner_column_params.preventDefault && inner_column_params.preventDefault(), showSettings = (closestPreset = $(inner_column_params.currentTarget)).data("tag"), inner_row_params = {}, inner_column_params = {
        ...
        parent_id: this.model.id,
        order: this.prepend ? this.getFirstPositionIndex() : vc.shortcodes.nextOrder()
      }, preset && presetType === showSettings && (newData.preset = preset), this.builder.create(newData)), this.model = this.builder.last(), i = this.builder.models.length - 1; 0 <= i; i--) {
        this.builder.models[i].get("shortcode");
      }
  ...
  window.vc.ExtendPresets = {
    ...
    afterRenderActions: function afterRenderActions() {
    ...
    saveSettingsAjaxData: function saveSettingsAjaxData(shortcode_name, title, is_default, data) {
      return {
    ...
    saveSettings: function saveSettings(title, is_default) {
    ...
    fetchSaveSettingsDialogAjaxData: function fetchSaveSettingsDialogAjaxData() {
      return {
    ...
    fetchSaveSettingsDialog: function fetchSaveSettingsDialog(callback) {
    ...
    showSaveSettingsDialog: function showSaveSettingsDialog(is_default) {
      var _this = this;
      ...
      this.isSettingsPresetDefault = !!is_default, this.fetchSaveSettingsDialog(function (created) {
        ...
        var $btn,
            delay,
            $viewPresetsButton = $prompt.find("[data-vc-view-settings-preset]");
    ...
    loadSettingsAjaxData: function loadSettingsAjaxData(id) {
      return {
    ...
    loadSettings: function loadSettings(id) {
    ...
    saveAsDefaultSettingsAjaxData: function saveAsDefaultSettingsAjaxData(shortcode_name, id) {
      return {
    ...
    saveAsDefaultSettings: function saveAsDefaultSettings(presetId, doneCallback) {
      var shortcode_name = this.model.get("shortcode"),
    ...
    restoreDefaultSettingsAjaxData: function restoreDefaultSettingsAjaxData(shortcode_name) {
      return {
    ...
    restoreDefaultSettings: function restoreDefaultSettings() {
      var shortcode_name = this.model.get("shortcode");
    ...
    setSettingsMenuContent: function setSettingsMenuContent(html) {
    ...
    reloadSettingsMenuContentAjaxData: function reloadSettingsMenuContentAjaxData(shortcode_name) {
      return {
    ...
    showViewSettingsList: function showViewSettingsList() {
      var _this,
          $prompt,
          closePrompt,
          $contentContainer = this.$el.find(".vc_ui-panel-content-container");
    ...
    buildsettingsListContent: function buildsettingsListContent($prompt) {
    ...
    reloadSettingsMenuContent: function reloadSettingsMenuContent() {
      var shortcode_name = this.model.get("shortcode"),
    ...
    closeSettings: function closeSettings(destroy) {
    ...
    isSettingsPresetDataTainted: function isSettingsPresetDataTainted() {
    ...
    untaintSettingsPresetData: function untaintSettingsPresetData() {
      var params = (params = JSON.stringify(this.getParamsForSettingsPreset())).replace(/vc_custom_\d+/, "");
      this.$el.data("vcSettingsPresetHash", vc_globalHashCode(params));
    },
    applySettingsPresetAjaxData: function applySettingsPresetAjaxData(params) {
    ...
    applySettingsPreset: function applySettingsPreset(params) {
    ...
    getParamsForSettingsPreset: function getParamsForSettingsPreset() {
  ...
  window.vc.ExtendTemplates = {
    fetchSaveTemplateDialogAjaxData: function fetchSaveTemplateDialogAjaxData() {
      return {
    ...
    fetchSaveTemplateDialog: function fetchSaveTemplateDialog(callback) {
    ...
    showSaveTemplateDialog: function showSaveTemplateDialog() {
      var _this = this;
  ...
  window.vc.EditElementPanelView = vc.PanelView.vcExtendUI(vc.HelperAjax).vcExtendUI(vc.ExtendPresets).vcExtendUI(vc.ExtendTemplates).vcExtendUI(vc.HelperPrompts).extend({
    ...
    setCustomButtonMessage: function setCustomButtonMessage($btn, message, type, currentTextHtml) {
    ...
    clearCustomButtonMessage: function clearCustomButtonMessage($btn) {
    ...
    render: function render(params, not_request_template) {
    ...
    prepareContentBlock: function prepareContentBlock() {
    ...
    buildParamsContent: function buildParamsContent($panelHeader) {
      ...
      $('.icon.dropdown').chosen(); //show options conditionally based on parent parameters
      ...
      function verticallyCenterColumns() {
        if ($('#equal_height-yes').is(':checked') && $('select[name="type"]').val() == 'full_width_content') $('#vertically_center_columns-true').parents('.vc_column').hide();else if (!$('#equal_height-yes').is(':checked') && $('select[name="type"]').val() == 'full_width_content') $('#vertically_center_columns-true').parents('.vc_column').show(); //full height row hide
        ...
        if ($('._nectar_full_screen_rows label[for="nectar_meta_on"].ui-state-active').length > 0 && $('select#_nectar_full_screen_rows_row_bg_animation').val() == 'ken_burns') $('.vc_shortcode-param[data-vc-shortcode-param-name="disable_ken_burns"]').show();else {
      ...
      if ($('[data-vc-shortcode="nectar_image_with_hotspots"]').length > 0) {
        ...
        if ($hotSpotData.length > 0) {
          $.each($hotSpotData, function (k, v) {
            ...
            for (var i = 0; i < $positionArr.length; i++) {
              if (v.position == $positionArr[i]) $positionOptions += '<option name="' + $positionArr[i] + '" selected="selected">' + $positionArr[i] + '</option>';else $positionOptions += '<option name="' + $positionArr[i] + '">' + $positionArr[i] + '</option>';
            } //textarea
        ...
        $('#nectar_image_with_hotspots_preview:not(#nectar_image_with_hotspots_preview .hotspot)').click(function (e) {
          ...
          $(this).append($hotspot); //create textarea
        ...
        $('body').on('click.hotspot-delete-event', '.hotspot-content a.delete', function (e) {
          ...
          hotspotUpdateNumbers(); //empty hotspotdata so list can be rebuilt inside next function
      ...
      $('.mouse_based_parallax_bg').trigger('change'); //add one-half column classes to mouse based parallax
    ...
    hookDependent: function hookDependent(checkTabs) {
      var is_empty,
          $master = $(checkTabs.currentTarget),
    ...
    window: function (_window2) {
      function window() {
        return _window2.apply(this, arguments);
      }

      window.toString = function () {
        return _window2.toString();
      };
    ...
    save: function save() {
      ...
      if ($('[data-vc-shortcode="nectar_image_with_hotspots"]').length > 0 && this.$convertedData.length > 0) {
        var hasTinymce = !_.isUndefined(window.tinyMCE); //clear content
    ...
    _killEditor: function _killEditor() {
  ...
  window.vc.TemplateLibraryView = vc.PanelView.vcExtendUI(vc.HelperAjax).extend({
    ...
    getLibrary: function getLibrary() {
      ...
      this.loaded ? this.showLibrary() : (this.checkAjax(), data = this.getStorage("templates"), _this = this, data && "object" == _typeof(data) && !_.isEmpty(data) ? (this.loaded = !0, this.loadLibrary(data), this.showLibrary()) : this.ajax = $.getJSON("https://vc-cc-templates.wpbakery.com/templates.json").done(function (data) {
    ...
    setStorage: function setStorage(key, value, expires) {
    ...
    loadLibrary: function loadLibrary(data) {
    ...
    addTemplateStatus: function addTemplateStatus(template) {
      var status,
          statusHtml = "",
    ...
    loadMyTemplates: function loadMyTemplates() {
      var renderedOutput = "",
          _this = this;
    ...
    closePopupButton: function closePopupButton(e) {
    ...
    downloadButton: function downloadButton(id) {
  ...
  vc.PostSettingsUIPanelFrontendEditor = vc.PostSettingsPanelView.vcExtendUI(vc.HelperPanelViewHeaderFooter).vcExtendUI(vc.HelperPanelViewResizable).vcExtendUI(vc.HelperPanelViewDraggable).vcExtendUI({
    ...
    setEditorSize: function setEditorSize() {
    ...
    removeChangeTitleField: function removeChangeTitleField() {
  ...
  window.vc.PresetSettingsUIPanelFrontendEditor = vc.PanelView.vcExtendUI(vc.HelperPanelViewHeaderFooter).vcExtendUI(vc.HelperAjax).vcExtendUI({
    ...
    createPreset: function createPreset(row) {
    ...
    deleteSettings: function deleteSettings(id, shortcode_name) {
      var _this = this;
    ...
    deleteSettingsAjaxData: function deleteSettingsAjaxData(shortcode_name, id) {
      return {
...
}(window.jQuery), window._.isUndefined(window.vc) && (window.vc = {}), function (vc, _, $) {
  "use strict";
  ...
  function Suggester(element, options) {
    this.el = element, this.$el = $(this.el), this.$el_wrap = "", this.$block = "", this.suggester = "", this.selected_items = [], this.options = _.isObject(options) ? options : {}, _.defaults(this.options, {
      ...
      predefined: [],
      locked: !1,
      select_callback: function select_callback(label, data) {},
      remove_callback: function remove_callback(label, data) {},
      update_callback: function update_callback(label, data) {},
      check_locked_callback: function check_locked_callback(el, data) {
        return !1;
      }
    }), this.init();
  }
  ...
  window.init_textarea_html = function ($element) {
    ...
    if (hex.length < 6) for (var i = 6 - hex.length - 1; 0 <= i; i--) {
      hex = "0" + hex;
    }
    return "#" + hex;
    ...
    labelClick: function labelClick(e) {
      e.preventDefault();
    ...
    buildSource: function buildSource(request, response) {
  ...
  var VcLoopEditorView = Backbone.View.extend({
    ...
    updateCheckbox: function updateCheckbox($input) {
    ...
    updateSuggestion: function updateSuggestion($suggestion_block, value) {
    ...
    suggestionLocked: function suggestionLocked(field, value) {
    ...
    createEditor: function createEditor(data) {
  ...
  VcSortedList.prototype = {
    ...
    init: function init() {
      ...
      var i,
          selected_data = this.$data_field.val().split(",");
    ...
    createControl: function createControl(data) {
      var sub_control = "",
    ...
    controlEvent: function controlEvent($control) {
  ...
  var GoogleFonts = Backbone.View.extend({
    ...
    previewElementRender: function previewElementRender() {
    ...
    previewElementLoading: function previewElementLoading() {
      this.$preview_el.text(window.i18nLocale.gfonts_loading_google_font || "Loading Font...");
    },
    fontFamilyDropdownRender: function fontFamilyDropdownRender() {
      return this.fontFamilyDropdownChange(), this;
    },
    fontFamilyDropdownChange: function fontFamilyDropdownChange() {
    ...
    fontStyleDropdownRender: function fontStyleDropdownRender() {
      var str_inner,
          str_arr = this.font_types.split(","),
          oel = "",
    ...
    fontStyleDropdownChange: function fontStyleDropdownChange() {
    ...
    source_data: function source_data() {
      return {};
    },
    ...
    enableMultiple: function enableMultiple() {
      this.isMultiple = !0, this.$el.show(), this.$el.focus();
    },
    enableSortable: function enableSortable() {
    ...
    sortableChange: function sortableChange(event, ui) {},
    ...
    sortableCreate: function sortableCreate(event, ui) {},
    sortableUpdate: function sortableUpdate(event, ui) {
    ...
    createBox: function createBox($label) {
    ...
    labelRemoveHook: function labelRemoveHook($label) {
      this.$el.blur(), this.$el.val(""), $label.on("click", this.labelRemoveClick);
    },
    labelRemoveClick: function labelRemoveClick(e, ui) {
      e.preventDefault();
      var $label = $(e.currentTarget);
    ...
    setContent: function setContent($el) {
      this.$content = $el;
    },
    content: function content() {
      return this.$content;
    ...
    initializeAdminLabels: function initializeAdminLabels() {
      for (var callback = this.hookAdminLabel, f = function f() {
        var $field = $(this);
        $field.data("vc_admin_labels") || ($field.data("vc_admin_labels", !0), $field.bind("keyup change", callback), callback({
          currentTarget: this
        }));
      }, i = 0; i < this.adminLabelParams.length; i++) {
        $("[name=" + this.adminLabelParams[i] + "].wpb_vc_param_value", this.$el).each(f);
      }
    },
    hookAdminLabel: function hookAdminLabel($wrapperLabel) {
    ...
    initializeDependency: function initializeDependency() {
      var callDependencies = {};
    ...
    hookDependent: function hookDependent(dependentElements) {
    ...
    deleteParam: function deleteParam(ev) {
  ...
  vc.edit_form_callbacks = [], vc.atts = {
    ...
    parseFrame: function parseFrame(param) {
      return vc.atts.parse.call(this, param);
    },
    init: function init(param, $field) {
    ...
    parse: function parse(new_value) {
    ...
    defaults: function defaults(param) {
      return "";
    }
  }, vc.atts.el_id = {
    clone: function clone(clonedModel, paramValue, paramSettings) {
    ...
    create: function create(shortcodeModel, shortcodeParams, paramSettings) {
    ...
    updateImages: function updateImages($thumbnails, thumbnails_html) {
    ...
    updateImage: function updateImage($thumbnail, image_src, image_exists) {
    ...
    parse: function parse(string_pieces) {
    ...
    extractValues: function extractValues(param, $el) {
      var data = [],
          self = this;
    ...
    parseOne: function parseOne(data) {
      var $content = this.content(),
    ...
    init: function init(param, $field) {
      $(".vc_link-build", $field).on("click", function (value_object) {
        ...
        var onClose = function onClose(e, wrap) {
    ...
    change: function change(param, $select) {
    ...
    $frame: null,
    closeEditor: function closeEditor(e) {
      e && e.preventDefault && e.preventDefault();
    ...
    init: function init(param, $field) {
      ...
      $('[data-vc-action="open"]', _this.content).on("click", function (iframeURL) {
        ...
        _this.gutenbergParamObj = new GutenbergParam({
          onSetValue: function onSetValue(value) {
  ...
  var GutenbergParam = function GutenbergParam(options) {
    return this.iframe = null, this.options = options || {}, this.value = this.options && this.options.value ? this.options.value : "", this.iframeLoaded = function () {
      var selectEditor,
          editor,
          newPost,
          notice = !!this.iframe.contentWindow.wp && this.iframe.contentWindow.wp.data;
  ...
  vc.debug = !1, vc.map = _.isUndefined(window.vc_mapper) ? {} : window.vc_mapper, vc.roles = _.isUndefined(window.vc_roles) ? {} : window.vc_roles, vc.Storage = function () {
    ...
    setModelRoot: function setModelRoot(data) {
      data = this.data[data];
    ...
    find: function find(model_id) {
      return this.data[model_id];
    },
    findAll: function findAll() {
      return this.fetch(), _.values(this.data);
    },
    findAllRootSorted: function findAllRootSorted() {
    ...
    _storageGetShortcodeContent: function _storageGetShortcodeContent(parent) {
    ...
    parseContent: function parseContent(data, content, parent) {
      /* nectar addition */
      ...
      _.each(matches, function (raw) {
        ...
        if (_.isString(sub_content) && sub_content.match(sub_regexp) && (_.isBoolean(map_settings.is_container) && true === map_settings.is_container || !_.isEmpty(map_settings.as_parent) && false !== map_settings.as_parent)) {
  ...
  vc.shortcode = Backbone.Model.extend({
    ...
    removeEvents: function removeEvents(model) {
    ...
    removeChildren: function removeChildren(models) {
    ...
    model: vc.shortcode,
    last_index: 0,
    getNextOrder: function getNextOrder() {
    ...
    initialize: function initialize() {},
    createFromString: function createFromString(shortcodes_string, data) {
    ...
    singleStringify: function singleStringify(id, state) {
      return this.modelsToString([vc.shortcodes.get(id)], state);
    },
    createShortcodeString: function createShortcodeString(model, state) {
      var tag = model.get("shortcode"),
          content = _.extend({}, model.get("params")),
          paramsForString = {},
          data = vc.getMergedParams(tag, content);
    ...
    modelsToString: function modelsToString(models, state) {
      return _.reduce(models, function (memo, model) {
        return memo + this.createShortcodeString(model, state);
      }, "", this);
    },
    _getShortcodeContent: function _getShortcodeContent(params, state) {
      var models = _.sortBy(vc.shortcodes.where({
  ...
  vc.clone_index = 1, vc.shortcode_view = Backbone.View.extend({
    ...
    checkControlsPosition: function checkControlsPosition() {
    ...
    hasUserAccess: function hasUserAccess() {
    ...
    canCurrentUser: function canCurrentUser(action) {
      var tag = this.model.get("shortcode");
    ...
    html2element: function html2element($template) {
      var attributes = {},
    ...
    _callJsCallback: function _callJsCallback() {
    ...
    addShortcode: function addShortcode(view, method) {
    ...
    changeShortcodeParams: function changeShortcodeParams(model) {
      ...
      _.defer(function () {
        ...
        var $img,
            inverted_value,
            $admin_label = param_settings.param_name,
    ...
    changeShortcodeParent: function changeShortcodeParent(view) {
      var $parent_view;
    ...
    addElement: function addElement(e) {
      ...
      if ($('#wpb_visual_composer div[data-element_type="page_submenu"]').length > 0) $('.vc_add-element-container li[data-element="page_submenu"]').addClass('hidden-element');else $('.vc_add-element-container li[data-element="page_submenu"]').removeClass('hidden-element');
    ...
    editElement: function editElement(e) {
    ...
    cloneModel: function cloneModel(model, parent_id, tag) {
  ...
  vc.saved_custom_css = !1, vc.createPreLoader = function () {
    ...
    initializeAccessPolicy: function initializeAccessPolicy() {
      this.accessPolicy = {
    ...
    accessPolicyActions: function accessPolicyActions() {
      var _this,
          front = "",
          back = "";
    ...
    changeParamsEvents: function changeParamsEvents(model) {
    ...
    render: function render() {
      ...
      this.$content = $("#visual_composer_content"); //this.$post = $("#postdivrich"), 
    ...
    addChild: function addChild(parent_id) {
    ...
    setDropable: function setDropable() {
    ...
    addShortcode: function addShortcode(model) {
      var view,
          _this,
          parentModelView = _.extend(vc.getDefaults(model.get("shortcode")), model.get("params"));
    ...
    addTextBlock: function addTextBlock(params) {
      var row, column;
    ...
    openTemplatesWindow: function openTemplatesWindow(e) {
    ...
    loadDefaultTemplate: function loadDefaultTemplate(e) {
      e && e.preventDefault && e.preventDefault(), vc.templates_panel_view.loadTemplate(e);
    },
    editSettings: function editSettings(e) {
    ...
    sortingStarted: function sortingStarted(event, ui) {
      $("#visual_composer_content").addClass("vc_sorting-started");
    },
    sortingStopped: function sortingStopped(event, ui) {
    ...
    updateElementsSorting: function updateElementsSorting(event, ui) {
      _.defer(function (app) {
        var old_parent_id,
            parent = ui.item.parent().closest("[data-model-id]").data("model"),
    ...
    updateRowsSorting: function updateRowsSorting(e, ui) {
      _.defer(function (app) {
    ...
    renderPlaceholder: function renderPlaceholder(event, is_container) {
    ...
    setNotEmpty: function setNotEmpty() {
      $("#vc_no-content-helper").addClass("vc_not-empty");
    },
    setIsEmpty: function setIsEmpty() {
      vc.views = {}, $("#vc_no-content-helper").removeClass("vc_not-empty");
    },
    checkEmpty: function checkEmpty(parent_view) {
    ...
    switchComposer: function switchComposer(e) {
    ...
    buildRelevance: function buildRelevance() {
  ...
  window.VcRowView = vc.shortcode_view.extend({
    ...
    convertRowColumns: function convertRowColumns(layout) {
    ...
    buildDesignHelpers: function buildDesignHelpers() {
      /* nectar addition */
    ...
    getChildTag: function getChildTag() {
    ...
    setActiveLayoutButton: function setActiveLayoutButton($button) {
    ...
    layoutEditor: function layoutEditor() {
    ...
    setColumns: function setColumns($button) {
    ...
    openClosedRow: function openClosedRow(e) {
    ...
    addToEmpty: function addToEmpty(e) {
    ...
    convertSize: function convertSize(num) {
      var dev = num ? num.split("/") : [1, 1],
          range = _.range(1, 13),
          num = !_.isUndefined(dev[0]) && 0 <= _.indexOf(range, parseInt(dev[0], 10)) && parseInt(dev[0], 10),
          dev = !_.isUndefined(dev[1]) && 0 <= _.indexOf(range, parseInt(dev[1], 10)) && parseInt(dev[1], 10);
    ...
    setSorting: function setSorting() {
      ...
      vc_user_access().partAccess("dragndrop") && (_this = this).$content.sortable({
        ...
        stop: function stop(event, parent_tag) {
          $("#visual_composer_content").removeClass("vc_sorting-started"), $(".dragging_in").removeClass("dragging_in");
    ...
    changeShortcodeParams: function changeShortcodeParams(collapsible) {
    ...
    changeShortcodeParams: function changeShortcodeParams(params) {
    ...
    changeShortcodeParams: function changeShortcodeParams($wrapper) {
      var params;
    ...
    changeShortcodeParams: function changeShortcodeParams(classes) {
    ...
    changeShortcodeParams: function changeShortcodeParams($find) {
      var icon;
    ...
    changeShortcodeParams: function changeShortcodeParams($adminLabel) {
      var value;
    ...
    changeShortcodeParams: function changeShortcodeParams(el_class) {
      var params;
    ...
    changeShortcodeParams: function changeShortcodeParams($element) {
      var params;
    ...
    createAddTabButton: function createAddTabButton() {
      var new_tab_button_id = Date.now() + "-" + Math.floor(11 * Math.random()); // nectar addition vc_tab to tab
    ...
    changedContent: function changedContent(view) {
      ...
      if (view.model.get('cloned') === true) {
        ...
        if (!params.title && this.model.get('shortcode') === 'nectar_icon_list') params.title = window.i18nLocale.nectar_icon_list_item;
        if (!params.title && this.model.get('shortcode') === 'page_submenu') params.title = window.i18nLocale.page_link;
        $("<li><a href='#tab-" + params.id + "'>" + params.title + "</a></li>").insertBefore(this.$add_button);
        this.$tabs.tabs('refresh');
    ...
    cloneModel: function cloneModel(model, parent_id, tag) {
      ...
      if (model.get('shortcode') === 'tab') _.extend(new_params, {
        id: +new Date() + '-' + this.$tabs.find('[data-element-type=tab]').length + '-' + Math.floor(Math.random() * 11)
      });
      if (model.get('shortcode') === 'item') _.extend(new_params, {
        id: +new Date() + '-' + this.$tabs.find('[data-element-type=item]').length + '-' + Math.floor(Math.random() * 11)
      });
      if (model.get('shortcode') === 'pricing_column') _.extend(new_params, {
        id: +new Date() + '-' + this.$tabs.find('[data-element-type=pricing_column]').length + '-' + Math.floor(Math.random() * 11)
      });
      if (model.get('shortcode') === 'testimonial') _.extend(new_params, {
        id: +new Date() + '-' + this.$tabs.find('[data-element-type=testimonial]').length + '-' + Math.floor(Math.random() * 11)
      });
      if (model.get('shortcode') === 'client') _.extend(new_params, {
        id: +new Date() + '-' + this.$tabs.find('[data-element-type=client]').length + '-' + Math.floor(Math.random() * 11)
      });
      if (model.get('shortcode') === 'nectar_icon_list_item') _.extend(new_params, {
        id: +new Date() + '-' + this.$tabs.find('[data-element-type=nectar_icon_list_item]').length + '-' + Math.floor(Math.random() * 11)
      });
      if (model.get('shortcode') === 'page_link') _.extend(new_params, {
        id: +new Date() + '-' + this.$tabs.find('[data-element-type=page_link]').length + '-' + Math.floor(Math.random() * 11)
      });
      ...
      if (model.get('shortcode') === 'tab') {
        model_clone = Shortcodes.create({
          ...
          parent_id: parent_id,
          order: new_order,
          cloned: model.get('shortcode') === 'tab' ? false : true,
          cloned_from: model.toJSON(),
          params: new_params
        });
        ...
        model_clone = Shortcodes.create({
          ...
          parent_id: parent_id,
          order: new_order,
          cloned: model.get('shortcode') === 'pricing_column' ? false : true,
          cloned_from: model.toJSON(),
          params: new_params
        });
        ...
        model_clone = Shortcodes.create({
          ...
          parent_id: parent_id,
          order: new_order,
          cloned: model.get('shortcode') === 'testimonial' ? false : true,
          cloned_from: model.toJSON(),
          params: new_params
        });
        ...
        model_clone = Shortcodes.create({
          ...
          parent_id: parent_id,
          order: new_order,
          cloned: model.get('shortcode') === 'client' ? false : true,
          cloned_from: model.toJSON(),
          params: new_params
        });
        ...
        model_clone = Shortcodes.create({
          ...
          parent_id: parent_id,
          order: new_order,
          cloned: model.get('shortcode') === 'nectar_icon_list_item' ? false : true,
          cloned_from: model.toJSON(),
          params: new_params
        });
        ...
        model_clone = Shortcodes.create({
          ...
          parent_id: parent_id,
          order: new_order,
          cloned: model.get('shortcode') === 'page_link' ? false : true,
          cloned_from: model.toJSON(),
          params: new_params
        });
        ...
        model_clone = Shortcodes.create({
          ...
          parent_id: parent_id,
          order: new_order,
          cloned: model.get('shortcode') === 'item' ? false : true,
          cloned_from: model.toJSON(),
          params: new_params
        });
    ...
    render: function render() {
      ...
      window.VcTabView.__super__.render.call(this); //if(!params.tab_id) {


      params.tab_id = +new Date() + '-' + Math.floor(Math.random() * 11); //this.model.save('params', params);
      //}
    ...
    cloneModel: function cloneModel(model, parent_id, save_order) {
      ...
      if (model.get('shortcode') === 'tab' || model.get('shortcode') === 'client' || model.get('shortcode') === 'nectar_icon_list_item' || model.get('shortcode') === 'page_link' || model.get('shortcode') === 'testimonial' || model.get('shortcode') === 'pricing_column' || model.get('shortcode') === 'item') _.extend(new_params, {
        id: +new Date() + '-' + this.$tabs.find('[data-element_type=tab]').length + '-' + Math.floor(Math.random() * 11)
      });
    ...
    clickAppendSection: function clickAppendSection(e) {
      e && e.preventDefault && e.preventDefault(), this.addSection();
    },
    clickPrependSection: function clickPrependSection(e) {
      e && e.preventDefault && e.preventDefault(), this.addSection(!0);
    },
    addSection: function addSection(params) {
      params = {
    ...
    updateSorting: function updateSorting(event, ui) {
      var self;
    ...
    makeFirstSectionActive: function makeFirstSectionActive() {
      this.$content.children(":first-child").addClass(this.activeClass);
    },
    checkForActiveSection: function checkForActiveSection() {
      this.$content.children("." + this.activeClass).length || this.makeFirstSectionActive();
    },
    changeActiveSection: function changeActiveSection(modelId) {
    ...
    changedContent: function changedContent(_changedContent) {
      _changedContent = window.VcBackendTtaViewInterface.__super__.changedContent.call(this, _changedContent);
      return this.checkForActiveSection(), this.buildSortable(this.$sortable), _changedContent;
    },
    notifySectionChanged: function notifySectionChanged(title) {
    ...
    notifySectionRendered: function notifySectionRendered(model) {},
    getNextTab: function getNextTab($nextTab) {
    ...
    renderSortingPlaceholder: function renderSortingPlaceholder(event, element) {
    ...
    setNavigationSectionTemplate: function setNavigationSectionTemplate(html) {
    ...
    getNavigationSectionTemplate: function getNavigationSectionTemplate() {
      return this.navigationSectionTemplate;
    },
    getParsedNavigationSectionTemplate: function getParsedNavigationSectionTemplate(data) {
      return this.navigationSectionTemplateParsed(data);
    },
    changeNavigationSectionTitle: function changeNavigationSectionTitle(modelId, title) {
    ...
    notifySectionChanged: function notifySectionChanged(model) {
      var title;
    ...
    findNavigationTab: function findNavigationTab(modelId) {
      return this.$navigation.children('[data-vc-target-model-id="' + modelId + '"]');
    },
    removeSection: function removeSection($nextTab) {
    ...
    renderSortingPlaceholder: function renderSortingPlaceholder(event, currentItemHeight) {
    ...
    removeSection: function removeSection($viewTab) {
    ...
    addShortcode: function addShortcode(view) {
    ...
    updateParentNavigation: function updateParentNavigation() {
  ...
  function processImages(attachments, callback) {
    ...
    $.ajax({
      ...
      if ("function" == typeof callback) {
        for (models = [], i = 0; i < response.data.ids.length; i++) {
          attachment = (attachment = "function" == typeof attachment ? attachments.get(response.data.ids[i]) : attachments[response.data.ids[i]]) || media.model.Attachment.get(response.data.ids[i]), models.push(attachment);
        }

        var promises = function (models) {
          for (var promises = [], i = 0; i < models.length; i++) {
            models[i].get("url") || promises.push(models[i].fetch());
          }
  ...
  attachmentCompatRender = _.extend(media.view.AttachmentCompat.prototype.render), media.view.AttachmentCompat.prototype.render = function () {
    ...
    init: function init() {
      ...
      $("body").unbind("click.vcGalleryWidget").on("click.vcGalleryWidget", ".gallery_widget_add_images", function (event) {
        ...
        if ($('select[name=type]').length > 0 && $('select[name=type]').val() == 'image_grid' || $('select[name=type]').length > 0 && $('select[name=type]').val() == 'parallax_image_grid') head.appendChild(style);
    ...
    $(".media-modal").addClass("processing-media"), processImages(selection, function (attachments) {
      var objects,
          attachments = _.map(attachments, function (newAttachment) {
...
}(window.jQuery, window._), function ($) {
  "use strict";

  var vcPointerMessage = function vcPointerMessage(target, pointerOptions, texts) {
  ...
  vcPointerMessage.prototype = {
    ...
    domButtonsWrapper: function domButtonsWrapper() {
      return $('<div class="vc_wp-pointer-controls" />');
    },
    domCloseBtn: function domCloseBtn() {
      return $('<a class="vc_pointer-close close">' + this.texts.finish + "</a>");
    },
    domNextBtn: function domNextBtn() {
    ...
    domPrevBtn: function domPrevBtn() {
    ...
    openedEvent: function openedEvent(a, b) {
  ...
  var vcPointersController = function vcPointersController(Pointer, texts) {
  ...
  vcPointersController.prototype = {
    ...
    getPointer: function getPointer(index) {
    ...
    setShowEventHandler: function setShowEventHandler() {
      var showEvent;
    ...
    setCloseEventHandler: function setCloseEventHandler() {
      var closeEvent;
    ...
    nextOnEvent: function nextOnEvent() {
    ...
    buttonsEvent: function buttonsEvent() {
    ...
    clickEventClose: function clickEventClose() {
      this.close(), this.dismissMessages();
    },
    clickEventNext: function clickEventNext() {
      this.close(), this.next();
    },
    clickEventPrev: function clickEventPrev() {
...
}(window.jQuery), window.jQuery, vc_user_access().partAccess("unfiltered_html") || vc.showMessage(window.i18nLocale.unfiltered_html_access, "type-error", 15e3), function () {
  "use strict";
  ...
  var undo_redo_core = {
    ...
    setZeroState: function setZeroState(data) {
  ...
  $(function () {
    ...
    window.vc && window.vc.events && ($undoControl = $("#vc_navbar-undo"), $redoControl = $("#vc_navbar-redo"), checkControls = function checkControls() {
      $undoControl.attr("disabled", !window.vc.undoRedoApi.canUndo()), $redoControl.attr("disabled", !window.vc.undoRedoApi.canRedo());
    }, renderNewContent = function renderNewContent(content) {
