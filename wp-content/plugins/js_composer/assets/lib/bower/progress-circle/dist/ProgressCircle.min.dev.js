...
!function (window, document) {
  function absPos(element) {
    ...
    if (element.offsetParent) for (; offsetLeft += element.offsetLeft, offsetTop += element.offsetTop, element = element.offsetParent;) {
      ;
    }
  ...
  var Circle = function Circle(style) {
    var arcDistance, infoText;
  ...
  Circle.prototype = {
    ...
    _drawInfo: function _drawInfo() {
      var lineHeight = [[this.infoLineStartX, this.infoLineStartY], [this.infoLineMidX, this.infoLineMidY], [this.infoLineEndX, this.infoLineEndY]];
      return this._drawSegments(lineHeight, !1), this.infoText.innerHTML = this.info, lineHeight = this.infoText.offsetHeight, this.infoText.style.top = this.infoLineEndY + absPos(this.canvas)[1] - lineHeight / 2 + "px", this;
    },
    _drawSegments: function _drawSegments(pointList, close) {
      var ctx = this.context;
