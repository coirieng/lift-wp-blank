    ...
    for (var t in this.states) {
      ...
      for (var a = 0; a < n.length; a++) {
        ...
        if (Array.isArray(f.token)) {
          if (f.token.length == 1 || c == 1) f.token = f.token[0];else {
  ...
  (function () {
    ...
    var e = function e(_e, t) {
      return (_e != "start" || t.length) && t.unshift(this.nextState, _e), this.nextState;
        ...
        t = function t(e, _t2) {
      return _t2.shift(), _t2.shift() || "start";
    };
  ...
  (function () {
    this.updateSelectionMarkers = function () {
      ...
      for (var l = o.ranges.length; l--;) {
        if (n) while (l > 0 && o.ranges[l].start.row == o.ranges[l - 1].end.row) {
          l--;
        }
...
(function () {
  ace.require(["ace/ace"], function (a) {
    ...
    for (var key in a) {
      if (a.hasOwnProperty(key)) ace[key] = a[key];
    }
  });
})();