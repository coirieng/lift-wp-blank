...
!function ($) {
  ...
  Tab.VERSION = "3.1.1", Tab.prototype.show = function () {
    ...
    $this.parent("li").hasClass("active") || (previous = $ul.find(".active:last a")[0], e = $.Event("show.bs.tab", {
      relatedTarget: previous
    }), $this.trigger(e), e.isDefaultPrevented() || ($target = $($target), this.activate($this.closest("li"), $ul), this.activate($target, $target.parent(), function () {
      $this.trigger({
        type: "shown.bs.tab",
        relatedTarget: previous
      });
