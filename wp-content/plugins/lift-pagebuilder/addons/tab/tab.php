	...
	public function get_settings() {
		$settings = array(
			...
			'horizontal_align' => array(
				'type' => 'select',
				'title' => __('Horizontal Alignment','lift-pagebuilder'),
				'depends' => array(array('tabtype', '=', 'horizontal')),
				'values' => array(
					'horizontalleft' => __('Left','lift-pagebuilder'),
					'horizontalcenter' => __('Center','lift-pagebuilder'),
					'horizontalright' => __('Right','lift-pagebuilder'),
				),
				'std' => 'horizontalleft',
			),
			'vertical_position' => array(
				'type' => 'select',
				'title' => __('Navbar Position','lift-pagebuilder'),
				'depends' => array(array('tabtype', '=', 'vertical')),
				'values' => array(
					'verticalleft' => __('Left','lift-pagebuilder'),
					'verticalright' => __('Right','lift-pagebuilder'),
				),
				'std' => 'verticalleft',
			),
			'navbar_width' => array(
				'type' => 'slider',
				'title' => __('Nav Bar width','lift-pagebuilder'),
				'unit' => array( '%','px','em' ),
				'range' => array(
						'em' => array(
							'min' => 0,
			...
			'tab_list' => array(
				'title' => __('Add Tab Item','lift-pagebuilder'),
				'type' => 'repeatable',
				'label' => 'title',
				'std' => array(
					array(
				...
				'attr' => array(
					...
					'icon_position' => array(
						...
						'values' => array(
							...
							'top' => __('Top','lift-pagebuilder'),
							'bottom' => __('Bottom','lift-pagebuilder'),
						),
						'std' => 'left',
					),
					'content' => array(
			...
			'nav_hover_bg' => array(
				'type' => 'color',
				'title' => __('Hover background Color','lift-pagebuilder'),
				'tab' => 'style',
				'section' => 'Nav bar item',
				'std'   => '#fafafa',
			...
			'nav_active_bg' => array(
				'type' => 'color',
				'title' => __('Active background Color','lift-pagebuilder'),
				'tab' => 'style',
				'section' => 'Nav bar item',
				'std'   => '#fff',
			...
			'icon_active_color' => array(
				'type' => 'color',
				'title' => __('Active/hover color','lift-pagebuilder'),
				'tab' => 'style',
				'section' => 'Icon',
			...
			'icon_bg_active_color' => array(
				'type' => 'color',
				'title' => __('Active/hover Background color','lift-pagebuilder'),
				'tab' => 'style',
				'section' => 'Icon',
