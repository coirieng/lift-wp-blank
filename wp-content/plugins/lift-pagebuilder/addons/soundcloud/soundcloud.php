...
class WPPB_Addon_Soundcloud{
	...
	public function get_settings() {
		...
		$settings = array(
			...
			'link' => array(
				'type' => 'text',
				'title' => __('SoundCloud URL','lift-pagebuilder'),
				'std' => 'https://soundcloud.com/the-bugle/bugle-179-playas-gon-play',
			),
			'visual_player' => array(
				'type' => 'switch',
				'title' => __('Visual Player','lift-pagebuilder'),
				'std' => '0'
			),
			'autoplay' => array(
				'type' => 'switch',
				'title' => __('Auto Play','lift-pagebuilder'),
				'std' => '0'
			),
			'buy_button' => array(
				'type' => 'switch',
				'title' => __('Buy Button','lift-pagebuilder'),
				'std' => '0'
			),
			'download' => array(
				'type' => 'switch',
				'title' => __('Download','lift-pagebuilder'),
				'std' => '0'
			),
			'share_button' => array(
				'type' => 'switch',
				'title' => __('Share Button','lift-pagebuilder'),
				'std' => '0'
			),
			'play_count' => array(
				'type' => 'switch',
				'title' => __('Play Count','lift-pagebuilder'),
				'std' => '0'
			),
			'username' => array(
				'type' => 'switch',
				'title' => __('Username','lift-pagebuilder'),
				'std' => '0'
			),
			'control_color' => array(
				'type' => 'color',
				'title' => __('Controls Color','lift-pagebuilder'),
				'std' => '#444444',
				'tab' => 'style',
			),
			'height' => array(
