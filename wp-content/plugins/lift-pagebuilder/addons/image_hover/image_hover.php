...
class WPPB_Addon_Image_Hover{
	...
	public function get_settings() {
		...
		$settings = array(
			'layout' => array(
				'type' => 'radioimage',
				'title' => __('Select layout','lift-pagebuilder'),
				'values' => array(
			...
			'content_position' => array(
				'type' => 'select',
				'title' => __('Content Position','lift-pagebuilder'),
				'values' => array(
					'topleft' => __('Top Left','lift-pagebuilder'),
					'topcenter' => __('Top Center','lift-pagebuilder'),
					'topright' => __('Top Right','lift-pagebuilder'),
					'middletop' => __('Middle Left','lift-pagebuilder'),
					'middlecenter' => __('Middle Center','lift-pagebuilder'),
					'middleright' => __('Middle Right','lift-pagebuilder'),
					'bottomleft' => __('Bottom Left','lift-pagebuilder'),
					'bottomcenter' => __('Bottom Center','lift-pagebuilder'),
					'bottomright' => __('Bottom Right','lift-pagebuilder'),
				),
			...
			'title_show' => array(
				'type' => 'switch',
				'title' => __('Show Title','lift-pagebuilder'),
				'std' => '1',
				'section' => 'Title',
			),
			'title' => array(
			...
			'heading_selector' => array(
				'type' => 'select',
				'title' => __('Title HTML Element','lift-pagebuilder'),
				'values' => array(
					'h1' => 'h1',
					'h2' => 'h2',
					'h3' => 'h3',
			...
			'title_link' => array(
				...
				'title' => __('Add title link','lift-pagebuilder'),
				'depends' => array(array('title_show', '=', '1')),
				'section' => 'Title',
			),
			...
			'subtitle_show' => array(
				'type' => 'switch',
				'title' => __('Show Sub Title','lift-pagebuilder'),
				'std' => '1',
				'section' => 'Sub Title',
			),
			'subtitle' => array(
				'type' => 'textarea',
				'title' => __('Sub title','lift-pagebuilder'),
			...
			'subheading_selector' => array(
				'type' => 'select',
				'title' => __('Sub title HTML Element','lift-pagebuilder'),
				'values' => array(
					'h1' => 'h1',
					'h2' => 'h2',
					'h3' => 'h3',
			...
			'button_show' => array(
				'type' => 'switch',
				'title' => __('Hide button','lift-pagebuilder'),
				'std' => '0',
				'section' => 'Button',
			),
			'button_text' => array(
			...
			'button_link' => array(
				'type' => 'link',
				'title' => __('Add button link','lift-pagebuilder'),
				'std' => array( 'link'=>'#','window'=>false,'nofolow'=>false ),
				'depends' => array(array('button_show', '=', '1')),
				'section' => 'Button',
			),
            ...
            'overlay_bg' => array(
                'type' => 'color',
                'title' => __('Overlay Background','lift-pagebuilder'),
                'std' => '#0180fe',
            ...
            'back_bg' => array(
                'type' => 'color',
                'title' => __('Overlay Hover Background','lift-pagebuilder'),
                'std' => '#377133',
			...
			'image_hover_effect' => array(
				'type' => 'select',
				'title' => __('Animation image effect','lift-pagebuilder'),
				'values' => array(
					'slideright' => __('Slide from Right','lift-pagebuilder'),
					'slideleft' => __('Slide From Left','lift-pagebuilder'),
					'slidetop' => __('Slide From Top','lift-pagebuilder'),
					'slidebottom' => __('Slide From Bottom','lift-pagebuilder'),
					'zoomin' => __('Zoom Out','lift-pagebuilder'),
					'zoomout' => __('Zoom In','lift-pagebuilder'),
				),
				'tab'=> 'style',
				'std' => 'slideleft',
			),
			'image_height' => array(
				'type' => 'slider',
				'title' => __('Height','lift-pagebuilder'),
				'unit' => array( '%','px','em' ),
				'range' => array(
					'em' => array(
						'min' => 0,
			...
			'wrap_padding' => array(
				'type' => 'dimension',
				'title' => __('Wrap padding','lift-pagebuilder'),
				'tab'=> 'style',
				'responsive' => true,
				'unit' => array( 'px','em','%' ),
			...
			'box_title_color' => array(
				...
				'tab'=> 'style',
				'section' => __('Title','lift-pagebuilder'),
				'depends' => array(array('title_show', '=', '1')),
			),
			...
			'title_margin' => array(
				'type' => 'dimension',
				'title' => __('Title margin','lift-pagebuilder'),
				'tab'=> 'style',
				'section' => __('Title','lift-pagebuilder'),
				'responsive' => true,
				'unit' => array( 'px','em','%' ),
			...
			'title_padding' => array(
				'type' => 'dimension',
				'title' => __('Title padding','lift-pagebuilder'),
				'tab'=> 'style',
				'section' => __('Title','lift-pagebuilder'),
				'responsive' => true,
				'unit' => array( 'px','em','%' ),
			...
			'box_subtitle_color' => array(
				...
				'tab'=> 'style',
				'section' => __('Sub Title','lift-pagebuilder'),
				'depends' => array(array('subtitle_show', '=', '1')),
			),
			...
			'subtitle_margin' => array(
				'type' => 'dimension',
				'title' => __('Sub title margin','lift-pagebuilder'),
				'tab'=> 'style',
				'section' => __('Sub Title','lift-pagebuilder'),
				'responsive' => true,
				'unit' => array( 'px','em','%' ),
			...
			'button_fontstyle' => array(
				...
				'section' => __('Button','lift-pagebuilder'),
				'tab'=> 'style',
				'depends' => array(array('button_show', '=', '1')),
			),
			'button_color' => array(
			...
			'buttom_hradius' => array(
				'type' => 'dimension',
				'title' => __('Border hover radius','lift-pagebuilder'),
				'unit' => array( '%','px','em' ),
				'std' => array(
					'md' => array( 'top' => '3px', 'right' => '3px', 'bottom' => '3px', 'left' => '3px' ),
					'sm' => array( 'top' => '', 'right' => '', 'bottom' => '', 'left' => '' ),
			...
			'btn_margin' => array(
				'type' => 'dimension',
				'title' => __('Button margin','lift-pagebuilder'),
				'tab'=> 'style',
				'section' => __('Button','lift-pagebuilder'),
				'unit' => array( 'px','em','%' ),
				'responsive' => true,
			...
			'three_border_top' => array(
				...
				'section' => __('Border','lift-pagebuilder'),
			...
			'six_border_width' => array(
				'type' => 'slider',
				'title' => __('Bar Height','lift-pagebuilder'),
				'unit' => array( 'px','em','%', ),
				'range' => array(
					'em' => array(
						'min' => 0,
