	...
	public function get_settings() {
		...
		$settings = array(
			...
			'alert_description' => array(
				'type' => 'textarea',
				'title' => __('Description','lift-pagebuilder'),
			...
			'alert_close' => array(
				'type' => 'switch',
				'title' => __('Show Close Button','lift-pagebuilder'),
				'std' => '1'
			),
			//style tab
			'alert_style' => array(
				'type' => 'select',
				'title' => __('Alert style','lift-pagebuilder'),
				'values' => array(
			...
			'content_color' => array(
				'type' => 'color',
				'title' => __('Content background color','lift-pagebuilder'),
				'tab' => 'style',
			...
			'close_color' => array(
				'type' => 'color',
				'title' => __('Close color','lift-pagebuilder'),
				'tab' => 'style',
				'std' => '#e02e2e',
			...
			'close_hcolor' => array(
				'type' => 'color',
				'title' => __('Close hover color','lift-pagebuilder'),
				'tab' => 'style',
