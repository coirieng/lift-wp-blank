...
class WPPB_Addon_Form{
	...
	public function get_settings() {
		...
		$settings = array(
			...
			'wppb_default_form' => array(
				...
				'attr' => array(
					'label' => array(
						'type' => 'text',
						'title' => __('Label','lift-pagebuilder'),
					),

					'field_id' => array(
						'type' => 'text',
						'title' => __('Field ID','lift-pagebuilder'),
						'desc' => __('Define the unique ID of this field. Use only English characters without special characters and spaces.', 'lift-pagebuilder')
					),

					'placeholder' => array(
						'type' => 'text',
						'title' => __('Placeholder','lift-pagebuilder'),
						'std' => '',
					...
					'require' => array(
						'type' => 'switch',
						'title' => __('Required Field', 'lift-pagebuilder'),
						'std' => '1',
						'desc' => __('Define whether the field should be required or optional', 'lift-pagebuilder'),
					),
					...
					'radio_field_options' => array(
						'title'     => __('Add Option', 'lift-pagebuilder'),
						'type'      => 'repeatable',
						'label' => 'label',
						'std'       => array(),
						'attr' => array(
							'label' => array(
								'type' => 'text',
								'title' => __('Radio Name','lift-pagebuilder'),
								'std' => '',
							),
						),
					...
					'checkbox_field_options' => array(
						...
						'attr' => array(
							'label' => array(
								'type' => 'text',
								'title' => __('Checkbox Name','lift-pagebuilder'),
								'std' => '',
							),
						),
					...
					'select_options' => array(
						'title'     => __('Select Option', 'lift-pagebuilder'),
						'type'      => 'repeatable',
						'std'       => array(),
						'label' => 'label',
						'attr' => array(
							'label' => array(
								'type' => 'text',
								'title' => __('Option Name','lift-pagebuilder'),
								'std' => '',
							),
						),
			...
			'wppb_default_form_to_email' => array(
				'type' => 'text',
				'title' => __('Recipient E-Mail','lift-pagebuilder'),
				'std' => $admin_email,
				'section' => 'Email',
				'depends' => array(array('form_type', '=', array('wppb_default_form'))),
			),
			'wppb_default_form_from_email' => array(
				'type' => 'text',
				'title' => __('From E-Mail','lift-pagebuilder'),
				'std' => $admin_email,
				'section' => 'Email',
				'depends' => array(array('form_type', '=', array('wppb_default_form'))),
			),
			'wppb_default_form_subject' => array(
				'type' => 'text',
				'title'     => __('Subject','lift-pagebuilder'),
				'std'       => __('A new query has been placed at {datetime}','lift-pagebuilder'),
				'section'   => 'Email',
				'desc' => __('You can set veraible for date time, available variable, <strong>{date}, {time}, {datetime}</strong>', 'lift-pagebuilder'),
				'depends'   => array(array('form_type', '=', array('wppb_default_form'))),
			),
			'email_format' => array(
				'type' => 'textarea',
				'title' => __('Message Format', 'lift-pagebuilder'),
				'std' => '',
				'section' => 'Email',
				'desc' => __('Custom Message format for this form, should be use like, <strong>My Message is {Message}</strong>', 'lift-pagebuilder'),
				'depends' => array(array('form_type', '=', array('wppb_default_form'))),
			),
			'success_message' => array(
				'type' => 'text',
				'title' => __('Success Message','lift-pagebuilder'),
				'std' => '',
				'section' => 'Email',
				'desc' => __('Type the message you want to display after successful form submission. Leave blank for default', 'lift-pagebuilder'),
				'depends' => array(array('form_type', '=', array('wppb_default_form'))),
			),

			'enable_redirect_url' => array(
				'type' => 'switch',
				'title' => __('Enable Redirect URL', 'lift-pagebuilder'),
				'std' => '0', // value 0 or 1,
				'section' => 'Redirect',
				'desc' => __('Define whether the field should be required or optional', 'lift-pagebuilder'),
				'depends' => array(array('form_type', '=', array('wppb_default_form'))),
			...
			'redirect_url' => array(
				'type' => 'text',
				'title' => __('Redirect URL','lift-pagebuilder'),
				'std' => '',
				'section' => 'Redirect',
				'desc' => __('Your redirect URL will be here', 'lift-pagebuilder'),
				'depends' => array(array('form_type', '=', 'wppb_default_form'), array('enable_redirect_url', '=', '1') ),
			),

			'enable_simple_recaptcha' => array(
				'type' => 'switch',
				'title' => __('Enable Simple ReCAPTCHA', 'lift-pagebuilder'),
				'std' => '0', // value 0 or 1,
				'section' => 'Security',
				'desc' => __('Enable or disable Simple ReCAPTCHA', 'lift-pagebuilder'),
				'depends' => array(array('form_type', '=', array('wppb_default_form')), array('enable_google_recaptcha', '!=', '1')),
			),
			'enable_google_recaptcha' => array(
				'type' => 'switch',
				'title' => __('Enable Google ReCAPTCHA', 'lift-pagebuilder'),
				'std' => '0', // value 0 or 1,
				'section' => 'Security',
				'desc' => __('Enable or disable Google ReCAPTCHA', 'lift-pagebuilder'),
				'depends' => array(array('form_type', '=', array('wppb_default_form')), array('enable_simple_recaptcha', '!=', '1')),
			),
			/*
			'wppb_form_recaptcha_question' => array(
				'type' => 'text',
				'title' => __('Set Question','lift-pagebuilder'),
				'std' => '3+6',
				'desc' => __('Set your question which will answer by form user, such as {addition 3+6 ?} ', 'lift-pagebuilder'),
				'section' => 'Security',
				'depends' => array(array('form_type', '=', array('wppb_default_form')), array('enable_simple_recaptcha', '=', '1')),
			),
			...
			'wppb_form_recaptcha_answer' => array(
				'type' => 'text',
				'title' => __('Set Answer','lift-pagebuilder'),
				'std' => '9',
				'desc' => __('Users answer have to match with this', 'lift-pagebuilder'),
				'section' => 'Security',
				'depends' => array(array('form_type', '=', array('wppb_default_form')), array('enable_simple_recaptcha', '=', '1')),
			),*/
			...
			'google_recaptcha_site_key' => array(
				'type' => 'text',
				'title' => __('Site key','lift-pagebuilder'),
				'std' => '',
				'desc' => __('Use this in the HTML code your site serves to users.', 'lift-pagebuilder'),
				'section' => 'Security',
				'depends' => array(array('form_type', '=', array('wppb_default_form')), array('enable_google_recaptcha', '=', '1')),
			),
			'google_recaptcha_secret_key' => array(
				'type' => 'text',
				'title' => __('Secret key','lift-pagebuilder'),
				'std' => '',
				'desc' => __('Use this for communication between your site and Google. Be sure to keep it a secret.', 'lift-pagebuilder'),
				'section' => 'Security',
				'depends' => array(array('form_type', '=', array('wppb_default_form')), array('enable_google_recaptcha', '=', '1')),
			),
			...
			'button_text' => array(
				'type' => 'text',
				'title' => __('Button text','lift-pagebuilder'),
				'std' => 'Submit Form',
				'section' => 'Button',
				'depends' => array(array('form_type', '=', array('wppb_default_form'))),
			),
			'icon_list' => array(
				'type' => 'icon',
				'title' => __('Button icon','lift-pagebuilder'),
				'std' => '',
				'section' => 'Button',
				'depends' => array(array('form_type', '=', array('wppb_default_form'))),
			),
			'icon_position' => array(
				'type' => 'select',
				'title' => __('Button icon position','lift-pagebuilder'),
			...
			'vertical_form_space' => array(
				'type' => 'slider',
				'title' => __('Vertical Spacing','lift-pagebuilder'),
				'unit' => array( 'px','%','em' ),
				'range' => array(
					'em' => array(
						'min' => 0,
			...
			'horizontal_form_space' => array(
				'type' => 'slider',
				'title' => __('Horizontal Spacing','lift-pagebuilder'),
				'unit' => array( 'px','%','em' ),
				'range' => array(
					'em' => array(
						'min' => 0,
			...
			'input_fontstyle' => array(
				'type' => 'typography',
				'title' => __('Input Typography','lift-pagebuilder'),
				'std' => array(
					'fontFamily' => '',
			...
			'input_color' => array(
				'type' => 'color',
				'title' => __('Input color','lift-pagebuilder'),
				'tab' => 'style',
				'section' => 'Form Style',
				'std' => '#454545',
			...
			'input_shadow' => array(
				...
				'tab' => 'style',
				'section' => 'Form Style',
				'title' => __('Input Boxshadow','lift-pagebuilder'),
				'std' => array(
			...
			'paceholder_color' => array(
				'type' => 'color',
				'title' => __('Placeholder color','lift-pagebuilder'),
				'tab' => 'style',
				'section' => 'Form Style',
				'std' => '#d5d5d5',
			...
			'input_bg' => array(
				'type' => 'color',
				'title' => __('Input background color','lift-pagebuilder'),
				'tab' => 'style',
				'section' => 'Form Style',
				'std' => '',
			...
			'radio_bg' => array(
				'type' => 'color',
				'title' => __('Radio/Checkbok active bg color','lift-pagebuilder'),
				'tab' => 'style',
				'section' => 'Form Style',
				'std' => '#00a7ff',
				'depends' => array(array('form_type', '=', array('wppb_default_form'))),
			...
			'input_focus_color' => array(
				'type' => 'border',
				'title' => __('Input focus boder color','lift-pagebuilder'),
				'tab' => 'style',
				'section' => 'Form Style',
				'std' => array(
					'itemOpenBorder' => 1,
			...
			'input_radius' => array(
				'type' => 'dimension',
				'title' => __('Input border radius','lift-pagebuilder'),
				'unit' => array( 'px','%','em' ),
				'std' => array(
			...
			'textarea_resize' => array(
				'type' => 'switch',
				'title' => __('Textarea resize','lift-pagebuilder'),
				'std' => '0',
				'tab' => 'style',
				'section' => 'Form Style',
			),
			...
			'label_show' => array(
				'type' => 'switch',
				'title' => __('Label button','lift-pagebuilder'),
				'std' => '1',
				'tab' => 'style',
				'section' => 'Label',
			),
			'label_fontstyle' => array(
				'type' => 'typography',
				'title' => __('Label Typography','lift-pagebuilder'),
				'std' => array(
					'fontFamily' => '',
					'fontSize' => array( 'md'=>'14px', 'sm'=>'', 'xs'=>'' ),
					'lineHeight' => array( 'md'=>'', 'sm'=>'', 'xs'=>'' ),
			...
			'label_color' => array(
				'type' => 'color',
				'title' => __('label Color','lift-pagebuilder'),
				'tab' => 'style',
				'section' => 'Label',
				'std'     => '#353535',
				'depends' => array(array('label_show', '=', '1')),
			...
			'button_hcolor' => array(
				'type' => 'color',
				'title' => __('Hover color','lift-pagebuilder'),
				'tab' => 'style',
				'section' => 'Button',
				'std'     => '#ffffff',
			...
			'button_bg' => array(
				'type' => 'color2',
				'title' => __('Background','lift-pagebuilder'),
				'tab' => 'style',
				'section' => 'Button',
				'clip' => false,
				'std' => array(
			...
			'button_radius' => array(
				'type' => 'dimension',
				'title' => __('Button radius','lift-pagebuilder'),
				'unit' => array( 'px','%','em' ),
				'std' => array(
      ...
      'button_hover_radius' => array(
				'type' => 'dimension',
				'title' => __('Button hover radius','lift-pagebuilder'),
				'unit' => array( 'px','%','em' ),
				'std' => array(
					'md' => array( 'top' => '5px', 'right' => '5px', 'bottom' => '5px', 'left' => '5px' ),
					'sm' => array( 'top' => '', 'right' => '', 'bottom' => '', 'left' => '' ),
            ...
            <form method="post" enctype="multipart/form-data" class="wppb-form-addon">
				...
				<?php if ($enableSimpleRecaptcha){ ?>
                    <div class="wppb-custom-recaptcha">
                        <span class="wppb-form-recaptcha-input"><input type="text" name="wppb_default_form[wppb_form_recaptcha_answer]" data-required="true" placeholder="10+5 = ?" data-label="<?php _e("WPPB Simple reCaptcha", 'lift-pagebuilder'); ?>"/></span>
                    </div>
				<?php } ?>
	...
	public function wppb_form_process(){
		...
		if ( ! isset($formAddonData['addon_id']) || ! isset($formAddonData['page_id'])){
			wp_send_json_error( __('Form data error', 'lift-pagebuilder') );
		}
		...
		//$responseData['msg'] = __('Something went wrong, please try again later', 'lift-pagebuilder');
		...
		if ($enableSimpleRecaptcha){
			...
			if (15 != $usersAnswere){
				$responseData['msg'] = __('recaptcha answer does not matched', 'lift-pagebuilder');
		...
		try{
			...
			if ( $isMail ) {
				$responseData['msg'] = __('Thank you for submitting form', 'lift-pagebuilder');
	...
	public function googleReCaptchaVerify($recapcha_secret_key = ''){
		$response_msg = array();
		$response_msg['msg'] = __('Something went wrong, please try again later', 'lift-pagebuilder');

		$url = 'https://www.google.com/recaptcha/api/siteverify';
		$g_response = isset($_POST['g-recaptcha-response']) ? sanitize_text_field($_POST['g-recaptcha-response']) : '';

		if ( ! $g_response){
			$response_msg['msg'] = __('Check reCaptcha required', 'lift-pagebuilder');
