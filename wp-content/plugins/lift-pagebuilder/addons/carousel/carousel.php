	...
	class WPPB_Addon_Carousel {
		...
		public function get_settings() {
			...
			$settings = array(
				'arrow_option' => array(
					'type' => 'switch',
					'title' => __('Navigation Option','lift-pagebuilder'),
					'std' => '1',
					'section' => 'Slider Settings',
				),
				'control_option' => array(
					'type' => 'switch',
					'title' => __('Control Option','lift-pagebuilder'),
					'std' => '1',
					'section' => 'Slider Settings',
				),
				'autoplay_option' => array(
					'type' => 'switch',
					'title' => __('Autoplay Option','lift-pagebuilder'),
					'std' => '1',
					'section' => 'Slider Settings',
				),
				'animated_speed' => array(
					'type' => 'number',
					'title' => __('Animated Speed','lift-pagebuilder'),
					'std' => '600',
					'section' => 'Slider Settings',
				...
				'slide_height' => array(
					'type' => 'slider',
					'title' => __('Slider Height','lift-pagebuilder'),
					'unit' => array( 'px','%','em' ),
					'range' => array(
						'em' => array(
							'min' => 0,
				...
				'carosuel_list' => array(
					'title' => __('Carousel','lift-pagebuilder'),
					'type' => 'repeatable',
					'label' => 'title',
					'std' => array(
						array(
					...
					'attr' => array(
						'slider_type' => array(
							'type' => 'select',
							'title' => __('Content Type','lift-pagebuilder'),
							'values' => array(
								'center_content' => __('Only Content','lift-pagebuilder'),
								'right_media' => __('Right Media','lift-pagebuilder'),
								'left_media' => __('Left Media','lift-pagebuilder'),
							),
							'std' => 'right_media',
							'section' => 'Slide',
						),
						'media_type' => array(
							'type' => 'select',
							'title' => __('Type','lift-pagebuilder'),
							'values' => array(
								'media_image' => __('Image','lift-pagebuilder'),
								'media_video' => __('Video','lift-pagebuilder'),
							),
							'std' => 'media_image',
							'section' => 'Slide',
						...
						'imageupload' => array(
							'type' => 'media',
							'title' => __('Upload content image','lift-pagebuilder'),
							'section' => 'Slide',
						...
						'video_url' => array(
							'type' => 'text',
							'title' => __('Video URL','lift-pagebuilder'),
						...
						'video_info' => array(
							'type' => 'switch',
							'title' => __('Hide video info','lift-pagebuilder'),
							'std' => '1',
							'depends' => array(array('media_type', '=', array('media_video'))),
							'section' => 'Slide',
						),
						...
						'content_align' => array(
							'type' => 'alignment',
							'title' => __('Content Alignment','lift-pagebuilder'),
						...
						'subselector' => array(
							'type' => 'select',
							'title' => __( 'Sub Title Tag','lift-pagebuilder' ),
							'values' => array(
								'h1' => 'h1',
								'h2' => 'h2',
								'h3' => 'h3',
						...
						'content' => array(
							'type' => 'textarea',
							'title' => __('Add content','lift-pagebuilder'),
						...
						'intro_color' => array(
							'type' => 'color',
							'title' => __('Content text color','lift-pagebuilder'),
							'section' => 'Content',
						...
						'button_link' => array(
							'type' => 'link',
							'title' => __('Button link','lift-pagebuilder'),
							'section' => 'Button one',
						),
						...
						'btn_hover_background' => array(
							'type' => 'color2',
							'title' => __('Button Hover Background','lift-pagebuilder'),
							'section' => 'Button one',
							'clip' => false,
							'std' => array(
								'clip' => false,
						...
						'button_text2' => array(
							'type' => 'text',
							'title' => __('Button text 2','lift-pagebuilder'),
							'section' => 'Button two',
							'std' => 'button'
						),
						'button_link2' => array(
							'type' => 'link',
							'title' => __('Button link 2','lift-pagebuilder'),
							'section' => 'Button two',
						),
						...
						'btn_color2' => array(
							'type' => 'color',
							'title' => __('Button Color 2','lift-pagebuilder'),
							'clip' => true,
							'std' => '#fff',
							'section' => 'Button two',
						...
						'btn_hover_color2' => array(
							'type' => 'color',
							'title' => __('Button Hover Color 2','lift-pagebuilder'),
							'section' => 'Button two',
							'selector' => '{{SELECTOR}} .wppb-btn-carousel2:hover { color: {{data.btn_hover_color2}}; }'
						),
						'btn_background2' => array(
							'type' => 'color2',
							'title' => __('Button Background 2','lift-pagebuilder'),
							'section' => 'Button two',
							'clip' => false,
							'std' => array(
								'clip' => false,
						...
						'btn_hover_background2' => array(
							'type' => 'color2',
							'title' => __('Button Hover Background 2','lift-pagebuilder'),
							'section' => 'Button two',
							'clip' => false,
							'std' => array(
								'clip' => false,
						...
						'btn_radius2' => array(
							'type' => 'dimension',
							'title' => __('Border 2 Radius','lift-pagebuilder'),
							'unit' => array( 'px','%','em' ),
							'responsive' => true,
							'section' => 'Button two',
						...
						'carosuel_bg' => array(
							'type' => 'background',
							'title' => __('Background image','lift-pagebuilder'),
							'section' => 'Background',
							'std' => '',
						...
						'overlay_en' => array(
							'type' => 'switch',
							'title' => __('Overlay hide','lift-pagebuilder'),
							'std' => '0',
							'section' => 'Background',
						),
						'carosuel_bg_overlay' => array(
							'type' => 'color2',
							'title' => __('Background Image overlay','lift-pagebuilder'),
							'section' => 'Background',
							'clip' => false,
							'std' => array(
								'clip' => false,
				...
				'nav_color' => array(
					'type' => 'color',
					'title' => __('Nav Color','lift-pagebuilder'),
					'tab' => 'style',
					'section' => 'Nav',
					'std'     => '#fff',
				...
				'nav_bg' => array(
					'type' => 'color2',
					'title' => __('Nav Background','lift-pagebuilder'),
					'tab' => 'style',
					'section' => 'Nav',
					'clip' => false,
					'std' => array(
				...
				'nav_width' => array(
					'type' => 'slider',
					'title' => __('Nav width','lift-pagebuilder'),
					'unit' => array( 'px','%','em' ),
					'range' => array(
						'em' => array(
							'min' => 0,
				...
				'nav_height' => array(
					'type' => 'slider',
					'title' => __('Nav height','lift-pagebuilder'),
					'unit' => array( 'px','%','em' ),
					'range' => array(
						'em' => array(
							'min' => 0,
				...
				'nav_position' => array(
					'type' => 'slider',
					'title' => __('Nav Position','lift-pagebuilder'),
					'range' => array(
						'em' => array(
							'min' => 0,
							'max' => 10,
				...
				'dot_bg' => array(
					'type' => 'color2',
					'title' => __('Dots Background','lift-pagebuilder'),
					'tab' => 'style',
					'section' => 'Dots',
					'clip' => false,
					'std' => array(
				...
				'dots_width' => array(
					'type' => 'slider',
					'title' => __('Dots width','lift-pagebuilder'),
					'unit' => array( 'px','%','em' ),
					'range' => array(
						'em' => array(
							'min' => 0,
				...
				'dots_height' => array(
					'type' => 'slider',
					'title' => __('Dots height','lift-pagebuilder'),
					'unit' => array( 'px','%','em' ),
					'range' => array(
						'em' => array(
							'min' => 0,
				...
				'dots_position' => array(
					'type' => 'slider',
					'title' => __('Dots Position','lift-pagebuilder'),
					'range' => array(
						'em' => array(
							'min' => 0,
							'max' => 10,
