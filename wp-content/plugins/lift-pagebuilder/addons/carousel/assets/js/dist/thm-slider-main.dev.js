...
jQuery(document).ready(function ($) {
  ...
  $('.wppb-carousel').each(function (index, $value) {
    ...
    var slickOptions = {
      ...
      prevArrow: '<span class="wppb-carousel-prev"><i class="fas fa-angle-left"></i></span>' //dots: true,
  ...
  $(document).on('rendered_addon', function (e, addon) {
    ...
    if (typeof addon.type !== 'undefined' && addon.type === 'addon' && addon.name === 'wppb_carousel') {
      var $sliderWrap = $(iframe).find('.wppb-carousel');
      $sliderWrap.each(function (index, $value) {
        ...
        if (addonID === parseInt(addon.id)) {
          ...
          var slickOptions = {
            ...
            prevArrow: '<span class="wppb-carousel-next"><i class="fas fa-angle-right"></i></span>' //dots: true,
