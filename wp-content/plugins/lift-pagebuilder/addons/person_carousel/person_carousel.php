...
class WPPB_Addon_Person_Carousel{
	...
	public function get_settings() {
		...
		$settings = array(
			...
			'person_list' => array(
				'title' => __('Person List','lift-pagebuilder'),
				'type' => 'repeatable',
				'label' => 'name',
				'std' => array(
					array(
				...
				'attr' => array(
					'image' => array(
						'type' => 'media',
						'title' => __('Image','lift-pagebuilder'),
						'std' => array( 'url' => WPPB_DIR_URL.'assets/img/placeholder/wppb-medium.jpg' ), 
					),
					'name' => array(
						'type' => 'text',
						'title' => __('Name','lift-pagebuilder'),
						'std' => 'Jhon Doe',
					),
					'name_link' => array(
						'type' => 'link',
						'title' => __('Profile URL','lift-pagebuilder'),
						'std' =>   array('link'=>'','window'=>false,'nofolow'=>false),
					),
					'email' => array(
						'type' => 'text',
						'title' => __('email','lift-pagebuilder'),
						'placeholder' => 'example@example.com',
					),
					'designation' => array(
						'type' => 'text',
						'title' => __('designation','lift-pagebuilder'),
						'std' => 'Designer',
					),
					'introtext' => array(
						'type' => 'textarea',
						'title' => __('Message text','lift-pagebuilder'),
						'std' => 'She was bouncing away, when a cry from the two women, who had turned towards the bed, caused her to look round.',
					),
					'show_social' => array(
						'type' => 'switch',
						'title' => __('Show Social Media URL','lift-pagebuilder'),
						'std' => '1'
					),
					'icon_list1' => array(
						'type' => 'iconsocial',
						'title' => __('Icon 1','lift-pagebuilder'),
						'std' => 'fab fa-facebook-f',
						'depends' => array(array('show_social', '!=', '')),
					),
					'socialurl1' => array(
						'type' => 'text',
						'title' => __('social URL 1','lift-pagebuilder'),
						'std' => '#',
						'depends' => array(array('show_social', '!=', '')),
					),
					'icon_list2' => array(
						'type' => 'iconsocial',
						'title' => __('Icon 2','lift-pagebuilder'),
						'std' => 'fab fa-facebook-f',
						'depends' => array(array('show_social', '!=', '')),
					),
					'socialurl2' => array(
						'type' => 'text',
						'title' => __('social URL 2','lift-pagebuilder'),
						'std' => '#',
						'depends' => array(array('show_social', '!=', '')),
					),
					'icon_list3' => array(
						'type' => 'iconsocial',
						'title' => __('Icon 3','lift-pagebuilder'),
						'std' => 'fab fa-facebook-f',
						'depends' => array(array('show_social', '!=', '')),
					),
					'socialurl3' => array(
						'type' => 'text',
						'title' => __('social URL 3','lift-pagebuilder'),
						'std' => '#',
						'depends' => array(array('show_social', '!=', '')),
					),
					'icon_list4' => array(
						'type' => 'iconsocial',
						'title' => __('Icon 4','lift-pagebuilder'),
						'std' => 'fab fa-facebook-f',
						'depends' => array(array('show_social', '!=', '')),
					),
					'socialurl4' => array(
						'type' => 'text',
						'title' => __('social URL 4','lift-pagebuilder'),
						'std' => '#',
						'depends' => array(array('show_social', '!=', '')),
					),
					'icon_list5' => array(
					...
					'socialurl5' => array(
						'type' => 'text',
						'title' => __('social URL 5','lift-pagebuilder'),
						'std' => '#',
						'depends' => array(array('show_social', '!=', '')),
					),
					'icon_list6' => array(
						'type' => 'iconsocial',
						'title' => __('Icon 6','lift-pagebuilder'),
						'std' => 'fab fa-facebook-f',
						'depends' => array(array('show_social', '!=', '')),
					),
					'socialurl6' => array(
						'type' => 'text',
						'title' => __('social URL 6','lift-pagebuilder'),
						'std' => '#',
						'depends' => array(array('show_social', '!=', '')),
					),
				),
			...
			'control_dots' => array(
				'type' => 'switch',
				'title' => __('Control Dots','lift-pagebuilder'),
				'std' => '0',
				'section' => 'Slide Settings',
			),
			'control_nav' => array(
				'type' => 'switch',
				'title' => __('Control Nav','lift-pagebuilder'),
				'std' => '1',
				'section' => 'Slide Settings',
			),
			'control_nav_style' => array(
				'type' => 'select',
				'title' => __('Style','lift-pagebuilder'),
				'values' => array(
					'nav_style1' => __('Nav Style 1','lift-pagebuilder'),
					'nav_style2' => __('Nav Style 2','lift-pagebuilder'),
					'nav_style3' => __('Nav Style 3','lift-pagebuilder'),
					'nav_style4' => __('Nav Style 4','lift-pagebuilder'),
				),
				'std' => 'nav_style1',
			...
			'column' => array(
				...
				'values' => array(
					'1' => __('Column 1','lift-pagebuilder'),
					'2' => __('Column 2','lift-pagebuilder'),
					'3' => __('Column 3','lift-pagebuilder'),
					'4' => __('Column 4','lift-pagebuilder'),
					'5' => __('Column 5','lift-pagebuilder'),
					'6' => __('Column 6','lift-pagebuilder'),
				),
				'std' => '1',
				'section' => 'Slide Settings',
			),
			...
			'img_width' => array(
				'type' => 'slider',
				'title' => __('Width','lift-pagebuilder'),
				'unit' => array( 'px','%','em' ),
				'range' => array(
						'em' => array(
							'min' => 0,
			...
			'dot_position' => array(
				'type' => 'slider',
				'title' => __('Position','lift-pagebuilder'),
				'unit' => array( '%','px','em' ),
				'range' => array(
					'em' => array(
						'min' => -20,
			...
			'dot_bg_hcolor' => array(
				'type' => 'color',
				'title' => __('Hover/active background','lift-pagebuilder'),
				'tab' => 'style',
				'section' => 'Dots Style',
			...
			'nav_left_position' => array(
				'type' => 'slider',
				'title' => __('Prev Position','lift-pagebuilder'),
				'unit' => array( 'px','em','%' ),
				'std' => array(
					'md' => '',
					'sm' => '',
			...
			'nav_right_position' => array(
				'type' => 'slider',
				'title' => __('Next Position','lift-pagebuilder'),
				'unit' => array( 'px','em','%' ),
				'range' => array(
					'em' => array(
						'min' => -50,
			...
			'nav_font_size' => array(
				'type' => 'slider',
				'title' => __('Nav Font Size','lift-pagebuilder'),
				'responsive' => true,
				'std' => array(
					'md' => '',
					'sm' => '',
			...
			'nav_bg_color' => array(
				'type' => 'color',
				'title' => __('Background color','lift-pagebuilder'),
				'tab' => 'style',
				'section' => 'Nav Style',
				'depends' => array(array('control_nav', '!=', '')),
			...
			'nav_bg_hcolor' => array(
				'type' => 'color',
				'title' => __('Background hover color','lift-pagebuilder'),
				'tab' => 'style',
				'section' => 'Nav Style',
				'depends' => array(array('control_nav', '!=', '')),
			...
			'wrap_margin' => array(
				'type' => 'slider',
				'title' => __('Margin Right','lift-pagebuilder'),
				'unit' => array( 'px','%','em' ),
				'range' => array(
						'em' => array(
							'min' => 0,
