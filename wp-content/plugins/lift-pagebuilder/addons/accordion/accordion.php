	...
	public function get_settings() {
		...
		$settings = array(
			...
			'accordion_list' => array(
				'title' => __('Accordion','lift-pagebuilder'),
				'type'  => 'repeatable',
				'label' => 'title',
				'std' => array(
					array( 
				...
				'attr' => array(
					'title' => array(
						'type' => 'text',
						'title' => __('Item title','lift-pagebuilder'),
					...
					'icon_position' => array(
						'type' => 'select',
						'title' => __('Title icon position','lift-pagebuilder'),
					...
					'content' => array(
						'type' => 'editor',
						'title' => __('Contents','lift-pagebuilder'),
						'std' => '1 year customer support',
					),
				),
			),
			'openitem' => array(
				...
				'values' => array(
					'' => __('Open first item','lift-pagebuilder'),
					'show' => __('Open all items','lift-pagebuilder'),
					'hide' => __('Close all items','lift-pagebuilder'),
				),
				'std' => '',
			),
			'navigation' => array(
				'type' => 'select',
				'title' => __('Navigation style','lift-pagebuilder'),
				'values' => array(
					'' => __('None','lift-pagebuilder'),
					'fas fa-plus' => __('Plus','lift-pagebuilder'),
					'fas fa-plus-circle' => __('Plus circle','lift-pagebuilder'),
					'fas fa-plus-square' => __('Plus fill square','lift-pagebuilder'),
					'fas fa-arrow-circle-right' => __('Arrow fill circle','lift-pagebuilder'),
					'fas fa-angle-right' => __('Angle','lift-pagebuilder'),
					'fas fa-angle-double-right' => __('Angle double','lift-pagebuilder'),
					'fas fa-chevron-right' => __('Chevron','lift-pagebuilder'),
					'fas fa-chevron-circle-right' => __('Chevron circle','lift-pagebuilder'),
					'fas fa-caret-right' => __('Caret','lift-pagebuilder'),
				),
				'std' => 'fas fa-angle-right',
			),
			'navigation_direction' => array(
				'type' => 'select',
				'title' => __('Navigation Direction','lift-pagebuilder'),
				'values' => array(
					'left' => __('Left','lift-pagebuilder'),
					'right' => __('Right','lift-pagebuilder'),
				),
			...
			'title_active_color' => array(
				'type' => 'color2',
				'title' => __('Active color','lift-pagebuilder'),
				'tab' => 'style',
				'section' => 'Title',
				'clip' => true,
				'std' => array(
			...
			'title_sept_space' => array(
				'type' => 'slider',
				'title' => __('Title separator spacing','lift-pagebuilder'),
				'unit' => array( 'px','em' ),
				'range' => array(
						'em' => array(
							'min' => -10,
			...
			'nav_icon_size' => array(
				'type' => 'slider',
				'title' => __('Navigation Icon Size','lift-pagebuilder'),
				'unit' => array( 'px','em' ),
				'range' => array(
						'em' => array(
							'min' => 0,
			...
			'nav_icon_color' => array(
				'type' => 'color',
				'title' => __('Navigation icon color','lift-pagebuilder'),
				'tab' => 'style',
				'section' => 'Icon',
				'std'       => '#666666',
			...
			'nav_icon_active_color' => array(
				'type' => 'color',
				'title' => __('Navigation icon active color','lift-pagebuilder'),
				'tab' => 'style',
				'section' => 'Icon',
				'std'       => '#000000',
