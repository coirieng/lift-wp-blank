...
class WPPB_Addon_Pricing_Table{
	...
	public function get_settings() {
		...
		$settings = array(
			...
			'currency' => array(
				'type' => 'text',
				'title' => __('Currency symbol','lift-pagebuilder'),
				'std' => '$',
			),
			'pricing' => array(
				'type' => 'text',
				'title' => __('Sales Price','lift-pagebuilder'),
				'std' => '89',
			),
			'sales' => array(
				'type' => 'text',
				'title' => __('Regular Price','lift-pagebuilder'),
				'std' => '',
			),
			'period' => array(
				'type' => 'text',
				'title' => __('Period','lift-pagebuilder'),
				'std' => '/ Month',
			),
			'pt_icon_list' => array(
				'type' => 'icon',
			...
			'pricing_feature' => array(
				'title' => __('Pricing Features','lift-pagebuilder'),
				'type' => 'repeatable',
				'label' => 'feature_text',
				'std' => array(
					array( 
			...
			'aditional_info' => array(
				'type' => 'text',
				'title' => __('Aditional Info','lift-pagebuilder'),
			...
			'pricing_content_odd' => array(
				'type' => 'color',
				'title' => __('Odd number bg color','lift-pagebuilder'),
				'tab' => 'style',
				'section' => 'Pricing Feature',
			...
			'pricing_content_even' => array(
				'type' => 'color',
				'title' => __('Even number bg color','lift-pagebuilder'),
				'tab' => 'style',
				'section' => 'Pricing Feature',
			...
			'pricing_subtitle' => array(
				'type' => 'color',
				'title' => __('Pricing sub Color','lift-pagebuilder'),
				'tab' => 'style',
			...
			'subtitle_margin' => array(
				'type' => 'slider',
				'title' => __('Margin bottom','lift-pagebuilder'),
				'unit' => array( 'px','%','em' ),
				'range' => array(
						'em' => array(
							'min' => 0,
			...
			'icon_section_bg' => array(
				'type' => 'color2',
				'title' => __('Icon section background color','lift-pagebuilder'),
				'tab' => 'style',
				'section' => 'Icon',
				'clip' => false,
				'std' => array(
			...
			'icon_line_height' => array(
				'type' => 'slider',
				'title' => __('Icon line height','lift-pagebuilder'),
				'unit' => array( 'px','%','em' ),
				'range' => array(
						'em' => array(
							'min' => 0,
			...
			'icon_width' => array(
				'type' => 'slider',
				'title' => __('Icon Width','lift-pagebuilder'),
				'unit' => array( 'px','%','em' ),
				'range' => array(
						'em' => array(
							'min' => 0,
			...
			'icon_radius' => array(
				'type' => 'dimension',
				'title' => __('Icon border radius','lift-pagebuilder'),
				'unit' => array( 'px','%','em' ),
				'std' => array(
			...
			'pricing_symbol' => array(
				'type' => 'color',
				'title' => __('Currency symbol color','lift-pagebuilder'),
				'tab' => 'style',
			...
			'pricing_sales' => array(
				'type' => 'color',
				'title' => __('Pricing sales color','lift-pagebuilder'),
				'tab' => 'style',
				'section' => 'Sales',
			...
			'pricing_color' => array(
				'type' => 'color',
				'title' => __('Pricing text color','lift-pagebuilder'),
				'tab' => 'style',
				'section' => 'Pricing',
			...
			'button_display' => array(
				'type' => 'select',
				'title' => __('Button display','lift-pagebuilder'),
				'values' => array(
					'btnblock' => __('Block','lift-pagebuilder'),
					'btninlineblock' => __('Inline Block','lift-pagebuilder'),
					'btninline' => __('Inline','lift-pagebuilder'),
				),
				'std' => 'btninlineblock',
				'tab' => 'style',
				'section' => 'Button',
			...
			'addition_text' => array(
				'type' => 'color',
				'title' => __('Text color','lift-pagebuilder'),
				'tab' => 'style',
