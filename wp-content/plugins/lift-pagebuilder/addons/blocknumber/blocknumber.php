...
class WPPB_Addon_Blocknumber{
	...
	public function get_settings() {
		...
		$settings = array(
			'number' => array(
				'type' => 'text',
				'title' => __('Block Number','lift-pagebuilder'),
				'std' => '01'
			),
			'number_title' => array(
				'type' => 'text',
			...
			'number_description' => array(
				'type' => 'textarea',
				'title' => __('Add Description','lift-pagebuilder'),
			...
			'number_color' => array(
				'type' => 'color',
				'title' => __('Number color','lift-pagebuilder'),
				'tab' => 'style',
				'std'       => '#ffffff',
			...
			'number_bg' => array(
				'type' => 'color',
				'title' => __('Number background color','lift-pagebuilder'),
				'tab' => 'style',
				'std' => '#03E16D',
			...
			'number_width' => array(
				'type' => 'slider',
				'title' => __('Number Width','lift-pagebuilder'),
				'unit' => array( 'px','%','em' ),
				'range' => array(
						'em' => array(
							'min' => 0,
			...
			'number_height' => array(
				'type' => 'slider',
				'title' => __('Number Height','lift-pagebuilder'),
				'unit' => array( 'px','%','em' ),
				'range' => array(
						'em' => array(
							'min' => 0,
      ...
      'number_fontstyle' => array(
			...
			'number_radius' => array(
				'type' => 'dimension',
				'title' => __('Number border radius','lift-pagebuilder'),
				'unit' => array( 'px','%','em' ),
				'responsive' => true,
				'tab' => 'style',
      ...
      'number_margin' => array(
				'type' => 'dimension',
				'title' => __('Number margin','lift-pagebuilder'),
				'unit' => array( 'px','%','em' ),
				'responsive' => true,
				'tab' => 'style',
			...
			'descr_color' => array(
				'type' => 'color',
				'title' => __('Description color','lift-pagebuilder'),
				'tab' => 'style',
				'section' => 'Description',
				'std'       => '#666666',
