...
class WPPB_Addon_Flip_Box{
	...
	public function get_settings() {
		...
		$settings = array(
			...
			'flip_bhave' => array(
				'type' => 'select',
				'title' => __('Behavior','lift-pagebuilder'),
				'values' => array(
					'hover' => __('Hover','lift-pagebuilder'),
					'click' => __('Click','lift-pagebuilder'),
				),
			...
			'flip_style' => array(
				...
				'values' => array(
					'rotate_style' => __('Rotate','lift-pagebuilder'),
					'slide_style' => __('Slide','lift-pagebuilder'),
					'fade_style' => __('Fade','lift-pagebuilder'),
					'threeD_style' => __('3D','lift-pagebuilder'),
				),
				'section' => 'Flip Options',
				'std' => 'rotate_style',
			),			
			'flip_direction' => array(
				'type' => 'select',
				'title' => __('Direction','lift-pagebuilder'),
				'values' => array(
					'flip_top' => __('From top','lift-pagebuilder'),
					'flip_bottom' => __('From bottom','lift-pagebuilder'),
					'flip_left' => __('From left','lift-pagebuilder'),
					'flip_right' => __('From right','lift-pagebuilder'),
				),
				'section' => 'Flip Options',
				'std' => 'flip_right',
			),	
			...
			'front_show_icon' => array(
				'type' => 'switch',
				'title' => __('Show icon','lift-pagebuilder'),
				'section' => 'Front View',
				'std' => '1'
			),
			'front_icon_list' => array(
				'type' => 'icon',
				'title' => __('Icon list','lift-pagebuilder'),
			...
			'front_image_upload' => array(
				'type' => 'media',
				'title' => __('Upload feature image','lift-pagebuilder'),
			...
			'front_image_alt' => array(
				'type' => 'text',
				'title' => __('Image alt text','lift-pagebuilder'),
				'std' => 'Image',
				'depends' => array(array('front_show_icon', '!=', '1')),
				'section' => 'Front View',
			),
			...
			'front_intro_margin' => array(
				'type' => 'dimension',
				'title' => __('Intro text margin','lift-pagebuilder'),
				'tab' => 'style',
				'section' => 'Front Style',
				'unit' => array( 'px','em','%' ),
				'responsive' => true,
			...
			'front_img_margin' => array(
				'type' => 'dimension',
				'title' => __('Image margin','lift-pagebuilder'),
				'tab' => 'style',
				'section' => 'Front Style',
				'unit' => array( 'px','em','%' ),
				'responsive' => true,
			...
			'front_icon_size' => array(
				'type' => 'slider',
				'title' => __('Icon size','lift-pagebuilder'),
				'unit' => array( 'px','%','em' ),
				'range' => array(
						'em' => array(
							'min' => 0,
			...
			'front_icon_height' => array(
				'type' => 'slider',
				'title' => __('Icon height','lift-pagebuilder'),
				'unit' => array( 'px','%','em' ),
				'range' => array(
						'em' => array(
							'min' => 0,
			...
			'front_icon_color' => array(
				'type' => 'color',
				'title' => __('Icon color','lift-pagebuilder'),
				'tab' => 'style',
				'section' => 'Front Style',
				'depends' => array(array('show_icon', '!=', '0')),
			...
			'front_icon_hcolor' => array(
				'type' => 'color',
				'title' => __('Icon hover color','lift-pagebuilder'),
				'tab' => 'style',
				'section' => 'Front Style',
			...
			'front_icon_bg' => array(
				'type' => 'color',
				'title' => __('Icon background','lift-pagebuilder'),
				'tab' => 'style',
				'section' => 'Front Style',
				'depends' => array(array('show_icon', '!=', '0')),
			...
			'front_icon_hover_bg' => array(
				'type' => 'color',
				'title' => __('Icon hover background','lift-pagebuilder'),
				'tab' => 'style',
				'section' => 'Front Style',
				'depends' => array(array('show_icon', '!=', '0')),
			...
			'front_icon_margin' => array(
				'type' => 'dimension',
				'title' => __('Icon margin','lift-pagebuilder'),
				'tab' => 'style',
				'section' => 'Front Style',
				'unit' => array( 'px','em','%' ),
				'responsive' => true,
			...
			'back_title_color' => array(
				'type' => 'color',
				'title' => __('Back Color','lift-pagebuilder'),
				'tab' => 'style',
				'section' => 'Back Style',
			...
			'back_intro_color' => array(
				'type' => 'color',
				'title' => __('Back Intro text color','lift-pagebuilder'),
				'tab' => 'style',
				'section' => 'Back Style',
			...
			'button_hradius' => array(
				'type' => 'dimension',
				'title' => __('Border Radius hover','lift-pagebuilder'),
				'unit' => array( 'px','%','em' ),
				'std' => array(
					'md' => array( 'top' => '48px', 'right' => '48px', 'bottom' => '48px', 'left' => '48px' ),
					'sm' => array( 'top' => '', 'right' => '', 'bottom' => '', 'left' => '' ),
			...
			'button_padding' => array(
				'type' => 'dimension',
				'title' => __('Button Padding','lift-pagebuilder'),
				'tab' => 'style',
				'section' => 'Back Style',
				'unit' => array( 'px','em','%' ),
				'responsive' => true,
