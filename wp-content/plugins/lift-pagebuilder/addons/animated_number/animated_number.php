...
class WPPB_Addon_Animated_Number{
	...
	public function get_settings() {
		...
		$settings = array(
			...
			'digit' => array(
				'type' => 'text',
				'title' => __('Counter digit','lift-pagebuilder'),
				'std' => '500'
			),
			...
			'duration' => array(
				'type' => 'text',
				'title' => __('Animation duration','lift-pagebuilder'),
				'std' => '1000',
			),
			'counter_title' => array(
				'type' => 'text',
				'title' => __('Counter title','lift-pagebuilder'),
				'std' => 'WordPress'
			),
			...
			'prefix_text' => array(
				'type' => 'text',
				'title' => __('Prefix Text','lift-pagebuilder'),
				'std' => ''
			),
			'additional' => array(
				'type' => 'text',
				'title' => __('Suffix Text','lift-pagebuilder'),
				'std' => '+'
			),
			'counter_align' => array(
				'type' => 'alignment',
				'title' => __('Counter alignment','lift-pagebuilder'),
			...
			'additional_space_horizontal' => array(
				'type' => 'slider',
				'title' => __('Space Horizontal','lift-pagebuilder'),
				'unit' => array( '%','px','em' ),
				'range' => array(
					'em' => array(
						'min' => -5,
			...
			'additional_space_vertical' => array(
				'type' => 'slider',
				'title' => __('Space vertically','lift-pagebuilder'),
				'unit' => array( '%','px','em' ),
				'range' => array(
					'em' => array(
						'min' => -5,
