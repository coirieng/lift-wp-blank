...
class WPPB_Addon_Video{
	...
	public function get_settings() {
		$settings = array(
			'video_type' => array(
				'type' => 'select',
				'title' => __('Video Source','lift-pagebuilder'),
				'values' => array(
					'youtube' => __('Youtube','lift-pagebuilder'),
					'vimeo' => __('Vimeo','lift-pagebuilder'),
					'self-hosted' => __('Self-hosted','lift-pagebuilder'),
				),
				'std' => 'youtube',
			),
			'video_url' => array(
			...
			'video_hide_logo' => array(
				'type' => 'switch',
				'title' => __('Logo','lift-pagebuilder'),
				'std' => '1',
				'depends' => array(array('video_type', '=', 'youtube')),
			),
			'video_controls' => array(
				'type' => 'switch',
				'title' => __('Controls','lift-pagebuilder'),
				'std' => '1',
				'depends' => array(array('video_type', '=', 'youtube')),
			),
			//style
