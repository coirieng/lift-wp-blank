	...
	public function get_settings() {
		...
		$settings = array(
			...
			'testimonial_list' => array(
				'title' => __('Testimonial Item','lift-pagebuilder'),
				'type' => 'repeatable',
				'label' => 'name',
				'std' => array(
					array(
			...
			'autoplay_option' => array(
				'type' => 'switch',
				'title' => __('Autoplay','lift-pagebuilder'),
				'std' => '1',
			...
			'control_nav_style' => array(
				'type' => 'select',
				'title' => __('Nav Style','lift-pagebuilder'),
				'values' => array(
			...
			'testimonial_align' => array(
				'type' => 'alignment',
				'title' => __('Testimonial alignment','lift-pagebuilder'),
				'responsive' => true,
				'section' => 'Slide Settings',
			...
			'dot_margin' => array(
				'type' => 'dimension',
				'title' => __('Dot Margin','lift-pagebuilder'),
				'tab'=> 'style',
				'section' => __('Dots Style','lift-pagebuilder'),
				'responsive' => true,
				'unit' => array( 'px','em','%' ),
