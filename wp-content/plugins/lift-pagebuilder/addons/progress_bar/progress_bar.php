...
class WPPB_Addon_Progress_Bar{
	...
	public function get_settings() {
		...
		$settings = array(
			...
			'stripped' => array(
				'type' => 'switch',
				'title' => __('Show Striped','lift-pagebuilder'),
				'std' => '0'
			),
			'show_title' => array(
				'type' => 'switch',
			...
			'show_percent' => array(
				'type' => 'switch',
				'title' => __('Show percentage','lift-pagebuilder'),
				'std' => '1'
			),			
			...
			'overlay_radius' => array(
				'type' => 'dimension',
				'title' => __('Overlay Radius','lift-pagebuilder'),
				'unit' => array( 'px','em','%' ),
				'std' => array(
			...
			'progress_bg' => array(
				'type' => 'color2',
				'title' => __('Custom background color','lift-pagebuilder'),
				'tab' => 'style',
				'clip' => false,
				'std' => array(
					'colorType' => 'color',
			...
			'progress_bg_overlay' => array(
				'type' => 'color2',
				'title' => __('Custom overlay background','lift-pagebuilder'),
				'tab' => 'style',
				'clip' => false,
				'std' => array(
					'colorType' => 'color',
			...
			'percent_text_bg' => array(
				'type' => 'color',
				'title' => __('Box Background','lift-pagebuilder'),
				'tab' => 'style',
				'section' => 'Percentage',
				'depends' => array(array('progress_layout', '=', array('three'))),
				'selector' => array(
