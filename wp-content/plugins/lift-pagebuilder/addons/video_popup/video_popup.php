...
class WPPB_Addon_Video_Popup{
	...
	public function get_settings() {
		$settings = array(
			...
			'before_text' => array(
				'type' => 'text',
				'title' => __('Before Video text','lift-pagebuilder'),
			),
			'after_text' => array(
				'type' => 'text',
				'title' => __('After Video text','lift-pagebuilder'),
			),
			'video_align' => array(
				'type' => 'select',
				'title' => __('Video icon alignment','lift-pagebuilder'),
				'responsive' => true,
				'values' => array(
					'video_left' => __('Left','lift-pagebuilder'),
					'video_center' => __('Center','lift-pagebuilder'),
					'video_right' => __('Right','lift-pagebuilder'),
				),
				'std' => 'video_center',
			),
			//style
			...
			'icon_radius' => array(
				'type' => 'dimension',
				'title' => __('Icon Radius','lift-pagebuilder'),
				'unit' => array( 'px','%','em' ),
				'std' => array(
			...
			'before_color' => array(
				'type' => 'color',
				'title' => __('Before color','lift-pagebuilder'),
				'tab' => 'style',
				'section' => 'Before text',
			...
			'after_color' => array(
				'type' => 'color',
				'title' => __('After color','lift-pagebuilder'),
				'tab' => 'style',
				'section' => 'After text',
