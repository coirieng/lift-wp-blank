...
class WPPB_Addon_Posts_Grid{
	...
	public function get_settings() {
		$settings = array(
			'posts_column' => array(
				'type'      => 'slider',
				'title'     => __('Column','lift-pagebuilder'),
				'responsive' => true,
				'std' => array(
					'md' => '3',
					'sm' => '2',
			...
			'posts_per_page' => array(
				'type'      => 'number',
				'title'     => __('Posts Per Page','lift-pagebuilder'),
				'std'       => '3'
			),
			'posts_image_size' => array(
				'type'      => 'select',
				'title'     => __('Image Size','lift-pagebuilder'),
				'values'    => wppb_getLall_image_sizes_option(),
				'std'       => 'wppb-medium',
			),
			'posts_title_position' => array(
				'type'      => 'select',
				'title'     => __('Title Position','lift-pagebuilder'),
				'values'    => array(
			...
			'posts_title' => array(
				'type' => 'switch',
				'title' => __('Title','lift-pagebuilder'),
				'std' => '1'
			),
			'posts_title_tag' => array(
				'type'      => 'select',
				'title'     => __('Title Tag','lift-pagebuilder'),
				'values'    => array(
					'h1'       => 'H1',
					'h2'       => 'H2',
					'h3'       => 'H3',
			...
			'posts_excerpt' => array(
				'type' => 'switch',
				'title' => __('Excerpt','lift-pagebuilder'),
				'std' => '1'
			),
			'posts_excerpt_length' => array(
				'type'      => 'number',
				'title'     => __('Excerpt Length','lift-pagebuilder'),
				'std'       => '30'
			),
			'posts_metadata' => array(
				'type'      => 'select',
				'multiple'  => true,
				'title'     => __('Meta Data','lift-pagebuilder'),
				'values'    => array(
					'author'        => __('Author','lift-pagebuilder'),
					'date'          => __('Date','lift-pagebuilder'),
					'time'          => __('Time','lift-pagebuilder'),
					'comments'      => __('Comments','lift-pagebuilder'),
					'tags'          => __('Tags','lift-pagebuilder'),
					'categories'    => __('Categories','lift-pagebuilder'),
				),
				'std'       => array('author','date','comments'),
			),
			'posts_separator' => array(
				'type'      => 'text',
				'title'     => __('Separator','lift-pagebuilder'),
				'std'       => '/'
			),
			'posts_read_more' => array(
				'type' => 'switch',
				'title' => __('Read More','lift-pagebuilder'),
				'std' => '1'
			),
			'posts_read_more_text' => array(
				'type'      => 'text',
				'title'     => __('Read More Text','lift-pagebuilder'),
				'std'       => 'Read More »'
			),
			...
			'post_type' => array(
				'type'      => 'select',
				'title'     => __('Post Type','lift-pagebuilder'),
			...
			'posts_categories' => array(
				'type'      => 'select',
				'multiple'  => true,
				'title'     => __('Categories','lift-pagebuilder'),
			...
			'posts_tags' => array(
				'type'      => 'select',
				'multiple'  => true,
				'title'     => __('Tags','lift-pagebuilder'),
			...
			'post_order_by' => array(
				'type'      => 'select',
				'title'     => __('Order By','lift-pagebuilder'),
				'values'    => array(
					'title' => __('Title','lift-pagebuilder'),
					'date' => __('Date','lift-pagebuilder'),
					'menu_order' => __('Menu Order','lift-pagebuilder'),
					'comments_count' => __('Comment Count','lift-pagebuilder'),
					'random' => __('Random','lift-pagebuilder'),
				),
				'std'       => 'date',
				'section' => 'Advanced_Query',
			),
			...
			'post_order' => array(
				'type'      => 'select',
				'title'     => __('Order','lift-pagebuilder'),
				'values'    => array(
					'desc' => __('DESC','lift-pagebuilder'),
					'asc' => __('ASC','lift-pagebuilder'),
				),
				'std'       => 'desc',
				'section' => 'Advanced_Query',
			),
			'posts_ids' => array(
				'type'      => 'text',
				'title'     => __('IDS','lift-pagebuilder'),
				'std'       => '',
				'section' => 'Advanced_Query',
			),
			'posts_exclude_ids' => array(
				'type'      => 'text',
				'title'     => __('Exclude IDS','lift-pagebuilder'),
				'std'       => '',
				'section' => 'Advanced_Query',
			...
			'posts_enable_pagination' => array(
				'type' => 'switch',
				'title' => __('Pagination','lift-pagebuilder'),
				'std' => '0',
				'section' => 'Pagination',
			),
			...
			'post_pagination_type' => array(
				'type'      => 'select',
				'title'     => __('Pagination Type','lift-pagebuilder'),
				'values'    => array(
					'numbers_next_previous' => __('Numbers With Next/Previous','lift-pagebuilder'),
					'next_previous' => __('Next/Previous','lift-pagebuilder'),
					'numbers' => __('Numbers','lift-pagebuilder'),
					'load_more' => __('Load More Page Ends','lift-pagebuilder'),
				),
			...
			'post_title_color' => array(
				'type' => 'color',
				'title' => __('Title color','lift-pagebuilder'),
				'tab' => 'style',
				'section' => 'Post Title',
			...
			'post_title_hcolor' => array(
				'type' => 'color',
				'title' => __('Title hover color','lift-pagebuilder'),
				'tab' => 'style',
				'section' => 'Post Title',
			...
			'post_meta_item_color' => array(
				'type' => 'color',
				'title' => __('Meta item color','lift-pagebuilder'),
				'tab' => 'style',
			...
			'post_meta_item_hcolor' => array(
				'type' => 'color',
				'title' => __('Meta item hover color','lift-pagebuilder'),
				'tab' => 'style',
				'section' => 'Post Meta Item',
			...
			'post_meta_size' => array(
				'type' => 'slider',
				'title' => __('Font Size','lift-pagebuilder'),
				'unit' => array( 'px','%','em' ),
				'range' => array(
					'em' => array(
						'min' => 0,
			...
			'post_meta_height' => array(
				'type' => 'slider',
				'title' => __('Line height','lift-pagebuilder'),
				'std' => array(
					'md' => '',
					'sm' => '',
					'xs' => '',
			...
			'post_img_width' => array(
				'type' => 'slider',
				'title' => __('Image width','lift-pagebuilder'),
				'unit' => array( 'px','%','em' ),
				'range' => array(
					'em' => array(
						'min' => 0,
			...
			'post_img_height' => array(
				'type' => 'slider',
				'title' => __('Image height','lift-pagebuilder'),
				'unit' => array( 'px','%','em' ),
				'range' => array(
					'em' => array(
						'min' => 0,
			...
			'post_border_radius' => array(
				'type' => 'dimension',
				'title' => __('Border Radius','lift-pagebuilder'),
				'unit' => array( 'px','%','em' ),
				'responsive' => true,
				'tab' => 'style',
				'section' => 'Post image',
			...
			'post_img_margin' => array(
				'type' => 'dimension',
				'title' => __('margin','lift-pagebuilder'),
				'tab' => 'style',
				'section' => 'Post image',
				'unit' => array( 'px','em','%' ),
				'std' => array(
			...
			'post_content_color' => array(
				'type' => 'color',
				'title' => __('Content color','lift-pagebuilder'),
				'tab' => 'style',
			...
			'post_button_color' => array(
				'type' => 'color',
				'title' => __('Button color','lift-pagebuilder'),
				'tab' => 'style',
				'section' => 'Post button',
			...
			'post_buttom_hradius' => array(
				'type' => 'dimension',
				'title' => __('hover border radius','lift-pagebuilder'),
				'unit' => array( '%','px','em' ),
				'responsive' => true,
				'tab' => 'style',
				'section' => 'Post button',
			...
			'post_nav_color' => array(
				'type' => 'color',
				'title' => __('Navigation color','lift-pagebuilder'),
				'tab' => 'style',
				'section' => 'Navigation',
				'std' => '#000',
				'depends' => array(array('post_pagination_type', '!=', array('load_more'))),
			...
			'post_nav_hcolor' => array(
				'type' => 'color',
				'title' => __('Navigation hover color','lift-pagebuilder'),
				'tab' => 'style',
				'std' => '#fff',
				'section' => 'Navigation',
				'depends' => array(array('post_pagination_type', '!=', array('load_more'))),
	...
	public function render($data = null){
		...
		$posts_read_more_text   = isset($settings['posts_read_more_text']) ? $settings['posts_read_more_text'] : __('Read More »', 'lift-pagebuilder');
                ...
                <div class="wppb-posts-addon-content">
						...
						while ( $the_query->have_posts() ) {
							...
							if (count($posts_metadata)) {
								...
								if (in_array('comments', $posts_metadata)) {
									$meta_data['comments'] = get_comments_number() . ' ' . __( 'Comments', 'lift-pagebuilder' );
								}
					...
					if ($posts_enable_pagination) {
						...
						echo "<div class='wppb-posts-addon-pagination'>";
							...
							$translated = __( 'Page', 'lift-pagebuilder' ); // Supply translatable string
							...
							if ($post_pagination_type === 'load_more'){
								echo '<a href="#" data-paged="'.$paged.'" class="wppb-posts-addon-loadmore-btn">'.__( 'Load More', 'lift-pagebuilder' ).'</a>';
							}
