		...
		$settings = array(
			...
			'social_item' => array(
				...
				'attr' => array(
					...
					'socialtext' => array(
						'type' => 'text',
						'title' => __('Social text','lift-pagebuilder'),
					),
					'style' => array(
						'type' => 'select',
			...
			'shape' => array(
				'type' => 'select',
				'title' => __('Social Shape','lift-pagebuilder'),
				'values' => array(
			...
			'btn_size' => array(
				'type' => 'select',
				'title' => __('Button Size','lift-pagebuilder'),
				'values' => array(
			...
			'social_align' => array(
				'type' => 'alignment',
				'title' => __('Social alignment','lift-pagebuilder'),
				'responsive' => true,
			...
			'social_fontstyle' => array(
				'type' => 'typography',
				'title' => __('Title Typography','lift-pagebuilder'),
				'std' => array(
					'fontFamily' => '',
