...
class WPPB_Addon_Feature_Box{
	...
	public function get_settings() {
		...
		$settings = array(
			'layout' => array(
				'type' => 'radioimage',
				'title' => __( 'Layout', 'lift-pagebuilder' ),
				'values' => array(
			...
			'number' => array(
				'type' => 'text',
				'title' => __('Number','lift-pagebuilder'),
			...
			'introtext' => array(
				'type' => 'textarea',
				'title' => __('Intro text','lift-pagebuilder'),
			...
			'show_image' => array(
				'type'      => 'switch',
				'title'     => __('Show Image','lift-pagebuilder'),
				'std'       => '0',
                'depends' => array(array('layout', '!=', array('seven')))
			),
			'icon_list' => array(
			...
			'title_padding' => array(
				'type'      => 'dimension',
				'title'     => __('padding','lift-pagebuilder'),
				'tab'       => 'style',
				'section'   => 'Box Title',
				'responsive' => true,
				'unit'      => array( 'px','em','%' ),
			...
			'number_horizontal' => array(
				'type' => 'slider',
				'title' => __('Horizontal','lift-pagebuilder'),
				'std' => array(
						'md' => '-25px',
						'sm' => '',
						'xs' => '',
			...
			'number_vertical' => array(
				'type' => 'slider',
				'title' => __('Vertical','lift-pagebuilder'),
				'std' => array(
						'md' => '15px',
						'sm' => '',
						'xs' => '',
			...
			'bar_horizontal' => array(
				'type' => 'slider',
				'title' => __('Bar Horizontal','lift-pagebuilder'),
				'unit' => array( '%','px','em' ),
				'range' => array(
						'em' => array(
							'min' => -25,
			...
			'bar_vertical' => array(
				'type' => 'slider',
				'title' => __('Bar Vertical','lift-pagebuilder'),
				'unit' => array( '%','px','em' ),
				'range' => array(
						'em' => array(
							'min' => 0,
