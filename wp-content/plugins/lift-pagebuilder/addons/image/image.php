...
class WPPB_Addon_Image{
	...
	public function get_settings() {
		...
		$settings = array(
			...
			'upload_image' => array(
				'type' => 'media',
				'title' => __('Upload image','lift-pagebuilder'),
				'std'=> array( 'url' => WPPB_DIR_URL.'assets/img/placeholder/wppb-medium.jpg' ),
			),
			'alt_text' => array(
				'type' => 'text',
				'title' => __('alt','lift-pagebuilder'),
				'std' => 'Image',
			),
			'caption_text' => array(
				'type' => 'text',
            ...
            'lightbox' => array(
                'type' => 'switch',
                'title' => __('Enable Popup','lift-pagebuilder'),
                'std' => '0'
            ),
            'lightbox_icon' => array(
                'type' => 'switch',
                'title' => __('Enable Icon','lift-pagebuilder'),
                'std' => '0'
            ),
			'image_link' => array(
				'type' => 'link',
			...
			'image_display' => array(
				'type' => 'select',
				'title' => __('Image display','lift-pagebuilder'),
				'values' => array(
					'imgblock' => __('Block','lift-pagebuilder'),
					'imginlineblock' => __('Inline Block','lift-pagebuilder'),
					'imginline' => __('Inline','lift-pagebuilder'),
				),
				'std' => 'imginlineblock',
			),
			'image_align' => array(
