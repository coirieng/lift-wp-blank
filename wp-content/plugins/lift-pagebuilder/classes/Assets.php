	...
	class WPPB_Assets {
		...
		public function __construct() {
			...
			if (wppb_helper()->is_editor_screen() || wppb_helper()->is_load_editor_iframe()){
				//Load only for LIFT WP Page Builder
		...
		public function wppb_enqueue_scripts(){
			...
			if( wppb_helper()->is_editor_screen() ){
				...
				$js_translate = array(
					'add_row' => __('Add Row','lift-pagebuilder'), 'layouts' => __('Layouts','lift-pagebuilder'), 'default_addons' => __('Default Addons','lift-pagebuilder'), 
					'wordpress_widgets' => __('WordPress Widgets','lift-pagebuilder'), 'add_column' => __('Add Column','lift-pagebuilder'), 'duplicate_column' => __('Duplicate Column','lift-pagebuilder'), 
					'disable_column' => __('Disable Column','lift-pagebuilder'), 'delete_column' => __('Delete Column','lift-pagebuilder'), 'add_inner_row' => __('Add Inner Row','lift-pagebuilder'), 
					'drag_column' => __('Drag Column','lift-pagebuilder'), 'drag_inner_row' => __('Drag Inner Row','lift-pagebuilder'), 'addons' => __('Addons','lift-pagebuilder'), 
					'blocks' => __('Blocks','lift-pagebuilder'), 'library' => __('Library','lift-pagebuilder'), 'tools' => __('Tools','lift-pagebuilder'), 'import' => __('Import','lift-pagebuilder'), 
					'export' => __('Export','lift-pagebuilder'), 'clear_page_content' => __('Clear Page Content','lift-pagebuilder'), 'view' => __('View','lift-pagebuilder'), 
					'save' => __('Save','lift-pagebuilder'), 'dashboard' => __('Dashboard','lift-pagebuilder'), 'edit_page' => __('Edit Page','lift-pagebuilder'), 
					'view_page' => __('View Page','lift-pagebuilder'), 'undo' => __('Undo','lift-pagebuilder'), 'redo' => __('Redo','lift-pagebuilder'), 
					'duplicate_row' => __('Duplicate Row','lift-pagebuilder'), 'save_row' => __('Save Row','lift-pagebuilder'), 'disable_row' => __('Disable Row','lift-pagebuilder'), 
					'move_up' => __('Move Up','lift-pagebuilder'), 'move_down' => __('Move Down','lift-pagebuilder'), 'delete_row' => __('Delete Row','lift-pagebuilder'), 
					'preview' => __('Preview','lift-pagebuilder'), 'pro' => __('PRO','lift-pagebuilder'), 'save_to_library' => __('Save to Library','lift-pagebuilder'), 
					'discard' => __('Discard','lift-pagebuilder'), 'title_of_the_custom_section' => __('Title of the custom section','lift-pagebuilder'), 'pages' => __('Pages','lift-pagebuilder'), 
					'categories' => __('Categories','lift-pagebuilder'), 'search' => __('Search','lift-pagebuilder'), 'apply' => __('Apply','lift-pagebuilder'), 'add_item' => __('Add Item','lift-pagebuilder'), 
					'cancel' => __('Cancel','lift-pagebuilder'), 'name' => __('Name','lift-pagebuilder'), 'delay' => __('Delay','lift-pagebuilder'), 'duration' => __('duration','lift-pagebuilder'), 
					'background' => __('Background','lift-pagebuilder'), 'hover' => __('Hover','lift-pagebuilder'), 'color' => __('Color','lift-pagebuilder'), 'image' => __('Image','lift-pagebuilder'), 
					'gradient' => __('Gradient','lift-pagebuilder'), 'video' => __('Video','lift-pagebuilder'), 'position' => __('Position','lift-pagebuilder'), 
					'attachment' => __('Attachment','lift-pagebuilder'), 'repeat' => __('Repeat','lift-pagebuilder'), 'size' => __('Size','lift-pagebuilder'), 'url' => __('URL','lift-pagebuilder'), 
					'fallback_image' => __('Fallback Image','lift-pagebuilder'), 'upload_video' => __('Upload Video','lift-pagebuilder'), 'type' => __('Type','lift-pagebuilder'), 
					'background_color' => __('Background Color','lift-pagebuilder'), 'style' => __('Style','lift-pagebuilder'), 'horizontal' => __('Horizontal','lift-pagebuilder'), 
					'vertical' => __('Vertical','lift-pagebuilder'), 'blur' => __('Blur','lift-pagebuilder'), 'spread' => __('Spread','lift-pagebuilder'), 'top' => __('Top','lift-pagebuilder'), 'right' => __('Right','lift-pagebuilder'), 
					'bottom' => __('Bottom','lift-pagebuilder'), 'left' => __('Left','lift-pagebuilder'), 'gradient_type' => __('Gradient Type','lift-pagebuilder'), 
					'gradient_direction' => __('Gradient Direction','lift-pagebuilder'), 'start_position' => __('Start Position','lift-pagebuilder'), 'end_position' => __('End Position','lift-pagebuilder'), 
					'all' => __('All','lift-pagebuilder'), 'wppb_icon' => __('Default Icon','lift-pagebuilder'), 'fontawesome' => __('Font Awesome 5','lift-pagebuilder'), 
					'open_in_new_window' => __('Open in new window','lift-pagebuilder'), 'nofollow' => __('nofollow','lift-pagebuilder'), 'delete' => __('Delete','lift-pagebuilder'), 
					'width' => __('Width','lift-pagebuilder'), 'height' => __('Height','lift-pagebuilder'), 'flip' => __('Flip','lift-pagebuilder'), 'invert' => __('Invert','lift-pagebuilder'), 
					'bring_to_front' => __('Bring to Front','lift-pagebuilder'), 'font_family' => __('Font Family','lift-pagebuilder'), 'font_size' => __('Font Size','lift-pagebuilder'), 
					'line_height' => __('Line Height','lift-pagebuilder'), 'letter_spacing' => __('Letter Spacing','lift-pagebuilder'), 'font_style' => __('Font Style','lift-pagebuilder'), 
					'font_weight' => __('Font Weight','lift-pagebuilder'),'text_decoration' => __('Text Decoration','lift-pagebuilder'), 'text_transform' => __('Text Transform','lift-pagebuilder'),'disable' => __('Disable','lift-pagebuilder'),'enable' => __('Enable','lift-pagebuilder'), 
					'brightness' => __('Brightness','lift-pagebuilder'), 'contrast' => __('Contrast','lift-pagebuilder'), 'grayscale' => __('Grayscale','lift-pagebuilder'), 'invert' => __('Invert','lift-pagebuilder'), 'hue_rotate' => __('Hue Rotate','lift-pagebuilder'), 'saturate' => __('Saturate','lift-pagebuilder'), 'sepia' => __('Sepia','lift-pagebuilder'),       
				);
