...
class WOW_Addon_Flip_Box{
	...
	public function get_settings() {
		...
		$settings = array(
			...
			'flip_bhave' => array(
				...
				'values' => array(
					'hover' => __('Hover','wow-pagebuilder'),
					'click' => __('Click','wow-pagebuilder'),
				),
			...
			'flip_style' => array(
				...
				'values' => array(
					'rotate_style' => __('Rotate','wow-pagebuilder'),
					'slide_style' => __('Slide','wow-pagebuilder'),
					'fade_style' => __('Fade','wow-pagebuilder'),
					'threeD_style' => __('3D','wow-pagebuilder'),
				),
				'section' => 'Flip Options',
				'std' => 'rotate_style',
			),			
			'flip_direction' => array(
				'type' => 'select',
				'title' => __('Direction','wow-pagebuilder'),
				'values' => array(
					'flip_top' => __('From top','wow-pagebuilder'),
					'flip_bottom' => __('From bottom','wow-pagebuilder'),
					'flip_left' => __('From left','wow-pagebuilder'),
					'flip_right' => __('From right','wow-pagebuilder'),
				),
				'section' => 'Flip Options',
				'std' => 'flip_right',
			),	
			'flip_height' => array(
				...
				'responsive' => true,
				'section' => 'Flip Options',
				'selector' => '{{SELECTOR}} .wow-flipbox-panel, {{SELECTOR}} .threeD-item { height: {{data.flip_height}}; }'
			),	
			'flip_radius' => array(
				'type' => 'dimension',
				...
				'responsive' => true,
				'section' => 'Flip Options',
				'selector' => '{{SELECTOR}} .wow-flipbox-front.flip-box:before, {{SELECTOR}} .threeD-flip-front:before,{{SELECTOR}} .wow-flipbox-back.flip-box:before, {{SELECTOR}} .threeD-flip-back:before { border-radius: {{data.flip_radius}}; }'
			),		
			...
			'front_show_icon' => array(
				'type' => 'switch',
				'title' => __('Show icon','wow-pagebuilder'),
				'section' => 'Front View',
				'std' => '1'
			),
			...
			'front_image_alt' => array(
				'type' => 'text',
				'title' => __('Image alt text','wow-pagebuilder'),
				'std' => 'Image',
				'depends' => array(array('front_show_icon', '!=', '1')),
				'section' => 'Front View',
			),
			'front_bg' => array(
				...
				'section' => 'Front View',
				'selector' => '{{SELECTOR}} .wow-flipbox-front.flip-box:before, {{SELECTOR}} .threeD-flip-front:before'
			),
			'front_align' => array(
				'type' => 'alignment',
				...
				'responsive' => true,
				'section' => 'Front View',
				'selector' => '{{SELECTOR}} .wow-flipbox-front, {{SELECTOR}} .threeD-flip-front{ text-align: {{data.front_align}}; }'
			),
			...
			'back_bg' => array(
				...
				'section' => 'Back View',
				'selector' => '{{SELECTOR}} .wow-flipbox-back.flip-box:before, {{SELECTOR}} .threeD-flip-back:before'
			),
			'back_align' => array(
				'type' => 'alignment',
				'title' => __('Alignment','wow-pagebuilder'),
				'responsive' => true,
				'section' => 'Back View',
				'selector' => '{{SELECTOR}} .wow-flipbox-back, .threeD-flip-back { text-align: {{data.back_align}}; }'
			),
			//front style options
			'front_title_color' => array(
				...
				'section' => 'Front Style',
				'selector' => '{{SELECTOR}} .wow-flip-front-title'
			),
			...
			'front_title_margin' => array(
				...
				'responsive' => true,
				'unit' => array( 'px','em','%' ),
				'selector' => '{{SELECTOR}} .wow-flip-front-title { margin: {{data.front_title_margin}}; }'
			),
			...
			'front_intro_color' => array(
				...
				'tab' => 'style',
				'section' => 'Front Style',
				'selector' => '{{SELECTOR}} .wow-flip-front-intro { color: {{data.front_intro_color}}; }'
			),
			'front_intro_style' => array(
				...
				'selector' => '{{SELECTOR}} .wow-flip-front-intro',
				'section' => 'Front Style',
				'tab' => 'style',
			),
			'front_intro_margin' => array(
				'type' => 'dimension',
				'title' => __('Intro text margin','wow-pagebuilder'),
				'tab' => 'style',
				'section' => 'Front Style',
				'unit' => array( 'px','em','%' ),
				'responsive' => true,
				'selector' => '{{SELECTOR}} .wow-flip-front-intro { margin: {{data.front_intro_margin}}; }'
			),
			...
			'front_img_width' => array(
				...
				'selector' => '{{SELECTOR}} .wow-flip-front-img img { width: {{data.front_img_width}}; }'
			),
			'front_img_height' => array(
				...
				'tab' => 'style',
				'depends' => array(array('show_icon', '!=', '1')),
				'selector' => '{{SELECTOR}} .wow-flip-front-img img { height: {{data.front_img_height}}; }'
			),
			'front_border_radius' => array(
				...
				'tab' => 'style',
				'depends' => array(array('show_icon', '!=', '1')),
				'selector' => '{{SELECTOR}} .wow-flip-front-img img { border-radius: {{data.front_border_radius}}; }'
			),
			'front_img_margin' => array(
				'type' => 'dimension',
				'title' => __('Image margin','wow-pagebuilder'),
				'tab' => 'style',
				'section' => 'Front Style',
				'unit' => array( 'px','em','%' ),
				'responsive' => true,
				'selector' => '{{SELECTOR}} .wow-flip-front-img img { margin: {{data.front_img_margin}}; }'
			),
			...
			'front_icon_size' => array(
				...
				'section' => 'Front Style',
				'depends' => array(array('show_icon', '!=', '0')),
				'selector' => '{{SELECTOR}} .wow-flip-front-icon i { font-size: {{data.front_icon_size}}; }'
			),
			'front_icon_width' => array(
				...
				'section' => 'Front Style',
				'depends' => array(array('show_icon', '!=', '0')),
				'selector' => '{{SELECTOR}} .wow-flip-front-icon { width: {{data.front_icon_width}}; }'
			),
			'front_icon_height' => array(
				...
				'depends' => array(array('show_icon', '!=', '0')),
				'selector' => array(
					'{{SELECTOR}} .wow-flip-front-icon { height: {{data.front_icon_height}}; }',
					'{{SELECTOR}} .wow-flip-front-icon i { line-height: {{data.front_icon_height}}; }',
				)
			),
			'front_icon_radius' => array(
				...
				'section' => 'Front Style',
				'depends' => array(array('show_icon', '!=', '0')),
				'selector' => '{{SELECTOR}}  .wow-flip-front-icon { border-radius: {{data.front_icon_radius}}; }'
			),
			'front_icon_color' => array(
				...
				'section' => 'Front Style',
				'depends' => array(array('show_icon', '!=', '0')),
				'selector' => '{{SELECTOR}} .wow-flip-front-icon { color: {{data.front_icon_color}}; }'
			),
			'front_icon_hcolor' => array(
				'type' => 'color',
				'title' => __('Icon hover color','wow-pagebuilder'),
				'tab' => 'style',
				'section' => 'Front Style',
				'selector' => '{{SELECTOR}} .wow-flip-front-icon:hover { color: {{data.front_icon_hcolor}}; }'
			),
			'front_icon_bg' => array(
				'type' => 'color',
				...
				'section' => 'Front Style',
				'depends' => array(array('show_icon', '!=', '0')),
				'selector' => '{{SELECTOR}} .wow-flip-front-icon { background: {{data.front_icon_bg}}; }'
			),
			'front_icon_hover_bg' => array(
				'type' => 'color',
				'title' => __('Icon hover background','wow-pagebuilder'),
				'tab' => 'style',
				'section' => 'Front Style',
				'depends' => array(array('show_icon', '!=', '0')),
				'selector' => '{{SELECTOR}} .wow-flip-front-icon:hover{ background: {{data.front_icon_hover_bg}}; }'
			),

			'front_icon_margin' => array(
				'type' => 'dimension',
				'title' => __('Icon margin','wow-pagebuilder'),
				'tab' => 'style',
				'section' => 'Front Style',
				'unit' => array( 'px','em','%' ),
				'responsive' => true,
				'selector' => '{{SELECTOR}} .wow-flip-front-icon { margin: {{data.front_icon_margin}}; }'
			),
			...
			'back_title_color' => array(
				'type' => 'color',
				'title' => __('Back Color','wow-pagebuilder'),
				'tab' => 'style',
				'section' => 'Back Style',
				'selector' => '{{SELECTOR}} .wow-flip-back-title { color: {{data.back_title_color}}; }'
			),
			'back_title_style' => array(
				...
				'selector' => '{{SELECTOR}} .wow-flip-back-title',
				'section' => 'Back Style',
				'tab' => 'style',
			),
			'back_title_margin' => array(
				...
				'responsive' => true,
				'unit' => array( 'px','em','%' ),
				'selector' => '{{SELECTOR}} .wow-flip-back-title { margin: {{data.back_title_margin}}; }'
			),
			...
			'back_intro_color' => array(
				'type' => 'color',
				'title' => __('Back Intro text color','wow-pagebuilder'),
				'tab' => 'style',
				'section' => 'Back Style',
				'selector' => '{{SELECTOR}} .wow-flip-back-intro { color: {{data.back_intro_color}}; }'
			),
			'back_intro_style' => array(
				...
				'selector' => '{{SELECTOR}} .wow-flip-back-intro',
				'section' => 'Back Style',
				'tab' => 'style',
			),
			'back_intro_margin' => array(
				...
				'unit' => array( 'px','em','%' ),
				'responsive' => true,
				'selector' => '{{SELECTOR}} .wow-flip-back-intro { margin: {{data.back_intro_margin}}; }'
			),
			...
			'back_img_width' => array(
				...
				'section' => 'Back Style',
				'depends' => array(array('show_icon', '!=', '1')),
				'selector' => '{{SELECTOR}} .wow-flip-back-img img { width: {{data.back_img_width}}; }'
			),
			'back_img_height' => array(
				...
				'tab' => 'style',
				'depends' => array(array('show_icon', '!=', '1')),
				'selector' => '{{SELECTOR}} .wow-flip-back-img img { height: {{data.back_img_height}}; }'
			),
			'back_border_radius' => array(
				...
				'tab' => 'style',
				'depends' => array(array('show_icon', '!=', '1')),
				'selector' => '{{SELECTOR}} .wow-flip-back-img img { border-radius: {{data.back_border_radius}}; }'
			),
			'back_img_margin' => array(
				...
				'unit' => array( 'px','em','%' ),
				'responsive' => true,
				'selector' => '{{SELECTOR}} .wow-flip-back-img img { margin: {{data.back_img_margin}}; }'
			),			
			...
			'back_icon_size' => array(
				...
				'section' => 'Back Style',
				'depends' => array(array('show_icon', '!=', '0')),
				'selector' => '{{SELECTOR}} .wow-flip-back-icon i { font-size: {{data.back_icon_size}}; }'
			),
			'back_icon_width' => array(
				...
				'section' => 'Back Style',
				'depends' => array(array('show_icon', '!=', '0')),
				'selector' => '{{SELECTOR}} .wow-flip-back-icon { width: {{data.back_icon_width}}; }'
			),
			'back_icon_height' => array(
				...
				'depends' => array(array('show_icon', '!=', '0')),
				'selector' => array(
					'{{SELECTOR}} .wow-flip-back-icon { height: {{data.back_icon_height}}; }',
					'{{SELECTOR}} .wow-flip-back-icon i { line-height: {{data.back_icon_height}}; }',
				)
			),
			'back_icon_radius' => array(
				...
				'section' => 'Back Style',
				'depends' => array(array('show_icon', '!=', '0')),
				'selector' => '{{SELECTOR}}  .wow-flip-back-icon { border-radius: {{data.back_icon_radius}}; }'
			),
			'back_icon_color' => array(
				...
				'section' => 'Back Style',
				'depends' => array(array('show_icon', '!=', '0')),
				'selector' => '{{SELECTOR}} .wow-flip-back-icon { color: {{data.back_icon_color}}; }'
			),
			'back_icon_hcolor' => array(
				...
				'tab' => 'style',
				'section' => 'Back Style',
				'selector' => '{{SELECTOR}} .wow-flip-back-icon:hover { color: {{data.back_icon_hcolor}}; }'
			),
			'back_icon_bg' => array(
				'type' => 'color',
				'title' => __('Icon background','wow-pagebuilder'),
				...
				'section' => 'Back Style',
				'depends' => array(array('show_icon', '!=', '0')),
				'selector' => '{{SELECTOR}} .wow-flip-back-icon { background: {{data.back_icon_bg}}; }'
			),
			'back_icon_hover_bg' => array(
				...
				'section' => 'Back Style',
				'depends' => array(array('show_icon', '!=', '0')),
				'selector' => '{{SELECTOR}} .wow-flip-back-icon:hover{ background: {{data.back_icon_hover_bg}}; }'
			),
			...
			'back_icon_margin' => array(
				...
				'unit' => array( 'px','em','%' ),
				'responsive' => true,
				'selector' => '{{SELECTOR}} .wow-flip-back-icon { margin: {{data.back_icon_margin}}; }'
			),
			...
			'back_button_typo' => array(
				...
				'selector' => '{{SELECTOR}} .wow-back-view-btn',
				'section' => 'Back Style',
				'tab' => 'style',
			),
			'back_button_color' => array(
				...
				'tab' => 'style',
				'section' => 'Back Style',
				'selector' => '{{SELECTOR}} .wow-back-view-btn{ color: {{data.back_button_color}}; }'
			),
			'back_button_hcolor' => array(
				...
				'tab' => 'style',
				'section' => 'Back Style',
				'selector' => '{{SELECTOR}} .wow-back-view-btn:hover { color: {{data.back_button_hcolor}}; }'
			),
			'back_button_bg' => array(
				...
				'tab' => 'style',
				'section' => 'Back Style',
				'selector' => '{{SELECTOR}} .wow-back-view-btn{ background: {{data.back_button_bg}}; }'
			),
			'back_button_hover_bg' => array(
				...
				'tab' => 'style',
				'section' => 'Back Style',
				'selector' => '{{SELECTOR}} .wow-back-view-btn:hover{ background: {{data.back_button_hover_bg}}; }'
			),
			...
			'icon_border_hcolor' => array(
				...
				'tab' => 'style',
				'section' => 'Back Style',
				'selector' => '{{SELECTOR}} .wow-back-view-btn:hover'
			),
			'button_radius' => array(
				'type' => 'dimension',
				'title' => __('Border Radius','wow-pagebuilder'),
				...
				'tab' => 'style',
				'section' => 'Back Style',
				'selector' => '{{SELECTOR}} .wow-back-view-btn { border-radius: {{data.button_radius}}; }'
			),
			'button_hradius' => array(
				'type' => 'dimension',
				'title' => __('Border Radius hover','wow-pagebuilder'),
				'unit' => array( 'px','%','em' ),
				'std' => array(
					'md' => array( 'top' => '48px', 'right' => '48px', 'bottom' => '48px', 'left' => '48px' ),
					'sm' => array( 'top' => '', 'right' => '', 'bottom' => '', 'left' => '' ),
				...
				'tab' => 'style',
				'section' => 'Back Style',
				'selector' => '{{SELECTOR}} .wow-back-view-btn:hover { border-radius: {{data.button_hradius}}; }'
			),
			'button_padding' => array(
				'type' => 'dimension',
				'title' => __('Button Padding','wow-pagebuilder'),
				'tab' => 'style',
				'section' => 'Back Style',
				'unit' => array( 'px','em','%' ),
				'responsive' => true,
				'selector' => '{{SELECTOR}} .wow-back-view-btn{ padding: {{data.button_padding}}; }'
			),
			'button_margin' => array(
				'type' => 'dimension',
				...
				'responsive' => true,
				'unit' => array( 'px','em','%' ),
				'selector' => '{{SELECTOR}} .wow-back-view-btn{ margin: {{data.button_margin}}; }'
			),
		);
	...
	public function render($data = null){
		...
		if( !empty( $front_title ) ){
			$data_front_title .= '<' .esc_attr($front_heading_selector). ' class="wow-flip-front-title">' . wp_kses_post($front_title) .'</' . esc_attr($front_heading_selector) . '>';
		}

		if( !empty( $front_introtext ) ){
			$data_front_intro .= '<div class="wow-flip-front-intro">' . wp_kses_post($front_introtext) .'</div>';
		}

		if($front_show_icon == 1) {	
			if( !empty( $front_icon_list ) ){
				$data_front_media .= '<div class="wow-flip-front-icon">';
			...
			if ( ! empty($front_image_upload['url']) ) {
				...
				$data_front_media .= '<div class="wow-flip-front-img">';
		...
		if( !empty( $back_title ) ){
			$data_back_title .= '<' .esc_attr($back_heading_selector). ' class="wow-flip-back-title">' . wp_kses_post($back_title) .'</' . esc_attr($back_heading_selector) . '>';
		}
		if( !empty( $back_introtext ) ){
			$data_back_intro .= '<div class="wow-flip-back-intro">' . wp_kses_post($back_introtext) .'</div>';
		}
		if( !empty($back_btn_link['link']) ){
			...
			$data_back_button  = '<a '.esc_attr($btntarget).' href="'.esc_url($back_btn_link['link']).'" '.esc_attr($btnnofolow).' class="wow-back-view-btn">' . $back_button_text  . '</a>';
		}

		if($back_show_icon == 1) {	
			if( !empty( $back_icon_list ) ){
				$data_back_media .= '<div class="wow-flip-back-icon">';
			...
			if ( ! empty($back_image_upload['url']) ) {
				...
				$data_back_media .= '<div class="wow-flip-back-img">';
		...
		$output  .= '<div class="wow-flip-box-addon">';
			$output .= '<div class="wow-flip-box-content ' . esc_attr($flip_style) . ' ' . esc_attr($flip_direction) . ' flipon-' . esc_attr($flip_bhave) . '">';
				if ($flip_style == 'threeD_style') {
					...
					$output .= '<div class="wow-flipbox-panel">';
					$output .= '<div class="wow-flipbox-front flip-box">';
					...
					$output .= '</div>'; //.front
					$output .= '<div class="wow-flipbox-back flip-box">';
					$output .= '<div class="flip-box-inner">';
					$output .= $data_back_media;
					$output .= $data_back_title;
					$output .= $data_back_intro;
					...
					$output .= '</div>'; //.flip-box-inner
					$output .= '</div>'; //.back
					$output .= '</div>'; //.wow-flipbox-panel
				}
			$output  .= '</div>';//wow-flip-box-content
		$output  .= '</div>';//wow-flip-box-addon
	...
	public function getTemplate(){
        ...
        if(data.front_title){
			data_front_title += "<"+front_heading+" class=\'wow-flip-front-title\'>"+data.front_title+"</"+front_heading+">";
		}
		if(data.front_introtext){
			data_front_intro += "<div class=\'wow-flip-front-intro\'>"+data.front_introtext+"</div>";
		}
		...
		if(data.back_title){
			data_back_title += "<"+back_heading+" class=\'wow-flip-back-title\'>"+data.back_title+"</"+back_heading+">";
		}

		if(data.back_introtext){
			data_back_intro += "<div class=\'wow-flip-back-intro\'>"+data.back_introtext+"</div>";
		}
		...
		if( data.back_btn_link && data.back_btn_link.link ) {
			data_back_button += "<a class=\'wow-back-view-btn\' href=\'"+ data.back_btn_link+"\'>"+data.back_button_text+"</a>";
		}
		...
		<div class="wow-flip-box-addon">
			<div class="wow-flip-box-content {{{data.flip_style}}} {{{data.flip_direction}}} flipon-{{{data.flip_bhave}}}">
				<#
				if ( flip_style == "threeD_style" ) { #>
				...
				<# } else { #>
					<div class="wow-flipbox-panel">
						<div class="wow-flipbox-front flip-box">
						...
						<div class="wow-flipbox-back flip-box">
							<div class="flip-box-inner">
								{{{data_back_media}}}
								{{{data_back_title}}}
								{{{data_back_intro}}}
