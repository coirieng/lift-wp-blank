...
class WOW_Addon_Soundcloud{

	public function get_name(){
		return 'wow_soundcloud';
	}
	public function get_title(){
		return 'SoundCloud';
	}
	public function get_icon() {
		return 'wow-font-soundcloud';
	}
	...
	public function get_settings() {
		...
		$settings = array(
			...
			'link' => array(
				'type' => 'text',
				'title' => __('SoundCloud URL','wow-pagebuilder'),
				'std' => 'https://soundcloud.com/the-bugle/bugle-179-playas-gon-play',
			),
			'visual_player' => array(
				'type' => 'switch',
				'title' => __('Visual Player','wow-pagebuilder'),
				'std' => '0'
			),
			'autoplay' => array(
				'type' => 'switch',
				'title' => __('Auto Play','wow-pagebuilder'),
				'std' => '0'
			),
			'buy_button' => array(
				'type' => 'switch',
				'title' => __('Buy Button','wow-pagebuilder'),
				'std' => '0'
			),
			'download' => array(
				'type' => 'switch',
				'title' => __('Download','wow-pagebuilder'),
				'std' => '0'
			),
			'share_button' => array(
				'type' => 'switch',
				'title' => __('Share Button','wow-pagebuilder'),
				'std' => '0'
			),
			'play_count' => array(
				'type' => 'switch',
				'title' => __('Play Count','wow-pagebuilder'),
				'std' => '0'
			),
			'username' => array(
				'type' => 'switch',
				'title' => __('Username','wow-pagebuilder'),
				'std' => '0'
			),
			'control_color' => array(
				'type' => 'color',
				'title' => __('Controls Color','wow-pagebuilder'),
				'std' => '#444444',
				'tab' => 'style',
			),
			'height' => array(
				...
				'responsive' => true,
				'tab' => 'style',
				'selector' => '{{SELECTOR}} .wow-soundcloud-content iframe { height: {{data.height}}; }'
			),
		);
	...
	public function render($data = null){
		...
		$output  .= '<div class="wow-soundcloud-addon">';
			$output  .= '<div class="wow-soundcloud-content">';
				$output  .= '<iframe';
	...
	public function getTemplate(){
		...
		#>
		<div class="wow-soundcloud-addon">
			<div class="wow-soundcloud-content">
