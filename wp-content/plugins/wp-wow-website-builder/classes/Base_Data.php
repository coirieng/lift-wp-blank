...
if ( ! class_exists( 'WOW_Base_Data' ) ) {
	class WOW_Base_Data {
		// Addons List & Category return
		public function addons_data(){
			$default_addon = array(
				'wow_accordion', 'wow_alert', 'wow_animated_number', 'wow_block_number', 'wow_button', 'wow_button_group',
				...
				'wow_testimonial_carousel', 'wow_text_block', 'wow_blocks', 'wow_video', 'wow_video_popup','wow_carousel'
			);
			...
			if( !empty($available_addons) ){
				foreach ($available_addons as $addon) {
					...
					if ( ! class_exists($addon)){
						trigger_error(" Uncaught Error: Class ‘{$addon}’ not found, you are trying to add an addon class to filter name 'wow_available_addons' which does not exist in your system");
						continue;
					}
					...
					$addon_icons = ( method_exists( $data , 'get_icon' ) ?  $data->get_icon() : 'wow-font-wordpress' );
		...
		public function getSvgShapes() {
			$shape_path = WOW_DIR_PATH .'assets/shapes';
			...
			$global_attribute = array(
				...
				'advanced' => array(
					...
					'addon_z_index' => array(
						...
						'selector' => '.wow-builder-container {{SELECTOR}}{ z-index: {{data.addon_z_index}}; }',
					),
					'addon_padding' => array(
						'type' => 'dimension',
						'title' => 'Padding',
					...
					'addon_wrap_opacity' => array(
						...
						'selector' => '{{SELECTOR}} .wow-addon{ opacity:{{data.addon_wrap_opacity}}; }',
						'section' => 'Opacity',
					),
					'addon_wrap_opacity_hover' => array(
						...
						'selector' => '{{SELECTOR}} .wow-addon:hover{ opacity:{{data.addon_wrap_opacity_hover}}; }',
						'section' => 'Opacity',
					),
					...
					'addon_display' => array(
						'type' => 'select',
						'title' => __('Display','wow-pagebuilder'),
						'values' => array(
							'inline' => 'Inline',
							'block' => 'Block',
					...
					'addon_custom_css' => array(
						'type' => 'textarea',
						'title' => __('Custom CSS','wow-pagebuilder'),
						'section' => 'Custom CSS',
						'placeholder' => __('Use {{SELECTOR}} before the selector to wrap element. Otherwise it works globally. e.g: {{SELECTOR}}{ display: none; }','wow-pagebuilder'),
						'desc' => __('Use {{SELECTOR}} before the selector to wrap element. Otherwise it works globally. e.g: {{SELECTOR}}{ display: none; }','wow-pagebuilder')
					),
				),
			);
				...
				'attr'  => array(
					'general' => array(
						'col_height' => array(
							...
							'responsive' => true,
							'selector' => '.wow-row > {{SELECTOR}}.wow-column-parent { min-height: {{data.col_height}}; }'
						),
						'col_content' => array(
							'type' => 'select',
							...
							'std' => '',
							'multiple' => false,
							'selector' => '{{SELECTOR}} .wow-column { display: -webkit-box; display: -ms-flexbox; display: flex; -webkit-box-align: {{data.col_content}}; -ms-flex-align: {{data.col_content}}; align-items: {{data.col_content}}; }'
						),
						'col_custom_width' => array(
							...
							'responsive' => true,
							'selector' => '.wow-column-parent{{SELECTOR}} { width: {{data.col_custom_width}}%; }'
						),
						'col_addons_space' => array(
							...
							'responsive' => true,
							'selector' => '{{SELECTOR}} .wow-column .wow-builder-addon{ margin-bottom: {{data.col_addons_space}}; }'
						),
						'col_animation' => array(
							'type' => 'animation',
							'title' => 'Animation',
					...
					'style' => array(
						'col_padding' => array(
							...
							'unit' => array( 'px','em','%' ),
							'responsive' => true,
							'selector' => '.wow-builder-container .wow-row > .wow-column-parent{{SELECTOR}} .wow-column { padding: {{data.col_padding}}; }'
						),
						'col_margin' => array(
							'type' => 'dimension',
							'title' => 'Margin',
							'unit' => array( 'px','em','%' ),
							'responsive' => true,
							'selector' => '.wow-builder-container .wow-row > .wow-column-parent{{SELECTOR}} .wow-column { margin: {{data.col_margin}}; }'
						),
						'col_border' => array(
							'type' => 'border',
							'title' => 'Border',
						...
						'col_border_hover' => array(
							...
							'selector' => '{{SELECTOR}} .wow-column:hover',
							'section' => 'Border',
						),
						'col_boxshadow' => array(
							'type' => 'boxshadow',
							...
							'section' => 'Box shadow',
							'selector' => '{{SELECTOR}} > .wow-column,{{SELECTOR}} > div > .wow-column'
						),
						'col_boxshadow:hover' => array(
							...
							'section' => 'Box shadow',
							'selector' => '{{SELECTOR}} > .wow-column:hover, {{SELECTOR}} > div > .wow-column:hover'
						),
						...
						'col_border_radius' => array(
							...
							'selector' => '{{SELECTOR}} .wow-column,{{SELECTOR}} .wow-column:after{ border-radius: {{data.col_border_radius}} ; }',
							'section' => 'Border Radius',
						),
						'col_border_radius_hover' => array(
							...
							'responsive' => true,
							'depends' => array(array('col_border_radius_check', '=', '1')),
							'selector' => '{{SELECTOR}} .wow-column:hover,{{SELECTOR}} .wow-column:hover:after{ border-radius: {{data.col_border_radius_hover}} ; }',
							'section' => 'Border Radius',
						),
						...
						'col_color_opacity'=> array(
							...
							'title' => 'Add Overlay Color',
							'std' => '#00aeff',
							'selector' => '{{SELECTOR}} .wow-column:after',
							'section' => 'Overlay',
						),
						'col_opacity' => array(
							'type' => 'slider',
							...
							'selector' => '{{SELECTOR}} .wow-column:after{transition: 300ms; content: " "; display: block; position: absolute; height: 100%; top: 0; left: 0; right: 0; opacity: {{data.col_opacity}}; }',
							'section' => 'Overlay',
						),
						'col_color_blend' => array(
							...
							'section' => 'Overlay',
							'selector' => '{{SELECTOR}} .wow-column:after{ mix-blend-mode:{{data.col_color_blend}}; }',
						),
					),
					'advanced' => array(
						'col_id' => array(
						...
						'col_z_index' => array(
							...
							'selector' => '.wow-row .wow-column-parent{{SELECTOR}} .wow-column{ z-index: {{data.col_z_index}}; }',
						),
						'col_hidden_xs' => array(
							'type' => 'switch',
							'title' => 'Hidden on Mobile',
				...
				'attr' => array(
					'general' => array(
						...
						'row_custom_width' => array(
							...
							'responsive' => true,
							'selector' => '.wow-builder-container#wow-builder-container .wow-row-parent{{SELECTOR}} > .wow-container,.wow-builder-container#wow-builder-container .wow-row-parent  .wow-container{{SELECTOR}} { max-width: {{data.row_custom_width}}px;margin-left: auto;margin-right: auto; }'
						),
						'row_custom_gutter' => array(
							...
							'division' => 2,
							'responsive' => true,
							'selector' => array('.wow-row-parent {{SELECTOR}}.wow-container > .wow-row, .wow-row-parent{{SELECTOR}} .wow-container > .wow-row { margin-left:  -{{data.row_custom_gutter}}px; margin-right: -{{data.row_custom_gutter}}px; }',
							'.wow-builder-container {{SELECTOR}} .wow-row .wow-column-parent-editor .wow-column { margin-left: {{data.row_custom_gutter}}px; margin-right: {{data.row_custom_gutter}}px; }',
							'.wow-builder-container {{SELECTOR}} .wow-row .wow-column-parent-view { padding-left: {{data.row_custom_gutter}}px; padding-right: {{data.row_custom_gutter}}px; }',
							'.wow-builder-container#wow-builder-container .wow-row-parent{{SELECTOR}} > .wow-container,.wow-builder-container#wow-builder-container .wow-row-parent  .wow-container{{SELECTOR}} { padding-left: {{data.row_custom_gutter}}px; padding-right: {{data.row_custom_gutter}}px; }')
						),
						'row_animation' => array(
							'type' => 'animation',
							'title' => 'Animation',
					...
					'style' => array(
						'row_padding' => array(
							...
							'unit' => array( 'px','em','%' ),
							'responsive' => true,
							'selector' => '.wow-builder-container > div > div > .wow-row-parent{{SELECTOR}},.wow-builder-container > .wow-row-parent{{SELECTOR}}, .wow-builder-container#wow-builder-container > .wow-row-parent .wow-container{{SELECTOR}}, .wow-builder-container#wow-builder-container .wow-row-placeholder > .wow-row-parent > .wow-container{{SELECTOR}}, .wow-builder-container .wow-inner-row-parent{{SELECTOR}} { padding: {{data.row_padding}}; }'
						),
						'row_margin' => array(
							'type' => 'dimension',
							'title' => 'Margin',
