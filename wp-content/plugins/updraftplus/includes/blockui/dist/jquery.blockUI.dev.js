...
(function () {
  ...
  function setup($) {
    ...
    var setExpr = "function" === typeof document.createElement('div').style.setExpression; // global $ methods for blocking/unblocking the entire page
    ...
    function install(el, opts) {
      ...
      if (ie6 || expr) {
        ...
        if (full && opts.allowBodyStretch && "CSS1Compat" === document.compatMode) $('html,body').css('height', '100%'); // fix ie6 issue when blocked element has a border width
        ...
        $.each(layers, function (i, o) {
          ...
          if (i < 2) {
            if (full) s.setExpression('height', 'Math.max(document.body.scrollHeight, document.body.offsetHeight) - ("CSS1Compat" === document.compatMode?0:' + opts.quirksmodeOffsetHack + ') + "px"');else s.setExpression('height', 'this.parentNode.offsetHeight + "px"');
            if (full) s.setExpression('width', '"CSS1Compat" === document.compatMode && document.documentElement.clientWidth || document.body.clientWidth + "px"');else s.setExpression('width', 'this.parentNode.offsetWidth + "px"');
    ...
    function bind(b, el, opts) {
      ...
      if (b) $(document).on(events, opts, handler);else $(document).off(events, handler); // former impl...
      //		var $e = $('a,:input');
