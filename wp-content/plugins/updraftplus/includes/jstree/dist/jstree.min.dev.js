...
!function (e) {
  ...
  if (!E.jstree) {
    ...
    !c && i && (c = function c(e, t) {
      ...
      _kbevent_to_func: function _kbevent_to_func(e) {
        var t = {
          ...
          173: "-"
            ...
            i = [];
        if (e.ctrlKey && i.push("ctrl"), e.altKey && i.push("alt"), e.shiftKey && i.push("shift"), i.push(t[e.which] || e.which), "shift-shift" === (i = i.sort().join("-").toLowerCase()) || "ctrl-ctrl" === i || "alt-alt" === i) return null;
            ...
            if (this.element && !this.get_container_ul().find(".jstree-loading").length) {
              if (this._data.core.ready = !0, this._data.core.selected.length) {
                if (this.settings.core.expand_selected_onload) {
                  for (var e = [], t, i, t = 0, i = this._data.core.selected.length; t < i; t++) {
                    e = e.concat(this._model.data[this._data.core.selected[t]].parents);
                  }

                  for (t = 0, i = (e = E.vakata.array_unique(e)).length; t < i; t++) {
      ...
      _nextSibling: function _nextSibling(e) {
      ...
      _previousSibling: function _previousSibling(e) {
      ...
      get_node: function get_node(e, t) {
        var i;
        (e = e && e.id ? e.id : e) instanceof E && e.length && e[0].id && (e = e[0].id);
      ...
      get_prev_dom: function get_prev_dom(e, t) {
        var i;
      ...
      get_parent: function get_parent(e) {
        return !(!(e = this.get_node(e)) || e.id === E.jstree.root) && e.parent;
      },
      get_children_dom: function get_children_dom(e) {
      ...
      is_parent: function is_parent(e) {
        return (e = this.get_node(e)) && (!1 === e.state.loaded || 0 < e.children.length);
      },
      is_loaded: function is_loaded(e) {
        return (e = this.get_node(e)) && e.state.loaded;
      },
      is_loading: function is_loading(e) {
        return (e = this.get_node(e)) && e.state && e.state.loading;
      },
      is_open: function is_open(e) {
        return (e = this.get_node(e)) && e.state.opened;
      },
      is_closed: function is_closed(e) {
        return (e = this.get_node(e)) && this.is_parent(e) && !e.state.opened;
      },
      is_leaf: function is_leaf(e) {
        return !this.is_parent(e);
      },
      load_node: function load_node(n, o) {
        var e, t, i, r, s;
        if (E.vakata.is_array(n)) return this._load_nodes(n.slice(), o), !0;
        if (!(n = this.get_node(n))) return o && o.call(this, n, !1), !1;

        if (n.state.loaded) {
          for (n.state.loaded = !1, i = 0, r = n.parents.length; i < r; i++) {
            this._model.data[n.parents[i]].children_d = E.vakata.array_filter(this._model.data[n.parents[i]].children_d, function (e) {
              return -1 === E.inArray(e, n.children_d);
            });
          }

          for (e = 0, t = n.children_d.length; e < t; e++) {
            this._model.data[n.children_d[e]].state.selected && (s = !0), delete this._model.data[n.children_d[e]];
          }
      ...
      _load_nodes: function _load_nodes(e, t, i, r) {
        for (var s = !0, a = function a() {
          this._load_nodes(e, t, !0);
        }, n = this._model.data, o, d, c = [], o = 0, d = e.length; o < d; o++) {
          n[e[o]] && (!n[e[o]].state.loaded && !n[e[o]].state.failed || !i && r) && (this.is_loading(e[o]) || this.load_node(e[o], a), s = !1);
        }
      ...
      load_all: function load_all(e, t) {
        ...
        for (e.state && !e.state.loaded && i.push(e.id), a = 0, n = s.length; a < n; a++) {
      ...
      _load_node: function _load_node(s, a) {
        ...
        }.bind(this)) : "object" == _typeof(e) ? e.url ? (e = E.extend(!0, {}, e), E.vakata.is_function(e.url) && (e.url = e.url.call(this, s)), E.vakata.is_function(e.data) && (e.data = e.data.call(this, s)), E.ajax(e).done(function (e, t, i) {
          var r = i.getResponseHeader("Content-Type");
          return r && -1 !== r.indexOf("json") || "object" == _typeof(e) ? this._append_json_data(s, e, function (e) {
            a.call(this, e);
      ...
      _node_changed: function _node_changed(e) {
        (e = this.get_node(e)) && -1 === E.inArray(e.id, this._model.changed) && this._model.changed.push(e.id);
      },
      _append_html_data: function _append_html_data(e, t, i) {
        ...
        }.bind(this)), o.children = s, o.children_d = a, c = 0, l = o.parents.length; c < l; c++) {
      ...
      _append_json_data: function _append_json_data(e, t, d, i) {
        if (null !== this.element) {
          ...
          var r = null,
            ...
            var t = (e = e.data ? e.data : e).dat,
              ...
              if (e && e.data && e.data.jstree && e.data.jstree.icon && (d.icon = e.data.jstree.icon), d.icon !== c && null !== d.icon && "" !== d.icon || (d.icon = !0), e && e.data && (d.data = e.data, e.data.jstree)) for (s in e.data.jstree) {
                e.data.jstree.hasOwnProperty(s) && (d.state[s] = e.data.jstree[s]);
              }
              if (e && "object" == _typeof(e.state)) for (s in e.state) {
                e.state.hasOwnProperty(s) && (d.state[s] = e.state[s]);
              }
              if (e && "object" == _typeof(e.li_attr)) for (s in e.li_attr) {
                e.li_attr.hasOwnProperty(s) && (d.li_attr[s] = e.li_attr[s]);
              }
              if (d.li_attr.id || (d.li_attr.id = r), e && "object" == _typeof(e.a_attr)) for (s in e.a_attr) {
                e.a_attr.hasOwnProperty(s) && (d.a_attr[s] = e.a_attr[s]);
              }

              for (e && e.children && !0 === e.children && (d.state.loaded = !1, d.children = [], d.children_d = []), s = 0, a = (u[d.id] = d).children.length; s < a; s++) {
                n = p(u[d.children[s]], d.id, i), o = u[n], d.children_d.push(n), o.children_d.length && (d.children_d = d.children_d.concat(o.children_d));
              }
              ...
              for (s in d = {
                ...
                icon: "object" != _typeof(e) || e.icon === c || e.icon,
                parent: t,
                parents: i,
                children: [],
                children_d: [],
              ...
              if (e && e.id && (d.id = e.id.toString()), e && e.text && (d.text = e.text), e && e.data && e.data.jstree && e.data.jstree.icon && (d.icon = e.data.jstree.icon), d.icon !== c && null !== d.icon && "" !== d.icon || (d.icon = !0), e && e.data && (d.data = e.data, e.data.jstree)) for (s in e.data.jstree) {
                e.data.jstree.hasOwnProperty(s) && (d.state[s] = e.data.jstree[s]);
              }
              if (e && "object" == _typeof(e.state)) for (s in e.state) {
                e.state.hasOwnProperty(s) && (d.state[s] = e.state[s]);
              ...
              if (d.li_attr.id && !d.id && (d.id = d.li_attr.id.toString()), d.id || (d.id = r), d.li_attr.id || (d.li_attr.id = d.id), e && "object" == _typeof(e.a_attr)) for (s in e.a_attr) {
                e.a_attr.hasOwnProperty(s) && (d.a_attr[s] = e.a_attr[s]);
              }

              if (e && e.children && e.children.length) {
                for (s = 0, a = e.children.length; s < a; s++) {
                  n = m(e.children[s], d.id, i), o = u[n], d.children.push(n), o.children_d.length && (d.children_d = d.children_d.concat(o.children_d));
                }
            ...
            if (t.length && t[0].id !== c && t[0].parent !== c) {
              for (o = 0, d = t.length; o < d; o++) {
                t[o].children || (t[o].children = []), t[o].state || (t[o].state = {}), u[t[o].id.toString()] = t[o];
              }

              for (o = 0, d = t.length; o < d; o++) {
                u[t[o].parent.toString()] ? (u[t[o].parent.toString()].children.push(t[o].id.toString()), a.children_d.push(t[o].id.toString())) : void 0 !== v && (v._data.core.last_error = {
                  error: "parse",
                  plugin: "core",
                  id: "core_07",
              ...
              for (o = 0, d = a.children.length; o < d; o++) {
                n = p(u[a.children[o]], i, a.parents.concat()), s.push(n), u[n].children_d.length && (s = s.concat(u[n].children_d));
              }

              for (o = 0, d = a.parents.length; o < d; o++) {
                u[a.parents[o]].children_d = u[a.parents[o]].children_d.concat(s);
              }
              ...
              for (o = 0, d = t.length; o < d; o++) {
                (n = m(t[o], i, a.parents.concat())) && (r.push(n), s.push(n), u[n].children_d.length && (s = s.concat(u[n].children_d)));
              }

              for (a.children = r, a.children_d = s, o = 0, d = a.parents.length; o < d; o++) {
                u[a.parents[o]].children_d = u[a.parents[o]].children_d.concat(s);
              }
            ...
            if (null !== this.element) {
              ...
              for (i in this._cnt = e.cnt, r = this._model.data) {
                r.hasOwnProperty(i) && r[i].state && r[i].state.loading && e.mod[i] && (e.mod[i].state.loading = !0);
              }
              ...
              if (this._model.data = e.mod, t) {
                ...
                if (n.length !== o.length || E.vakata.array_unique(n.concat(o)).length !== n.length) {
                  for (i = 0, s = n.length; i < s; i++) {
                    -1 === E.inArray(n[i], a) && -1 === E.inArray(n[i], o) && (r[n[i]].state.selected = !1);
                  }

                  for (i = 0, s = o.length; i < s; i++) {
                    -1 === E.inArray(o[i], n) && (r[o[i]].state.selected = !0);
                  }
                }
              }
      ...
      _parse_model_from_html: function _parse_model_from_html(e, t, i) {
        ...
        for (o in this._model.default_state) {
          this._model.default_state.hasOwnProperty(o) && (n.state[o] = this._model.default_state[o]);
        }
        ...
        })), (t = (e.children("a").first().length ? e.children("a").first() : e).clone()).children("ins, i, ul").remove(), t = t.html(), t = E("<div></div>").html(t), n.text = this.settings.core.force_text ? t.text() : t.html(), t = e.data(), n.data = t ? E.extend(!0, {}, t) : null, n.state.opened = e.hasClass("jstree-open"), n.state.selected = e.children("a").hasClass("jstree-clicked"), n.state.disabled = e.children("a").hasClass("jstree-disabled"), n.data && n.data.jstree) for (o in n.data.jstree) {
          n.data.jstree.hasOwnProperty(o) && (n.state[o] = n.data.jstree[o]);
        }
      ...
      _parse_model_from_flat_json: function _parse_model_from_flat_json(e, t, i) {
        i = i ? i.concat() : [], t && i.unshift(t);
        var r = e.id.toString(),
            s = this._model.data,
        ...
        for (n in a) {
          a.hasOwnProperty(n) && (l.state[n] = a[n]);
        }

        if (e && e.data && e.data.jstree && e.data.jstree.icon && (l.icon = e.data.jstree.icon), l.icon !== P && null !== l.icon && "" !== l.icon || (l.icon = !0), e && e.data && (l.data = e.data, e.data.jstree)) for (n in e.data.jstree) {
          e.data.jstree.hasOwnProperty(n) && (l.state[n] = e.data.jstree[n]);
        }
        if (e && "object" == _typeof(e.state)) for (n in e.state) {
          e.state.hasOwnProperty(n) && (l.state[n] = e.state[n]);
        }
        if (e && "object" == _typeof(e.li_attr)) for (n in e.li_attr) {
          e.li_attr.hasOwnProperty(n) && (l.li_attr[n] = e.li_attr[n]);
        }
        if (l.li_attr.id || (l.li_attr.id = r), e && "object" == _typeof(e.a_attr)) for (n in e.a_attr) {
          e.a_attr.hasOwnProperty(n) && (l.a_attr[n] = e.a_attr[n]);
        }

        for (e && e.children && !0 === e.children && (l.state.loaded = !1, l.children = [], l.children_d = []), n = 0, o = (s[l.id] = l).children.length; n < o; n++) {
          c = s[d = this._parse_model_from_flat_json(s[l.children[n]], l.id, i)], l.children_d.push(d), c.children_d.length && (l.children_d = l.children_d.concat(c.children_d));
        }

        return delete e.data, delete e.children, s[l.id].original = e, l.state.selected && this._data.core.selected.push(l.id), l.id;
      },
      _parse_model_from_json: function _parse_model_from_json(e, t, i) {
        i = i ? i.concat() : [], t && i.unshift(t);
        var r = !1,
            s,
            a,
        ...
        for (s in l = {
          id: !1,
          text: "string" == typeof e ? e : "",
          icon: "object" != _typeof(e) || e.icon === P || e.icon,
          parent: t,
          parents: i,
          children: [],
          children_d: [],
        ...
        if (e && e.id && (l.id = e.id.toString()), e && e.text && (l.text = e.text), e && e.data && e.data.jstree && e.data.jstree.icon && (l.icon = e.data.jstree.icon), l.icon !== P && null !== l.icon && "" !== l.icon || (l.icon = !0), e && e.data && (l.data = e.data, e.data.jstree)) for (s in e.data.jstree) {
          e.data.jstree.hasOwnProperty(s) && (l.state[s] = e.data.jstree[s]);
        }
        if (e && "object" == _typeof(e.state)) for (s in e.state) {
        ...
        if (l.li_attr.id && !l.id && (l.id = l.li_attr.id.toString()), l.id || (l.id = r), l.li_attr.id || (l.li_attr.id = l.id), e && "object" == _typeof(e.a_attr)) for (s in e.a_attr) {
          e.a_attr.hasOwnProperty(s) && (l.a_attr[s] = e.a_attr[s]);
        }

        if (e && e.children && e.children.length) {
          for (s = 0, a = e.children.length; s < a; s++) {
            o = d[n = this._parse_model_from_json(e.children[s], l.id, i)], l.children.push(n), o.children_d.length && (l.children_d = l.children_d.concat(o.children_d));
          }
      ...
      _redraw: function _redraw() {
        for (var e = (this._model.force_full_redraw ? this._model.data[E.jstree.root].children : this._model.changed).concat([]), t = b.createElement("UL"), i, r, s, a = this._data.core.focused, r = 0, s = e.length; r < s; r++) {
          (i = this.redraw_node(e[r], !0, this._model.force_full_redraw)) && this._model.force_full_redraw && t.appendChild(i);
        }
      ...
      draw_children: function draw_children(e) {
        ...
        if (e.children(".jstree-children").remove(), e = e[0], t.children.length && t.state.loaded) {
          for ((s = a.createElement("UL")).setAttribute("role", "group"), s.className = "jstree-children", i = 0, r = t.children.length; i < r; i++) {
      ...
      redraw_node: function redraw_node(e, t, i, r) {
        ...
        for (d in e = this._data.core.node.cloneNode(!0), h = "jstree-node ", s.li_attr) {
          s.li_attr.hasOwnProperty(d) && "id" !== d && ("class" !== d ? e.setAttribute(d, s.li_attr[d]) : h += s.li_attr[d]);
        }
        ...
        if (null !== s.parent && g[s.parent] && !s.state.hidden && (d = E.inArray(s.id, g[s.parent].children), k = s.id, -1 !== d)) for (d++, c = g[s.parent].children.length; d < c; d++) {
          if ((k = !g[g[s.parent].children[d]].state.hidden ? g[s.parent].children[d] : k) !== s.id) break;
        }

        for (c in s.state.hidden && (h += " jstree-hidden"), s.state.loading && (h += " jstree-loading"), s.state.loaded && !j ? h += " jstree-leaf" : (h += s.state.opened && s.state.loaded ? " jstree-open" : " jstree-closed", e.childNodes[1].setAttribute("aria-expanded", s.state.opened && s.state.loaded)), k === s.id && (h += " jstree-last"), e.id = s.id, e.className = h, h = (s.state.selected ? " jstree-clicked" : "") + (s.state.disabled ? " jstree-disabled" : ""), s.a_attr) {
          s.a_attr.hasOwnProperty(c) && ("href" === c && "#" === s.a_attr[c] || ("class" !== c ? e.childNodes[1].setAttribute(c, s.a_attr[c]) : h += " " + s.a_attr[c]));
        }
        ...
        if (h.length && (e.childNodes[1].className = "jstree-anchor " + h), (s.icon && !0 !== s.icon || !1 === s.icon) && (!1 === s.icon ? e.childNodes[1].childNodes[0].className += " jstree-themeicon-hidden" : -1 === s.icon.indexOf("/") && -1 === s.icon.indexOf(".") ? e.childNodes[1].childNodes[0].className += " " + s.icon + " jstree-themeicon-custom" : (e.childNodes[1].childNodes[0].style.backgroundImage = 'url("' + s.icon + '")', e.childNodes[1].childNodes[0].style.backgroundPosition = "center center", e.childNodes[1].childNodes[0].style.backgroundSize = "auto", e.childNodes[1].childNodes[0].className += " jstree-themeicon-custom")), this.settings.core.force_text ? e.childNodes[1].appendChild(_.createTextNode(s.text)) : e.childNodes[1].innerHTML += s.text, t && s.children.length && (s.state.opened || r) && s.state.loaded) {
          for ((l = _.createElement("UL")).setAttribute("role", "group"), l.className = "jstree-children", d = 0, c = s.children.length; d < c; d++) {
      ...
      open_node: function open_node(e, i, r) {
        var t, s, a, n;
      ...
      close_node: function close_node(e, t) {
        var i, r, s, a;
      ...
      toggle_node: function toggle_node(e) {
        var t, i;
      ...
      open_all: function open_all(e, i, r) {
        if (e = e || E.jstree.root, !(e = this.get_node(e))) return !1;
      ...
      close_all: function close_all(e, t) {
        if (e = e || E.jstree.root, !(e = this.get_node(e))) return !1;
        ...
        })), s = 0, a = e.children_d.length; s < a; s++) {
      ...
      is_disabled: function is_disabled(e) {
        return (e = this.get_node(e)) && e.state && e.state.disabled;
      },
      enable_node: function enable_node(e) {
        var t, i;
      ...
      disable_node: function disable_node(e) {
        var t, i;
      ...
      is_hidden: function is_hidden(e) {
        return !0 === (e = this.get_node(e)).state.hidden;
      },
      hide_node: function hide_node(e, t) {
        var i, r;
      ...
      show_node: function show_node(e, t) {
        var i, r;
      ...
      hide_all: function hide_all(e) {
        var t,
            i = this._model.data,
            r = [];

        for (t in i) {
          i.hasOwnProperty(t) && t !== E.jstree.root && !i[t].state.hidden && (i[t].state.hidden = !0, r.push(t));
        }
      ...
      show_all: function show_all(e) {
        var t,
            i = this._model.data,
            r = [];

        for (t in i) {
          i.hasOwnProperty(t) && t !== E.jstree.root && i[t].state.hidden && (i[t].state.hidden = !1, r.push(t));
        }
      ...
      activate_node: function activate_node(e, t) {
        if (this.is_disabled(e)) return !1;
        if (t && "object" == _typeof(t) || (t = {}), this._data.core.last_clicked = this._data.core.last_clicked && this._data.core.last_clicked.id !== P ? this.get_node(this._data.core.last_clicked.id) : null, this._data.core.last_clicked && !this._data.core.last_clicked.state.selected && (this._data.core.last_clicked = null), !this._data.core.last_clicked && this._data.core.selected.length && (this._data.core.last_clicked = this.get_node(this._data.core.selected[this._data.core.selected.length - 1])), this.settings.core.multiple && (t.metaKey || t.ctrlKey || t.shiftKey) && (!t.shiftKey || this._data.core.last_clicked && this.get_parent(e) && this.get_parent(e) === this._data.core.last_clicked.parent)) {
          if (t.shiftKey) {
            for (var i = this.get_node(e).id, r = this._data.core.last_clicked.id, s = this.get_node(this._data.core.last_clicked.parent).children, a = !1, n, o, n = 0, o = s.length; n < o; n += 1) {
              s[n] === i && (a = !a), s[n] === r && (a = !a), this.is_disabled(s[n]) || !a && s[n] !== i && s[n] !== r ? this.deselect_node(s[n], !0, t) : this.is_hidden(s[n]) || this.select_node(s[n], !0, !1, t);
            }
      ...
      hover_node: function hover_node(e) {
      ...
      deselect_node: function deselect_node(e, t, i) {
        var r, s, a;
      ...
      select_all: function select_all(e) {
        ...
        for (this._data.core.selected = this._model.data[E.jstree.root].children_d.concat(), i = 0, r = this._data.core.selected.length; i < r; i++) {
      ...
      deselect_all: function deselect_all(e) {
        for (var t = this._data.core.selected.concat([]), i, r, i = 0, r = this._data.core.selected.length; i < r; i++) {
      ...
      is_selected: function is_selected(e) {
        return !(!(e = this.get_node(e)) || e.id === E.jstree.root) && e.state.selected;
      },
      get_selected: function get_selected(e) {
        return e ? E.map(this._data.core.selected, function (e) {
          return this.get_node(e);
        }.bind(this)) : this._data.core.selected.slice();
      },
      get_top_selected: function get_top_selected(e) {
        for (var t = this.get_selected(!0), i = {}, r, s, a, n, r = 0, s = t.length; r < s; r++) {
          i[t[r].id] = t[r];
        }
      ...
      get_bottom_selected: function get_bottom_selected(e) {
        for (var t = this.get_selected(!0), i = [], r, s, r = 0, s = t.length; r < s; r++) {
      ...
      get_state: function get_state() {
        ...
        for (t in this._model.data) {
          this._model.data.hasOwnProperty(t) && t !== E.jstree.root && (this._model.data[t].state.loaded && this.settings.core.loaded_state && e.core.loaded.push(t), this._model.data[t].state.opened && e.core.open.push(t), this._model.data[t].state.selected && e.core.selected.push(t));
        }

        return e;
      },
      set_state: function set_state(t, i) {
        if (t) {
          if (t.core && t.core.selected && t.core.initial_selection === P && (t.core.initial_selection = this._data.core.selected.concat([]).sort().join(",")), t.core) {
            ...
            for (n in t) {
              t.hasOwnProperty(n) && "core" !== n && -1 === E.inArray(n, this.settings.plugins) && delete t[n];
            }
      ...
      refresh_node: function refresh_node(t) {
      ...
      set_id: function set_id(e, t) {
        ...
        for (t = t.toString(), s[e.parent].children[E.inArray(e.id, s[e.parent].children)] = t, i = 0, r = e.parents.length; i < r; i++) {
          s[e.parents[i]].children_d[E.inArray(e.id, s[e.parents[i]].children_d)] = t;
        }
        ...
        for (i = 0, r = e.children_d.length; i < r; i++) {
          s[e.children_d[i]].parents[E.inArray(e.id, s[e.children_d[i]].parents)] = t;
        }
      ...
      set_text: function set_text(e, t) {
        var i, r;
      ...
      get_json: function get_json(e, t, i) {
        ...
        var r = {
          ...
          data: (!t || !t.no_data) && E.extend(!0, E.vakata.is_array(e.data) ? [] : {}, e.data)
            ...
            s,
            a;
        if (t && t.flat ? r.parent = e.parent : r.children = [], t && t.no_state) delete r.state;else for (s in e.state) {
          e.state.hasOwnProperty(s) && (r.state[s] = e.state[s]);
        }
        if (t && t.no_li_attr && delete r.li_attr, t && t.no_a_attr && delete r.a_attr, t && t.no_id && (delete r.id, r.li_attr && r.li_attr.id && delete r.li_attr.id, r.a_attr && r.a_attr.id && delete r.a_attr.id), t && t.flat && e.id !== E.jstree.root && i.push(r), !t || !t.no_children) for (s = 0, a = e.children.length; s < a; s++) {
          t && t.flat ? this.get_json(e.children[s], t, i) : r.children.push(this.get_json(e.children[s], t));
        }
        return t && t.flat ? i : e.id === E.jstree.root ? r.children : r;
      },
      create_node: function create_node(e, t, i, r, s) {
        ...
        for (a = this.get_node(t), (n = []).push(t), n = n.concat(a.children_d), this.trigger("model", {
          nodes: n,
          parent: e.id
        }), e.children_d = e.children_d.concat(n), o = 0, d = e.parents.length; o < d; o++) {
      ...
      rename_node: function rename_node(e, t) {
        var i, r, s;
      ...
      delete_node: function delete_node(e) {
        ...
        for (-1 !== s && (r.children = E.vakata.array_remove(r.children, s)), (a = e.children_d.concat([])).push(e.id), n = 0, o = e.parents.length; n < o; n++) {
          this._model.data[e.parents[n]].children_d = E.vakata.array_filter(this._model.data[e.parents[n]].children_d, function (e) {
      ...
      check: function check(e, t, i, r, s) {
      ...
      move_node: function move_node(e, t, i, r, s, a, n) {
        ...
        if (E.vakata.is_array(e)) {
          if (1 !== e.length) {
            for (o = 0, d = e.length; o < d; o++) {
              (f = this.move_node(e[o], t, i, r, s, !1, n)) && (t = f, i = "after");
            }
        ...
        if (e.parent === h.id) {
          for (u = h.children.concat(), -1 !== (f = E.inArray(e.id, u)) && (u = E.vakata.array_remove(u, f), f < i && i--), f = [], p = 0, m = u.length; p < m; p++) {
            f[i <= p ? p + 1 : p] = u[p];
          }
          ...
          for ((f = e.children_d.concat()).push(e.id), p = 0, m = e.parents.length; p < m; p++) {
            for (u = [], v = 0, j = (k = _._model.data[e.parents[p]].children_d).length; v < j; v++) {
          ...
          for (_._model.data[c].children = E.vakata.array_remove_item(_._model.data[c].children, e.id), p = 0, m = h.parents.length; p < m; p++) {
          ...
          for (u[i] = e.id, h.children = u, h.children_d.push(e.id), h.children_d = h.children_d.concat(e.children_d), e.parent = h.id, (f = h.parents.concat()).unshift(h.id), k = e.parents.length, f = (e.parents = f).concat(), p = 0, m = e.children_d.length; p < m; p++) {
            this._model.data[e.children_d[p]].parents = this._model.data[e.children_d[p]].parents.slice(0, -1 * k), Array.prototype.push.apply(this._model.data[e.children_d[p]].parents, f);
          }
      ...
      copy_node: function copy_node(e, t, i, r, s, a, n) {
        ...
        if (E.vakata.is_array(e)) {
          if (1 !== e.length) {
            for (o = 0, d = e.length; o < d; o++) {
              (l = this.copy_node(e[o], t, i, r, s, !0, n)) && (t = l, i = "after");
            }
      ...
      cut: function cut(e) {
        ...
        for (var t = [], i, r, s, r = 0, s = e.length; r < s; r++) {
          (i = this.get_node(e[r])) && i.id && i.id !== E.jstree.root && t.push(i);
        }
      ...
      set_theme: function set_theme(e, t) {
        if (!e) return !1;
        var i, i;
      ...
      set_theme_variant: function set_theme_variant(e) {
      ...
      set_icon: function set_icon(e, t) {
        var i, r, s, a;
      ...
      get_icon: function get_icon(e) {
        return !(!(e = this.get_node(e)) || e.id === E.jstree.root) && e.icon;
      },
      hide_icon: function hide_icon(e) {
        var t, i;
      ...
      show_icon: function show_icon(e) {
        var t, i, r;
      ...
      for (s in r = [], e) {
        ~~s + "" == s + "" && 0 <= s && t.call(i, e[s], +s, e) && r.push(e[s]);
      }
      ...
      this.trigger = function (e, t) {
        ...
        if (t = t || {}, "changed" === e.replace(".jstree", "")) {
          ...
          for (i = 0, r = t.selected.length; i < r; i++) {
            s[t.selected[i]] ? s[t.selected[i]] = 2 : t.changed.selected.push(t.selected[i]);
          }
    ...
    l.className = "jstree-icon jstree-checkbox", l.setAttribute("role", "presentation"), E.jstree.defaults.checkbox = {
      ...
      this.bind = function () {
        d.bind.call(this), this._data.checkbox.uto = !1, this._data.checkbox.selected = [], this.settings.checkbox.three_state && (this.settings.checkbox.cascade = "up+down+undetermined"), this.element.on("init.jstree", function () {
          ...
          for (var i = this._model.data, r = i[t.parent], s = t.nodes, a, n, a = 0, n = s.length; a < n; a++) {
            i[s[a]].state.checked = i[s[a]].state.checked || i[s[a]].original && i[s[a]].original.state && i[s[a]].original.state.checked, i[s[a]].state.checked && this._data.checkbox.selected.push(s[a]);
          }
          ...
          } else for (o = 0, d = s.length; o < d; o++) {
            if (i[s[o]].state[_ ? "selected" : "checked"]) {
              for (c = 0, l = i[s[o]].children_d.length; c < l; c++) {
                i[i[s[o]].children_d[c]].state[_ ? "selected" : "checked"] = !0;
              }
          ...
          if (-1 !== t.indexOf("up")) {
            for (o = 0, d = r.children_d.length; o < d; o++) {
              i[r.children_d[o]].children.length || a.push(i[r.children_d[o]].parent);
            }
            ...
            for (c = 0, l = (a = E.vakata.array_unique(a)).length; c < l; c++) {
              ...
              while (r && r.id !== E.jstree.root) {
                ...
                if (n !== d) break;
                r.state[_ ? "selected" : "checked"] = !0, this._data[_ ? "core" : "checkbox"].selected.push(r.id), (h = this.get_node(r, !0)) && h.length && h.attr("aria-selected", !0).children(".jstree-anchor").addClass(_ ? "jstree-clicked" : "jstree-checked"), r = this.get_node(r.parent);
              }
            }
          }
          ...
          if (-1 !== t.indexOf("down")) for (var g = this._cascade_new_checked_state(r.id, !0), u = r.children_d.concat(r.id), n = 0, o = u.length; n < o; n++) {
            -1 < g.indexOf(u[n]) ? h[u[n]] = !0 : delete h[u[n]];
          }
          if (-1 !== t.indexOf("up")) while (a && a.id !== E.jstree.root) {
            for (n = d = 0, o = a.children.length; n < o; n++) {
              d += s[a.children[n]].state[l ? "selected" : "checked"];
            }

            if (d !== o) break;
            a.state[l ? "selected" : "checked"] = !0, h[a.id] = !0, (c = this.get_node(a, !0)) && c.length && c.attr("aria-selected", !0).children(".jstree-anchor").addClass(l ? "jstree-clicked" : "jstree-checked"), a = this.get_node(a.parent);
          }
          ...
          for (var i = this.get_node(E.jstree.root), r = this._model.data, s, a, n, s = 0, a = i.children_d.length; s < a; s++) {
            (n = r[i.children_d[s]]) && n.original && n.original.state && n.original.state.undetermined && (n.original.state.undetermined = !1);
          }
          ...
          if (-1 !== d.indexOf("down") && (g = this._cascade_new_checked_state(r.id, !1), t = E.vakata.array_filter(t, function (e) {
            ...
            for (a = 0, n = r.parents.length; a < n; a++) {
              (o = this._model.data[r.parents[a]]).state[c ? "selected" : "checked"] = !1, o && o.original && o.original.state && o.original.state.undetermined && (o.original.state.undetermined = !1), (o = this.get_node(r.parents[a], !0)) && o.length && o.attr("aria-selected", !1).children(".jstree-anchor").removeClass(c ? "jstree-clicked" : "jstree-checked");
            }
          ...
          if (!i) {
            ...
            while (a && a.id !== E.jstree.root && !a.state[l ? "selected" : "checked"]) {
              ...
              if (!(0 < d && n === d)) break;
              a.state[l ? "selected" : "checked"] = !0, this._data[l ? "core" : "checkbox"].selected.push(a.id), (c = this.get_node(a, !0)) && c.length && c.attr("aria-selected", !0).children(".jstree-anchor").addClass(l ? "jstree-clicked" : "jstree-checked"), a = this.get_node(a.parent);
            }
          }
          ...
          while (a && a.id !== E.jstree.root) {
            ...
            if (n === d) a.state[l ? "selected" : "checked"] || (a.state[l ? "selected" : "checked"] = !0, this._data[l ? "core" : "checkbox"].selected.push(a.id), (c = this.get_node(a, !0)) && c.length && c.attr("aria-selected", !0).children(".jstree-anchor").addClass(l ? "jstree-clicked" : "jstree-checked"));else {
              if (!a.state[l ? "selected" : "checked"]) break;
              a.state[l ? "selected" : "checked"] = !1, this._data[l ? "core" : "checkbox"].selected = E.vakata.array_remove_item(this._data[l ? "core" : "checkbox"].selected, a.id), (c = this.get_node(a, !0)) && c.length && c.attr("aria-selected", !1).children(".jstree-anchor").removeClass(l ? "jstree-clicked" : "jstree-checked");
            }
        ...
        for (var i, r, s, a, n = {}, o = this._model.data, t = this.settings.checkbox.tie_selection, d = this._data[t ? "core" : "checkbox"].selected, c = [], l = this, h = [], i = 0, r = d.length; i < r; i++) {
          if (o[d[i]] && o[d[i]].parents) for (s = 0, a = o[d[i]].parents.length; s < a; s++) {
        ...
        for (this.element.find(".jstree-closed").not(":has(.jstree-children)").each(function () {
          ...
          if (e) if (e.state.loaded) {
            for (i = 0, r = e.children_d.length; i < r; i++) {
              if (!(t = o[e.children_d[i]]).state.loaded && t.original && t.original.state && t.original.state.undetermined && !0 === t.original.state.undetermined) for (n[t.id] === P && t.id !== E.jstree.root && (n[t.id] = !0, c.push(t.id)), s = 0, a = t.parents.length; s < a; s++) {
                n[t.parents[s]] === P && t.parents[s] !== E.jstree.root && (n[t.parents[s]] = !0, c.push(t.parents[s]));
              }
            }
          } else if (e.original && e.original.state && e.original.state.undetermined && !0 === e.original.state.undetermined) for (n[e.id] === P && e.id !== E.jstree.root && (n[e.id] = !0, c.push(e.id)), s = 0, a = e.parents.length; s < a; s++) {
            n[e.parents[s]] === P && e.parents[s] !== E.jstree.root && (n[e.parents[s]] = !0, c.push(e.parents[s]));
          }
        }), i = 0, r = c.length; i < r; i++) {
          o[c[i]].state[t ? "selected" : "checked"] || h.push(e ? o[c[i]] : c[i]);
        }
        ...
        if (null !== this.element) {
          ...
          for (this.element.find(".jstree-undetermined").removeClass("jstree-undetermined"), t = 0, i = e.length; t < i; t++) {
            (r = this.get_node(e[t], !0)) && r.length && r.children(".jstree-anchor").children(".jstree-checkbox").addClass("jstree-undetermined");
          }
        }
        ...
        if (!this.settings.checkbox.cascade_to_disabled && s.state.disabled || !this.settings.checkbox.cascade_to_hidden && s.state.hidden) c = this.get_checked_descendants(e), s.state[r ? "selected" : "checked"] && c.push(s.id), a = a.concat(c);else {
          ...
          s.original && s.original.state && s.original.state.undetermined && (s.original.state.undetermined = e), !e && t && n.length === s.children.length ? (s.state[r ? "selected" : "checked"] = t, a.push(s.id), h.attr("aria-selected", !0).children(".jstree-anchor").addClass(r ? "jstree-clicked" : "jstree-checked")) : (s.state[r ? "selected" : "checked"] = !1, h.attr("aria-selected", !1).children(".jstree-anchor").removeClass(r ? "jstree-clicked" : "jstree-checked"));
        }
        return a;
        ...
        for (this._data.checkbox.selected = this._model.data[E.jstree.root].children_d.concat(), t = 0, i = this._data.checkbox.selected.length; t < i; t++) {
        ...
        for (var e = this._data.checkbox.selected.concat([]), t, i, t = 0, i = this._data.checkbox.selected.length; t < i; t++) {
        ...
        for (var t = this.get_checked(!0), i = {}, r, s, a, n, r = 0, s = t.length; r < s; r++) {
          i[t[r].id] = t[r];
        }
        ...
        for (var t = this.get_checked(!0), i = [], r, s, r = 0, s = t.length; r < s; r++) {
          t[r].children.length || i.push(t[r].id);
        }
        ...
        var i, r, s, a, n, o;
        if (!E.vakata.is_array(e) && !this.settings.checkbox.tie_selection && (o = this.get_node(e)) && o.state.loaded) for (i = 0, r = o.children_d.length; i < r; i++) {
          this._model.data[o.children_d[i]].state.checked && (this._data.checkbox.selected = E.vakata.array_remove_item(this._data.checkbox.selected, o.children_d[i]));
        }
          ...
          ccp: {
            ...
            submenu: {
              ...
              paste: {
                separator_before: !1,
                icon: !1,
                _disabled: function _disabled(e) {
      ...
      this.bind = function () {
        ...
        this._data.contextmenu.visible && E.vakata.context.hide(), a.teardown.call(this);
      ...
      _parse: function _parse(e, t) {
        ...
        return t && (i += "<ul>"), h.each(e, function (e, t) {
          return !t || (g.items.push(t), !r && t.separator_before && (i += "<li class='vakata-context-separator'><a href='#' " + (h.vakata.context.settings.icons ? "" : 'style="margin-left:0px;"') + ">&#160;</a></li>"), r = !1, i += "<li class='" + (t._class || "") + (!0 === t._disabled || h.vakata.is_function(t._disabled) && t._disabled({
            item: t,
            reference: g.reference,
            element: g.element
            ...
            reference: g.reference,
            element: g.element
          }) : t.label) + (t.shortcut ? ' <span class="vakata-contextmenu-shortcut vakata-contextmenu-shortcut-' + t.shortcut + '">' + (t.shortcut_label || "") + "</span>" : "") + "</a>", t.submenu && (s = h.vakata.context._parse(t.submenu, !0)) && (i += s), i += "</li>", void (t.separator_after && (i += "<li class='vakata-context-separator'><a href='#' " + (h.vakata.context.settings.icons ? "" : 'style="margin-left:0px;"') + ">&#160;</a></li>", r = !0)));
        }), i = i.replace(/<li class\='vakata-context-separator'\><\/li\>$/, ""), t && (i += "</ul>"), t || (g.html = i, h.vakata.context._trigger("parse")), 10 < i.length && i;
      },
      _show_submenu: function _show_submenu(e) {
        var t, i, r, s, a, n, o, d;
      ...
      show: function show(e, t, i) {
        ...
        e && !i && h(e).data("vakata_contextmenu") && (i = h(e).data("vakata_contextmenu")), h.vakata.context._parse(i) && g.element.html(g.html), g.items.length && (g.element.appendTo(b.body), s = g.element, a = g.position_x, n = g.position_y, o = s.width(), d = s.height(), c = h(window).width() + h(window).scrollLeft(), i = h(window).height() + h(window).scrollTop(), c < (a = _ && (a -= s.outerWidth() - h(e).outerWidth()) < h(window).scrollLeft() + 20 ? h(window).scrollLeft() + 20 : a) + o + 20 && (a = c - (o + 20)), i < n + d + 20 && (n = i - (d + 20)), g.element.css({
          left: a,
          top: n
      ...
      E(b).on("dragover.vakata.jstree", function (e) {
        ...
        if (A && (s.event && "dragover" === s.event.type && !a || clearTimeout(A)), s && s.data && s.data.jstree && (!s.event.target.id || "jstree-marker" !== s.event.target.id)) {
          ...
          if (n && n._data && n._data.dnd) if (S.attr("class", "jstree-" + n.get_theme() + (n.settings.core.themes.responsive ? " jstree-dnd-responsive" : "")), x = s.data.origin && (s.data.origin.settings.dnd.always_copy || s.data.origin.settings.dnd.copy && (s.event.metaKey || s.event.ctrlKey)), s.helper.children().attr("class", "jstree-" + n.get_theme() + " jstree-" + n.get_theme() + "-" + n.get_theme_variant() + " " + (n.settings.core.themes.responsive ? " jstree-dnd-responsive" : "")).find(".jstree-copy").first()[x ? "show" : "hide"](), s.event.target !== n.element[0] && s.event.target !== n.get_container_ul()[0] || 0 !== n.get_container_ul().children().length) {
      ...
      this.init = function (e, t) {
        ...
        if (!o) {
          for (r = 0, s = a.length; r < s; r++) {
            i[a[r]] && (i[a[r]].state.loaded || i[a[r]].state.failed) && !d || (t.push(a[r]), (c = this.get_node(a[r], !0)) && c.length && c.addClass("jstree-loading").attr("aria-busy", !0));
          }
          ...
          if (this._data.massload = {}, t.length) {
            if (E.vakata.is_function(e)) return e.call(this, t, function (e) {
              var t, i;
              if (e) for (t in e) {
                e.hasOwnProperty(t) && (this._data.massload[t] = e[t]);
              }

              for (t = 0, i = a.length; t < i; t++) {
                (c = this.get_node(a[t], !0)) && c.length && c.removeClass("jstree-loading").attr("aria-busy", !1);
              }

              l._load_nodes.call(this, a, n, o, d);
            }.bind(this));
            if ("object" == _typeof(e) && e && e.url) return e = E.extend(!0, {}, e), E.vakata.is_function(e.url) && (e.url = e.url.call(this, t)), E.vakata.is_function(e.data) && (e.data = e.data.call(this, t)), E.ajax(e).done(function (e, t, i) {
              var r, s;
              if (e) for (r in e) {
                e.hasOwnProperty(r) && (this._data.massload[r] = e[r]);
              }

              for (r = 0, s = a.length; r < s; r++) {
                (c = this.get_node(a[r], !0)) && c.length && c.removeClass("jstree-loading").attr("aria-busy", !1);
              }
      ...
      this.bind = function () {
        o.bind.call(this), this._data.search.str = "", this._data.search.dom = E(), this._data.search.res = [], this._data.search.opn = [], this._data.search.som = !1, this._data.search.smc = !1, this._data.search.hdn = [], this.element.on("search.jstree", function (e, t) {
          if (this._data.search.som && t.res.length) {
            for (var i = this._model.data, r, s, a = [], n, o, r = 0, s = t.res.length; r < s; r++) {
              if (i[t.res[r]] && !i[t.res[r]].state.hidden && (a.push(t.res[r]), a = a.concat(i[t.res[r]].parents), this._data.search.smc)) for (n = 0, o = i[t.res[r]].children_d.length; n < o; n++) {
                i[i[t.res[r]].children_d[n]] && !i[i[t.res[r]].children_d[n]].state.hidden && a.push(i[t.res[r]].children_d[n]);
              }
            }
        ...
        if (s || (this._data.search.str = r, this._data.search.dom = E(), this._data.search.res = [], this._data.search.opn = [], this._data.search.som = t, this._data.search.smc = a), c = new E.vakata.search(r, !0, {
          ...
          for (_ = 0, g = (h = E.vakata.array_unique(h)).length; _ < g; _++) {
            h[_] !== E.jstree.root && d[h[_]] && !0 === this.open_node(h[_], null, 0) && this._data.search.opn.push(h[_]);
          }
        ...
        if (e = o.redraw_node.apply(this, arguments), e && -1 !== E.inArray(e.id, this._data.search.res)) {
          for (var s, a, n = null, s = 0, a = e.childNodes.length; s < a; s++) {
            if (e.childNodes[s] && e.childNodes[s].className && -1 !== e.childNodes[s].className.indexOf("jstree-anchor")) {
              n = e.childNodes[s];
              break;
      ...
      return 32 < k && (m.fuzzy = !1), m.fuzzy && (b = 1 << k - 1, y = function () {
        ...
        for (-1 !== a && (s = Math.min(x(0, a), s), -1 !== (a = e.lastIndexOf(p, v + k)) && (s = Math.min(x(0, a), s))), a = -1, t = 0; t < k; t++) {
          ...
          while (n < o) {
            x(t, v + o) <= s ? n = o : d = o, o = Math.floor((d - n) / 2 + n);
          }
          ...
          for (d = o, l = Math.max(1, v - o + 1), h = Math.min(v + o, r) + k, (_ = new Array(h + 2))[h + 1] = (1 << t) - 1, i = h; l <= i; i--) {
            if (g = y[e.charAt(i - 1)], _[i] = 0 === t ? (_[i + 1] << 1 | 1) & g : (_[i + 1] << 1 | 1) & g | (c[i + 1] | c[i]) << 1 | 1 | c[i + 1], _[i] & b && (u = x(t, i - 1)) <= s) {
              if (s = u, a = i - 1, f.push(a), !(v < a)) break;
              l = Math.max(1, 2 * v - a);
            }
          }
    ...
    var m = !(E.jstree.plugins.sort = function (e, t) {
      this.bind = function () {
        ...
        var i, r;
        if (e = this.get_node(e), e && e.children && e.children.length && (e.children.sort(this.settings.sort.bind(this)), t)) for (i = 0, r = e.children_d.length; i < r; i++) {
    ...
    E.jstree.defaults.state = {
      ...
      this.init = function (e, t) {
        var i, r;
        if (t && t.types && t.types["default"]) for (i in t.types) {
          if ("default" !== i && i !== E.jstree.root && t.types.hasOwnProperty(i)) for (r in t.types["default"]) {
            t.types["default"].hasOwnProperty(r) && t.types[i][r] === P && (t.types[i][r] = t.types["default"][r]);
          }
        }
        ...
        this.element.on("model.jstree", function (e, t) {
          for (var i = this._model.data, r = t.nodes, s = this.settings.types, a, n, o = "default", d, a = 0, n = r.length; a < n; a++) {
            if (o = "default", i[r[a]].original && i[r[a]].original.type && s[i[r[a]].original.type] && (o = i[r[a]].original.type), i[r[a]].data && i[r[a]].data.jstree && i[r[a]].data.jstree.type && s[i[r[a]].data.jstree.type] && (o = i[r[a]].data.jstree.type), i[r[a]].type = o, !0 === i[r[a]].icon && s[o].icon !== P && (i[r[a]].icon = s[o].icon), s[o].li_attr !== P && "object" == _typeof(s[o].li_attr)) for (d in s[o].li_attr) {
              s[o].li_attr.hasOwnProperty(d) && "id" !== d && (i[r[a]].li_attr[d] === P ? i[r[a]].li_attr[d] = s[o].li_attr[d] : "class" === d && (i[r[a]].li_attr["class"] = s[o].li_attr["class"] + " " + i[r[a]].li_attr["class"]));
            }
            if (s[o].a_attr !== P && "object" == _typeof(s[o].a_attr)) for (d in s[o].a_attr) {
              s[o].a_attr.hasOwnProperty(d) && "id" !== d && (i[r[a]].a_attr[d] === P ? i[r[a]].a_attr[d] = s[o].a_attr[d] : "href" === d && "#" === i[r[a]].a_attr[d] ? i[r[a]].a_attr.href = s[o].a_attr.href : "class" === d && (i[r[a]].a_attr["class"] = s[o].a_attr["class"] + " " + i[r[a]].a_attr["class"]));
            }
          }
        ...
        if (!1 === o) return !1;
        if (E.vakata.is_array(o)) for (r = 0, s = o.length; r < s; r++) {
          o[r].type = o[r].id && a[o[r].id] && a[o[r].id].type ? a[o[r].id].type : "default", t && t.no_id && (delete o[r].id, o[r].li_attr && o[r].li_attr.id && delete o[r].li_attr.id, o[r].a_attr && o[r].a_attr.id && delete o[r].a_attr.id);
        ...
        var a,
            ...
            d,
            c,
            a = (a = t && t.id ? s && s.origin ? s.origin : E.jstree.reference(t.id) : null) && a._model && a._model.data ? a._model.data : null;
        ...
        if ((c = this.get_node(e, !0)) && c.length && (l = c.children(".jstree-anchor")), n = e.type, o = this.get_icon(e), e.type = t, !0 !== o && r[n] && (r[n].icon === P || o !== r[n].icon) || this.set_icon(e, r[t].icon === P || r[t].icon), r[n] && r[n].li_attr !== P && "object" == _typeof(r[n].li_attr)) for (d in r[n].li_attr) {
          r[n].li_attr.hasOwnProperty(d) && "id" !== d && ("class" === d ? (i[e.id].li_attr["class"] = (i[e.id].li_attr["class"] || "").replace(r[n].li_attr[d], ""), c && c.removeClass(r[n].li_attr[d])) : i[e.id].li_attr[d] === r[n].li_attr[d] && (i[e.id].li_attr[d] = null, c && c.removeAttr(d)));
        }
        if (r[n] && r[n].a_attr !== P && "object" == _typeof(r[n].a_attr)) for (d in r[n].a_attr) {
          r[n].a_attr.hasOwnProperty(d) && "id" !== d && ("class" === d ? (i[e.id].a_attr["class"] = (i[e.id].a_attr["class"] || "").replace(r[n].a_attr[d], ""), l && l.removeClass(r[n].a_attr[d])) : i[e.id].a_attr[d] === r[n].a_attr[d] && ("href" === d ? (i[e.id].a_attr[d] = "#", l && l.attr("href", "#")) : (delete i[e.id].a_attr[d], l && l.removeAttr(d))));
        }
        if (r[t].li_attr !== P && "object" == _typeof(r[t].li_attr)) for (d in r[t].li_attr) {
          r[t].li_attr.hasOwnProperty(d) && "id" !== d && (i[e.id].li_attr[d] === P ? (i[e.id].li_attr[d] = r[t].li_attr[d], c && ("class" === d ? c.addClass(r[t].li_attr[d]) : c.attr(d, r[t].li_attr[d]))) : "class" === d && (i[e.id].li_attr["class"] = r[t].li_attr[d] + " " + i[e.id].li_attr["class"], c && c.addClass(r[t].li_attr[d])));
        }
        if (r[t].a_attr !== P && "object" == _typeof(r[t].a_attr)) for (d in r[t].a_attr) {
          r[t].a_attr.hasOwnProperty(d) && "id" !== d && (i[e.id].a_attr[d] === P ? (i[e.id].a_attr[d] = r[t].a_attr[d], l && ("class" === d ? l.addClass(r[t].a_attr[d]) : l.attr(d, r[t].a_attr[d]))) : "href" === d && "#" === i[e.id].a_attr[d] ? (i[e.id].a_attr.href = r[t].a_attr.href, l && l.attr("href", r[t].a_attr.href)) : "class" === d && (i[e.id].a_attr["class"] = r[t].a_attr["class"] + " " + i[e.id].a_attr["class"], l && l.addClass(r[t].a_attr[d])));
        }
        return !0;
      };
      ...
      case_sensitive: !1,
      trim_whitespace: !1,
      duplicate: function duplicate(e, t) {
        return e + " (" + t + ")";
      }
      ...
      this.check = function (e, t, i, r, s) {
        ...
        for (var a = "rename_node" === e ? r : t.text, n = [], o = this.settings.unique.case_sensitive, d = this.settings.unique.trim_whitespace, c = this._model.data, l, h, _, l = 0, h = i.children.length; l < h; l++) {
          _ = c[i.children[l]].text, o || (_ = _.toLowerCase()), d && (_ = _.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "")), n.push(_);
        }
        ...
        if (!t || t.text === P) {
          ...
          for (var a, n, o, d, c, l = this._model.data, h = this.settings.unique.case_sensitive, _ = this.settings.unique.trim_whitespace, g = this.settings.unique.duplicate, u, n = a = this.get_string("New node"), o = [], d = 0, c = e.children.length; d < c; d++) {
            u = l[e.children[d]].text, h || (u = u.toLowerCase()), _ && (u = u.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "")), o.push(u);
          }

          d = 1, u = n, h || (u = u.toLowerCase()), _ && (u = u.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, ""));

          while (-1 !== E.inArray(u, o)) {
            u = n = g.call(this, a, ++d).toString(), h || (u = u.toLowerCase()), _ && (u = u.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, ""));
          }
    ...
    if (j.setAttribute("unselectable", "on"), j.setAttribute("role", "presentation"), j.className = "jstree-wholerow", j.innerHTML = "&#160;", E.jstree.plugins.wholerow = function (e, a) {
      this.bind = function () {
        a.bind.call(this), this.element.on("ready.jstree set_state.jstree", function () {
          ...
          for (var i = !1, r, s, r = 0, s = t.selected.length; r < s; r++) {
            (i = this.get_node(t.selected[r], !0)) && i.length && i.children(".jstree-wholerow").addClass("jstree-wholerow-clicked");
          }
      ...
      var k = Object.create(HTMLElement.prototype);

      k.createdCallback = function () {
        var e = {
          core: {},
          plugins: []
        },
        ...
        for (t in E.jstree.plugins) {
          E.jstree.plugins.hasOwnProperty(t) && this.attributes[t] && (e.plugins.push(t), this.getAttribute(t) && JSON.parse(this.getAttribute(t)) && (e[t] = JSON.parse(this.getAttribute(t))));
        }

        for (t in E.jstree.defaults.core) {
          E.jstree.defaults.core.hasOwnProperty(t) && this.attributes[t] && (e.core[t] = JSON.parse(this.getAttribute(t)) || this.getAttribute(t));
        }
