...
!function (t, e) {
  "function" == typeof define && define.amd ? define(["tether"], e) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = e(require("tether")) : t.Shepherd = e(t.Tether);
}(void 0, function (t) {
  "use strict";
  ...
  function c(t, e) {
    var n = void 0;
    return i(t.matches) ? i(t.matchesSelector) ? i(t.msMatchesSelector) ? i(t.webkitMatchesSelector) ? i(t.mozMatchesSelector) ? i(t.oMatchesSelector) || (n = t.oMatchesSelector) : n = t.mozMatchesSelector : n = t.webkitMatchesSelector : n = t.msMatchesSelector : n = t.matchesSelector : n = t.matches, n.call(t, e);
  }

  function l(t) {
    if (s(t)) return t.hasOwnProperty("element") && t.hasOwnProperty("on") ? t : null;
    var e = S.exec(t);
    if (!e) return null;
    var n = e[2];
  ...
  var u = function () {
    ...
    return n(p, s), u(p, [{
      ...
      value: function value() {
        ...
        this.options = t, this.destroy(), this.id = this.options.id || this.id || "step-" + b();
      ...
      value: function value() {
        var t = l(this.options.attachTo) || {},
            e = m({}, t);
        return "string" == typeof t.element && (e.element = document.querySelector(t.element), e.element || console.error("The element for this Shepherd step was not found " + t.element)), e;
      }
    }, {
      key: "setupTether",
      value: function value() {
        if (i(t)) throw new Error("Using the attachment feature of Shepherd requires the Tether library");
        var e = this.getAttachTo(),
            n = k[e.on] || k.right;
        i(e.element) && (e.element = "viewport", n = "middle center");
        var r = {
        ...
        this.tether && this.tether.destroy(), this.tether = new t(m(r, this.options.tetherOptions));
      }
    }, {
      key: "show",
      value: function value() {
      ...
      value: function value() {
        var t = this;
        this.trigger("before-show"), this.el || this.render(), v(this.el, "shepherd-open"), document.body.setAttribute("data-shepherd-step", this.id), this.setupTether(), this.options.scrollTo && setTimeout(function () {
          t.scrollTo();
        }), this.trigger("show");
      }
    }, {
      ...
      value: function value() {
        var t = this;
        i(this.el) || this.destroy(), this.el = h("<div class='shepherd-step " + (this.options.classes || "") + "' data-id='" + this.id + "' " + (this.options.idAttribute ? 'id="' + this.options.idAttribute + '"' : "") + "></div>");
        var e = document.createElement("div");
        e.className = "shepherd-content", this.el.appendChild(e);
        var n = document.createElement("header");

        if (e.appendChild(n), this.options.title && (n.innerHTML += "<h3 class='shepherd-title'>" + this.options.title + "</h3>", this.el.className += " shepherd-has-title"), this.options.showCancelLink) {
          var r = h("<a href class='shepherd-cancel-link'>✕</a>");
          n.appendChild(r), this.el.className += " shepherd-has-cancel-link", this.bindCancelLink(r);
        }

        i(this.options.text) || !function () {
          var n = h("<div class='shepherd-text'></div>"),
              i = t.options.text;
          "function" == typeof i && (i = i.call(t, n)), i instanceof HTMLElement ? n.appendChild(i) : ("string" == typeof i && (i = [i]), i.map(function (t) {
            n.innerHTML += "<p>" + t + "</p>";
          })), e.appendChild(n);
          ...
          t.options.buttons.map(function (e) {
            ...
            i.appendChild(n), t.bindButtonEvents(e, n.querySelector("a"));
      ...
      value: function value(t, e) {
        var n = this;
        t.events = t.events || {}, i(t.action) || (t.events.click = t.action);
    ...
    function r() {
      ...
      e(this, r), d(Object.getPrototypeOf(r.prototype), "constructor", this).call(this, n), this.bindMethods(), this.options = n, this.steps = this.options.steps || [];
    ...
    return n(r, t), u(r, [{
      ...
      value: function value(t) {
        for (var e = this.getCurrentStep(), n = 0; n < this.steps.length; ++n) {
          ...
          if (i.id === t) {
            i.isOpen() && i.hide(), i.destroy(), this.steps.splice(n, 1);
            break;
          }
        }
      ...
      value: function value() {
        ...
        t === this.steps.length - 1 ? (this.hide(t), this.trigger("complete"), this.done()) : this.show(t + 1, !0);
      }
    }, {
      key: "back",
      value: function value() {
      ...
      key: "done",
      value: function value() {
        w.activeTour = null, g(document.body, "shepherd-active"), this.trigger("inactive", {
          tour: this
        });
      }
    }, {
      ...
      value: function value() {
        ...
        this.currentStep ? this.currentStep.hide() : (v(document.body, "shepherd-active"), this.trigger("active", {
          tour: this
        })), w.activeTour = this;
        var n = void 0;
        if (n = "string" == typeof t ? this.getById(t) : this.steps[t]) if (i(n.options.showOn) || n.options.showOn()) this.trigger("show", {
          step: n,
          previous: this.currentStep
        }), this.currentStep && this.currentStep.hide(), this.currentStep = n, n.show();else {
