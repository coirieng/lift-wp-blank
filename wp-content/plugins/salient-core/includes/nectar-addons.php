  ...
  vc_add_param("vc_row_inner", array(
    ...
    "value" => array(
      "Default" => "default",
		...
		"description" => esc_html__('Determine whether to load the image on page load or to use a lazy load method for higher performance. Note: This will disable the "Masonry Style" option.', "salient-core"),
    'std' => 'default',
  ));
