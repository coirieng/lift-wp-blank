...
jQuery(document).ready(function ($) {
  ...
  */
  ...
  $('body').on('click', '.tabbed > ul li:not(.cta-button) a', function (e) {
    ...
    if (!$(this).hasClass('active-tab') && !$(this).hasClass('loading')) {
      ...
      $(this).parents('.tabbed').find('> div:not(.clear)' + $frontEndEditorTabDiv).css({
        'visibility': 'hidden',
        'position': 'absolute',
        'opacity': '0',
        'left': '-9999px',
      ...
      if ($('body.vc_editor').length > 0) {
        ...
        $(this).parents('.tabbed').find('> div[data-model-id="' + $data_m_id + '"]' + $frontEndEditorTabDiv).css({
          'visibility': 'visible',
          'position': 'relative',
          'left': '0',
          'display': 'block'
          ...
          'opacity': 1
        }, 400).addClass('visible-tab'); //update padding
      } else {
  ...
  */
  ...
  $('body').on('click', '.toggle h3 a', function () {
    if (!$(this).parents('.toggles').hasClass('accordion')) {
      ...
      $(this).parents('.toggle').toggleClass('open'); //switch icon
  ...
  $('body').on('click', '.accordion .toggle h3 a', function () {
    ...
    $(this).parents('.toggle').addClass('open'); //switch icon
  ...
  */
  ...
  twentytwentyInit(); // Team Member Fullscreen.
  ...
  function teamMemberFullscreen() {
    ...
    $body.on('click', '.team-member[data-style="bio_fullscreen"]', function () {
      ...
      teamFullscreenResize(); // Transition in

      $('.nectar_team_member_overlay').addClass('open').addClass('animating');
      setTimeout(function () {
        $('.nectar_team_member_close').addClass('visible');
        $('.nectar_team_member_overlay').removeClass('animating');
      }, 500); // Bind close mousemove
