 ...
 */
function deactivate_bn_wp() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-bn-wp-deactivator.php';
	LIFT_WP_Deactivator::deactivate();
}

register_activation_hook( __FILE__, 'activate_bn_wp' );
register_deactivation_hook( __FILE__, 'deactivate_bn_wp' );
