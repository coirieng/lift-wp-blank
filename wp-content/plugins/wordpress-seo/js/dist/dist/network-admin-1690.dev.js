    ...
    !function (e) {
      function t(t) {
        var n,
            r,
            a = e(".wrap > h1");
        t.length && (n = t.map(function (e) {
          return "<div class='" + e.type + " notice'><p>" + e.message + "</p></div>";
        }), a.after(n.join("")), r = wpseoNetworkAdminGlobalL10n.error_prefix, "updated" === t[0].type && (r = wpseoNetworkAdminGlobalL10n.success_prefix), o()(r.replace("%s", t[0].message), "assertive"));
      }

      function n(n) {
        var r = e(this),
            o = r.find("[type='submit']:focus"),
            a = r.serialize();
        return n.preventDefault(), e(".wrap > .notice").remove(), o.length || (o = e(".wpseotab.active [type='submit']")), "action" === o.attr("name") && (a = a.replace(/action=([a-zA-Z0-9_]+)/, "action=" + o.val())), e.ajax({
          type: "POST",
          url: ajaxurl,
          data: a
        }).done(function (e) {
