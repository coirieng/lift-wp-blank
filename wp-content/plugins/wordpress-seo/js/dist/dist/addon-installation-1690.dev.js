...
!function (e) {
  ...
  357: function _(e, t, n) {
    ...
    var o,
      ...
      Object(p.__)("%s SEO installation", "wordpress-seo"), "Yoast"),
          u = Object(p.__)("the following addons", "wordpress-seo");
      return 1 === e.addons.length && (u = e.addons[0]), 1 !== e.addons.length && (c = Object(r.createElement)("ul", {
        className: "ul-disc"
      }, e.addons.map(function (e, t) {
        return Object(r.createElement)("li", {
          key: "addon-" + t
        }, e);
      }))), o ? Object(r.createElement)(m.a, {
        title: l,
        onRequestClose: s,
        icon: Object(r.createElement)(y.a, null),
        isDismissible: !1
      }, Object(r.createElement)("p", null, Object(p.sprintf)(
      /* translators: %s expands to Yoast SEO Premium */
      Object(p.__)("Please confirm below that you would like to install %s on this site.", "wordpress-seo"), u)), c, Object(r.createElement)(w, null, Object(r.createElement)(d.Button, {
        onClick: s,
        id: "close-addon-installation-dialog"
      }, Object(p.__)("Cancel", "wordpress-seo")), Object(r.createElement)(d.Button, {
        onClick: function onClick() {
          window.location.href = "admin.php?page=wpseo_licenses&action=install&nonce=" + e.nonce;
        },
        id: "continue-addon-installation-dialog",
        className: "yoast-button--primary"
      }, Object(p.__)("Install and activate", "wordpress-seo")))) : null;
    };

    O.propTypes = {
      nonce: u.a.string.isRequired,
      addons: u.a.array
    }, O.defaultProps = {
      addons: []
    };
    ...
    v.setAttribute("id", "wpseo-app-element"), document.getElementById("extensions").append(v), Object(r.render)(Object(r.createElement)(j, {
      nonce: wpseoAddonInstallationL10n.nonce,
      addons: wpseoAddonInstallationL10n.addons
    }), v);
  },
  39: function _(e, t, n) {
    var o = n(99),
  ...
  53: function _(e, t, n) {
    ...
    var o = n(27),
      ...
      var t = e.title,
          ...
          l = o ? Object(s.createElement)("span", {
        className: "yoast-icon"
      }) : null;
      return Object(s.createElement)(u.Modal, r()({
        title: t,
