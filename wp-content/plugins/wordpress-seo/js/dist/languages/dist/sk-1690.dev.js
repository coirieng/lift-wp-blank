...
window.yoast = window.yoast || {}, window.yoast.Researcher = function (n) {
  var e = {};
  ...
  return o.m = n, o.c = e, o.d = function (n, e, t) {
    ...
    if (o.r(t), Object.defineProperty(t, "default", {
      enumerable: !0,
      value: n
    }), 2 & e && "string" != typeof n) for (var a in n) {
      o.d(t, a, function (e) {
        return n[e];
      }.bind(null, a));
    }
  ...
  0: function _(n, e) {
    n.exports = window.yoast.analysis;
  },
  1: function _(n, e) {
    function o(e) {
      return n.exports = o = Object.setPrototypeOf ? Object.getPrototypeOf : function (n) {
        return n.__proto__ || Object.getPrototypeOf(n);
      }, n.exports["default"] = n.exports, n.exports.__esModule = !0, o(e);
    }

    n.exports = o, n.exports["default"] = n.exports, n.exports.__esModule = !0;
  },
  2: function _(n, e) {
    n.exports = window.lodash;
  },
  3: function _(n, e) {
  ...
  42: function _(n, e, o) {
    ...
    var x = function (n) {
      ...
      function r(n, e) {
        var o;
        return a()(this, r), (o = t.call(this, n, e))._participles = function (n) {
          var e = j(n),
              o = new RegExp("(ný|ní|tý|ná|tá|né|té)$");
          return e.filter(function (n) {
            return o.test(n);
          });
        }(o.getClauseText()), o.checkParticiples(), o;
      }

      return b()(r, [{
        key: "checkParticiples",
        value: function value() {
          var n = this.getParticiples().filter(function (n) {
            return !y.includes(n);
          });
          this.setPassive(n.length > 0);
        }
      }]), r;
    }(v.languageProcessing.values.Clause),
        g = v.languageProcessing.getClausesSplitOnStopWords,
        S = v.languageProcessing.createRegexFromArray,
        _ = {
      Clause: x,
      regexes: {
        auxiliaryRegex: S(["byť", "som", "si", "je", "sme", "ste", "sú", "bol", "bola", "boli", "bolo", "budem", "budeš", "bude", "budeme", "budete", "budú"]),
        stopCharacterRegex: /([:,])(?=[ \n\r\t'"+\-»«‹›<>])/gi,
        stopwordRegex: S(p)
      }
    };
    ...
    function O(_n, e) {
      ...
      if ("undefined" == typeof Symbol || null == _n[Symbol.iterator]) {
        if (Array.isArray(_n) || (o = function (n, e) {
          if (n) {
            if ("string" == typeof n) return P(n, void 0);
            var o = Object.prototype.toString.call(n).slice(8, -1);
            return "Object" === o && n.constructor && (o = n.constructor.name), "Map" === o || "Set" === o ? Array.from(n) : "Arguments" === o || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(o) ? P(n, void 0) : void 0;
          }
        }(_n)) || e && _n && "number" == typeof _n.length) {
          o && (_n = o);
    ...
    function W(n, e) {
      var o = e.externalStemmer.palatalEndingsRegexes.find(function (e) {
        return new RegExp(e[0]).test(n);
      });
      return o ? n.replace(new RegExp(o[0]), o[1]) : n.slice(0, -1);
    }

    var M = v.languageProcessing.baseStemmer;

    function E(n) {
      var e = Object(R.get)(n.getData("morphology"), "sk", !1);
      return e ? function (n) {
        return function (n, e) {
          var o = function (n, e) {
            var o,
            ...
            return null;
          }(n, e.exceptionLists.exceptionStemsWithFullForms);
          ...
          return o || function (n, e) {
            ...
            var o = e.externalStemmer.derivationalSuffixes;
            if (n.length > 8 && n.endsWith(o.derivationalSuffix1)) return n.slice(0, -6);

            if (n.length > 7) {
              if (n.endsWith(o.derivationalSuffix2)) return W(n.slice(0, -4), e);
              if (o.derivationalSuffixes3.includes(n.slice(-5))) return n.slice(0, -5);
            }

            if (n.length > 6) {
              if (o.derivationalSuffixes4.includes(n.slice(-4))) return n.slice(0, -4);
              if (o.derivationalSuffixes5.includes(n.slice(-4))) return W(n.slice(0, -3), e);
            }

            if (n.length > 5) {
              if (n.endsWith(o.derivationalSuffix6)) return n.slice(0, -3);
              if (o.derivationalSuffixes7.includes(n.slice(-3))) return W(n.slice(0, -2), e);
              if (o.derivationalSuffixes8.includes(n.slice(-3))) return n.slice(0, -3);
            }

            if (n.length > 4) {
              if (o.derivationalSuffixes9.includes(n.slice(-2))) return n.slice(0, -2);
              if (o.derivationalSuffixes10.includes(n.slice(-2))) return W(n.slice(0, -1), e);
            }

            var t = new RegExp(e.externalStemmer.derivationalRegex);
            return n.length > 3 && t.test(n) ? n.slice(0, -1) : n;
          }(n = function (n, e) {
            var o = e.externalStemmer.augmentativeSuffixes;
            return n.length > 6 && n.endsWith(o.augmentativeSuffix1) ? n.slice(0, -4) : n.length > 5 && o.augmentativeSuffixes2.includes(n.slice(-3)) ? W(n.slice(0, -2), e) : n;
          }(n = function (n, e) {
            var o = e.externalStemmer.diminutiveSuffixes;
            if (n.length > 7 && n.endsWith(o.diminutiveSuffix1)) return n.slice(0, -5);

            if (n.length > 6) {
              if (o.diminutiveSuffixes2.includes(n.slice(-4))) return W(n.slice(0, -3), e);
              if (o.diminutiveSuffixes3.includes(n.slice(-4))) return W(n.slice(0, -4), e);
            }

            if (n.length > 5) {
              if (o.diminutiveSuffixes4.includes(n.slice(-3))) return W(n.slice(0, -3), e);
              if (o.diminutiveSuffixes5.includes(n.slice(-3))) return n.slice(0, -3);
            }

            if (n.length > 4) {
              if (o.diminutiveSuffixes6.includes(n.slice(-2))) return W(n.slice(0, -1), e);
              if (o.diminutiveSuffixes7.includes(n.slice(-2))) return n.slice(0, -1);
            }

            return n.length > 3 && n.endsWith("k") && !n.endsWith("isk") ? n.slice(0, -1) : n;
          }(n = function (n, e) {
            var o = e.externalStemmer.superlativePrefix;
            return n.length > 6 && n.startsWith(o) && (n = n.slice(3, n.length)), n.length > 5 && e.externalStemmer.comparativeSuffixes.includes(n.slice(-3)) && (n = W(n.slice(0, -2), e)), n;
          }(n = function (n, e) {
            var o = e.externalStemmer.possessiveSuffixes;

            if (n.length > 5) {
              if (n.endsWith(o.posSuffixOv)) return n.slice(0, -2);
              if (n.endsWith(o.posSuffixIn)) return W(n.slice(0, -1), e);
            }

            return n;
          }(n = function (n, e) {
            var o = e.externalStemmer.caseSuffixes,
                t = e.externalStemmer.caseRegexes;
            if (n.length > 7 && n.endsWith(o.caseSuffix1)) return n.slice(0, -5);
            if (n.length > 6 && n.endsWith(o.caseSuffix2)) return W(n.slice(0, -3), e);

            if (n.length > 5) {
              if (o.caseSuffixes3.includes(n.slice(-3))) return W(n.slice(0, -2), e);
              if (o.caseSuffixes4.includes(n.slice(-3))) return n.slice(0, -3);
            }

            if (n.length > 4) {
              if (n.endsWith(o.caseSuffix5)) return W(n.slice(0, -1), e);
              if (o.caseSuffixes6.includes(n.slice(-2))) return W(n.slice(0, -2), e);
              if (o.caseSuffixes7.includes(n.slice(-2))) return n.slice(0, -2);
            }

            if (n.length > 3) {
              if (new RegExp(t.caseRegex1).test(n)) return W(n, e);
              if (new RegExp(t.caseRegex2).test(n)) return n.slice(0, -1);
            }

            return n;
          }(n, e), e), e), e), e), e), e.exceptionLists.stemsThatBelongToOneWord) || n;
        }(n, e);
      } : M;
    }
    ...
    var T = function (n) {
      ...
      function r(n) {
        var e;
        return a()(this, r), delete (e = t.call(this, n)).defaultResearches.getFleschReadingScore, Object.assign(e.config, {
          language: "sk",
      ...
      return r;
    }(v.languageProcessing.AbstractResearcher);
  },
  5: function _(n, e, o) {
    var t = o(6)["default"],
        a = o(9);
    n.exports = function (n, e) {
      return !e || "object" !== t(e) && "function" != typeof e ? a(n) : e;
    }, n.exports["default"] = n.exports, n.exports.__esModule = !0;
  },
  6: function _(n, e) {
    function o(e) {
      return "function" == typeof Symbol && "symbol" == _typeof(Symbol.iterator) ? (n.exports = o = function o(n) {
        return _typeof(n);
      }, n.exports["default"] = n.exports, n.exports.__esModule = !0) : (n.exports = o = function o(n) {
  ...
  8: function _(n, e) {
    function o(e, t) {
      return n.exports = o = Object.setPrototypeOf || function (n, e) {
