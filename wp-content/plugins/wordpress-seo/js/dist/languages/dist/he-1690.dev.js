...
window.yoast = window.yoast || {}, window.yoast.Researcher = function (e) {
  ...
  var n = r(3),
      ...
      d = [["או", "או"], ["אין", "אלא"], ["לא", "אלא"], ["מצד אחד", "מצד אחר"], ["מחד גיסא", "מאידך גיסא"], ["ראשית", "שנית"], ["תחילה", "לבסוף"], ["משום ש", "מפני ש"], ["לכאורה", "אך"]],
      y = ["אחד", "כמה", "מעטים", "אחת", "שנים", "שתים", "שלשה", "שלש", "ארבעה", "ארבע", "חמשה", "חמש", "ששה", "שש", "שבעה", "שבע", "שמונה", "שמונה", "תשעה", "תשע", "עשרה", "עשר", "זה", "זאת", "אלה", "אוה", "היא", "אלה", "המה", "הם", "הנה"],
      v = {
  ...
  function g(e) {
    var t = ["ב", "ה", "ו", "כ", "ל", "מ", "ש"],
        r = [];
    r.push.apply(r, m()(t.map(function (t) {
      return t + e;
    })));
    var n = "";
    return t.some(function (t) {
      return e.startsWith(t);
    }) && (n = e.slice(1)), n.length > 0 && (r.push(n), r.push.apply(r, m()(t.map(function (e) {
      return e + n;
    })))), r;
  }
  ...
  var h = r(2),
    ...
    return t.some(function (t) {
      ...
      w = p.languageProcessing.baseStemmer;

  function S(e) {
    var t = Object(h.get)(e.getData("morphology"), "he", !1);
    return t ? function (e) {
      return function (e, t) {
        var r = t.dictionary,
            n = r[e];
        ...
        var o = _(e, t.prefixes);

        if (o !== e) {
          if (n = r[o]) return n;

          var u = _(o, t.prefixes);

          if (u !== o && (n = r[u])) return n;
        }
  ...
  var T = p.languageProcessing.getWords,
      W = function W(e, t, r) {
    return t.some(function (t) {
      return r.some(function (r) {
        return new RegExp("^" + r.prefix + t + r.suffix + "$").test(e);
      });
    });
  };
      ...
      if ("undefined" == typeof Symbol || null == e[Symbol.iterator]) {
        if (Array.isArray(e) || (r = function (e, t) {
          if (e) {
            ...
            var r = Object.prototype.toString.call(e).slice(8, -1);
            return "Object" === r && e.constructor && (r = e.constructor.name), "Map" === r || "Set" === r ? Array.from(e) : "Arguments" === r || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r) ? R(e, void 0) : void 0;
          }
    ...
    try {
      var n = function n() {
        ...
        return A.some(function (t) {
          return r.some(function (r) {
            return new RegExp("^" + r.prefix + t[0] + "ו" + t[1] + t[2] + r.suffix + "$").test(e);
          });
        }) || W(e, j, [{
  ...
  var I = function (e) {
    ...
    function u(e) {
      var t;
      return o()(this, u), delete (t = n.call(this, e)).defaultResearches.getFleschReadingScore, Object.assign(t.config, {
        language: "he",
        passiveConstructionType: "morphological",
        firstWordExceptions: y,
        functionWords: l,
        transitionWords: x,
        twoPartTransitionWords: d,
        sentenceLength: v
      }), Object.assign(t.helpers, {
        createBasicWordForms: g,
        getStemmer: S,
        isPassiveSentence: E
      }), t;
    }
