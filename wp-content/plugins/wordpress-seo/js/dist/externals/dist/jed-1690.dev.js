...
window.yoast = window.yoast || {}, window.yoast.jed = function (t) {
  var e = {};
    ...
    !function (r, n) {
      var i = Array.prototype,
        ...
        forEach: function forEach(t, e, r) {
          var n, i, s;
          if (null !== t) if (a && t.forEach === a) t.forEach(e, r);else if (t.length === +t.length) {
            for (n = 0, i = t.length; n < i; n++) {
              if (n in t && e.call(r, t[n], n, t) === h) return;
            }
          } else for (s in t) {
            if (l.call(t, s) && e.call(r, t[s], s, t) === h) return;
          }
        },
        extend: function extend(t) {
          return this.forEach(o.call(arguments, 1), function (e) {
            for (var r in e) {
              t[r] = e[r];
            }
          }), t;
      ...
      u.context_delimiter = String.fromCharCode(4), c.extend(f.prototype, {
        onDomain: function onDomain(t) {
          return this._domain = t, this;
        },
        withContext: function withContext(t) {
          return this._context = t, this;
        },
        ifPlural: function ifPlural(t, e) {
          return this._val = t, this._pkey = e, this;
        },
        fetch: function fetch(t) {
          return "[object Array]" != {}.toString.call(t) && (t = [].slice.call(arguments, 0)), (t && t.length ? u.sprintf : function (t) {
            return t;
        ...
        textdomain: function textdomain(t) {
        ...
        dgettext: function dgettext(t, e) {
          return this.dcnpgettext.call(this, t, void 0, e);
        },
        dcgettext: function dcgettext(t, e) {
          return this.dcnpgettext.call(this, t, void 0, e);
        },
        ngettext: function ngettext(t, e, r) {
          return this.dcnpgettext.call(this, void 0, void 0, t, e, r);
        },
        dngettext: function dngettext(t, e, r, n) {
          return this.dcnpgettext.call(this, t, void 0, e, r, n);
        },
        dcngettext: function dcngettext(t, e, r, n) {
          return this.dcnpgettext.call(this, t, void 0, e, r, n);
        },
        pgettext: function pgettext(t, e) {
          return this.dcnpgettext.call(this, void 0, t, e);
        },
        dpgettext: function dpgettext(t, e, r) {
          return this.dcnpgettext.call(this, t, e, r);
        },
        dcpgettext: function dcpgettext(t, e, r) {
          return this.dcnpgettext.call(this, t, e, r);
        },
        npgettext: function npgettext(t, e, r, n) {
          return this.dcnpgettext.call(this, void 0, t, e, r, n);
        },
        dnpgettext: function dnpgettext(t, e, r, n, i) {
          return this.dcnpgettext.call(this, t, e, r, n, i);
        },
        dcnpgettext: function dcnpgettext(t, e, r, n, i) {
          var s;
          if (n = n || r, t = t || this._textdomain, !this.options) return (s = new u()).dcnpgettext.call(s, void 0, void 0, r, n, i);
          ...
          var o,
              l,
              a,
              h = e ? e + u.context_delimiter + r : r,
              c = this.options.locale_data,
              f = c[t],
              d = (c.messages || this.defaults.locale_data.messages)[""],
              y = f[""].plural_forms || f[""]["Plural-Forms"] || f[""]["plural-forms"] || d.plural_forms || d["Plural-Forms"] || d["plural-forms"];
          if (void 0 === i) a = 0;else {
            if ("number" != typeof i && (i = parseInt(i, 10), isNaN(i))) throw new Error("The number that was passed in is not a number.");
            a = p(y)(i);
          }
          if (!f) throw new Error("No domain named `" + t + "` could be found.");
          return !(o = f[h]) || a > o.length ? (this.options.missing_key_callback && this.options.missing_key_callback(h, t), l = [r, n], !0 === this.options.debug && console.log(l[p(y)(i)]), l[p()(i)]) : (l = o[a]) || (l = [r, n])[p()(i)];
        }
      });
      ...
      var d,
        ...
        return r.format = function (r, n) {
          ...
          for (s = 0; s < p; s++) {
            if ("string" === (f = t(r[s]))) d.push(r[s]);else if ("array" === f) {
              if ((l = r[s])[2]) for (i = n[u], o = 0; o < l[2].length; o++) {
                if (!i.hasOwnProperty(l[2][o])) throw y('[sprintf] property "%s" does not exist', l[2][o]);
                i = i[l[2][o]];
              } else i = l[1] ? n[l[1]] : n[u++];
              if (/[^s]/.test(l[8]) && "number" != t(i)) throw y("[sprintf] expecting number but found %s", t(i));
              ...
              i = /[def]/.test(l[8]) && l[3] && i >= 0 ? "+" + i : i, h = l[4] ? "0" == l[4] ? "0" : l[4].charAt(1) : " ", c = l[6] - String(i).length, a = l[6] ? e(h, c) : "", d.push(l[5] ? i + a : a + i);
            }
          }
            ...
            if (null !== (r = /^[^\x25]+/.exec(e))) n.push(r[0]);else if (null !== (r = /^\x25{2}/.exec(e))) n.push("%");else {
              ...
              if (r[2]) {
                ...
                for (s.push(l[1]); "" !== (o = o.substring(l[0].length));) {
                  if (null !== (l = /^\.([a-z_][a-z_\d]*)/i.exec(o))) s.push(l[1]);else {
      ...
      u.parse_plural = function (t, e) {
        ...
        var e = u.PF.parse(t);
        return function (t) {
          return !0 === (r = u.PF.interpreter(e)(t)) ? 1 : r || 0;
          var r;
        };
        ...
        return function (e) {
          switch (t.type) {
            ...
            case "TERNARY":
              return u.PF.interpreter(t.expr)(e) ? u.PF.interpreter(t.truthy)(e) : u.PF.interpreter(t.falsey)(e);

            case "OR":
              return u.PF.interpreter(t.left)(e) || u.PF.interpreter(t.right)(e);
        ...
        performAction: function performAction(t, e, r, n, i, s, o) {
          var l = s.length - 1;
        ...
        parse: function parse(t) {
          ...
          for (var p, f, d, y, g, x, m, _, b, v = {};;) {
            if (d = r[r.length - 1], this.defaultActions[d] ? y = this.defaultActions[d] : (null == p && (p = u()), y = s[d] && s[d][p]), void 0 === y || !y.length || !y[0]) {
              if (!h) {
                for (x in b = [], s[d]) {
                ...
                var w = "";
                w = this.lexer.showPosition ? "Parse error on line " + (l + 1) + ":\n" + this.lexer.showPosition() + "\nExpecting " + b.join(", ") + ", got '" + this.terminals_[p] + "'" : "Parse error on line " + (l + 1) + ": Unexpected " + (1 == p ? "end of input" : "'" + (this.terminals_[p] || p) + "'"), this.parseError(w, {
              ...
              if (3 == h) {
                ...
                a = this.lexer.yyleng, o = this.lexer.yytext, l = this.lexer.yylineno, c = this.lexer.yylloc, p = u();
              }
              ...
              f = p, p = 2, y = s[d = r[r.length - 1]] && s[d][2], h = 3;
            }
            ...
            switch (y[0]) {
              case 1:
                r.push(p), n.push(this.lexer.yytext), i.push(this.lexer.yylloc), r.push(y[1]), p = null, f ? (p = f, f = null) : (a = this.lexer.yyleng, o = this.lexer.yytext, l = this.lexer.yylineno, c = this.lexer.yylloc, h > 0 && h--);
                break;

              case 2:
                if (m = this.productions_[y[1]][1], v.$ = n[n.length - m], v._$ = {
                  first_line: i[i.length - (m || 1)].first_line,
                  last_line: i[i.length - 1].last_line,
                  first_column: i[i.length - (m || 1)].first_column,
                  last_column: i[i.length - 1].last_column
                }, void 0 !== (g = this.performAction.call(v, o, a, l, this.yy, y[1], n, i))) return g;
                m && (r = r.slice(0, -1 * m * 2), n = n.slice(0, -1 * m), i = i.slice(0, -1 * m)), r.push(this.productions_[y[1]][0]), n.push(v.$), i.push(v._$), _ = s[r[r.length - 2]][r[r.length - 1]], r.push(_);
                break;
        ...
        performAction: function performAction(t, e, r, n) {
          switch (r) {
            case 0:
              break;
      ...
      }, d), t.exports && (e = t.exports = u), e.Jed = u;
    }();
  }
});