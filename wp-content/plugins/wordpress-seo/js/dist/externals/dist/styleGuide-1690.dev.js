...
window.yoast = window.yoast || {}, window.yoast.styleGuide = function (e) {
  var t = {};
  ...
  747: function _(e, t, o) {
    "use strict";

    o.r(t), o.d(t, "colors", function () {
      return c;
    }), o.d(t, "breakpoints", function () {
      return l;
    }), o.d(t, "rgba", function () {
      return d;
    }), o.d(t, "withCaretStyles", function () {
      return $;
    }), o.d(t, "angleRight", function () {
      return f;
    }), o.d(t, "angleLeft", function () {
      return p;
    });
    ...
    var r,
        ...
        u = o(14),
        f = function f(e) {
      return "data:image/svg+xml;charset=utf8," + encodeURIComponent('<svg width="1792" height="1792" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg"><path fill="' + e + '" d="M1152 896q0 26-19 45l-448 448q-19 19-45 19t-45-19-19-45v-896q0-26 19-45t45-19 45 19l448 448q19 19 19 45z" /></svg>');
    },
        p = function p(e) {
      return "data:image/svg+xml;charset=utf8," + encodeURIComponent('<svg width="1792" height="1792" viewBox="0 0 192 512" xmlns="http://www.w3.org/2000/svg"><path fill="' + e + '" d="M192 127.338v257.324c0 17.818-21.543 26.741-34.142 14.142L29.196 270.142c-7.81-7.81-7.81-20.474 0-28.284l128.662-128.662c12.599-12.6 34.142-3.676 34.142 14.142z"/></svg>');
    };

    function d(e, t) {
      return "rgba( " + function (e) {
        if ("string" != typeof e) throw new Error("Please pass a string representation of a color in hex notation.");
        if (e.match(/^#[a-fA-F0-9]{6}$/)) return parseInt("".concat(e[1]).concat(e[2]), 16) + ", " + parseInt("".concat(e[3]).concat(e[4]), 16) + ", " + parseInt("".concat(e[5]).concat(e[6]), 16);
        if (e.match(/^#[a-fA-F0-9]{3}$/)) return parseInt("".concat(e[1]).concat(e[1]), 16) + ", " + parseInt("".concat(e[2]).concat(e[2]), 16) + ", " + parseInt(" ".concat(e[3]).concat(e[3]), 16);
        throw new Error("Couldn't parse the color string. Please provide the color as a string in hex notation.");
      }(e) + ", " + t + " )";
    }

    var $ = function $(e) {
      return i()(e)(r || (r = n()(["\n\t\t&::before {\n\t\t\tdisplay: block;\n\t\t\tposition: absolute;\n\t\t\ttop: 4px;\n\t\t\t", ": -25px;\n\t\t\twidth: 24px;\n\t\t\theight: 24px;\n\t\t\tbackground-image: url( ", ' );\n\t\t\tbackground-size: 25px;\n\t\t\tcontent: "";\n\t\t}\n\t'])), Object(u.getDirectionalStyle)("left", "right"), s);
    };

    function s(e) {
      return Object(u.getDirectionalStyle)(f(g(e)), p(g(e)))(e);
    }

    function g(e) {
      return e.isActive ? c.$color_snippet_focus : e.isHovered ? c.$color_snippet_hover : "transparent";
    }
  }
});