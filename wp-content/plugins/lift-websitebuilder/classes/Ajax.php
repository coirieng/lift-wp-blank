...
if ( ! class_exists('WOW_Ajax')){
	...
	class WOW_Ajax{
		...
		public function __construct() {
			...
			//Get Template from LIFT PageBuilder Server
		...
		public function  wow_page_save(){
			...
			$success_array = array( 'msg' => __('LIFT PageBuilder content has been updated.', 'wow-pagebuilder') );
			$error_array = array();
		...
		/**
		 * @since 1.0.0
		 * Delete css file generated by LIFT PageBuilder
		 */
