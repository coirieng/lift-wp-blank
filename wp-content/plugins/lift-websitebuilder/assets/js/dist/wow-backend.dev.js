...
jQuery(document).ready(function ($) {
  ...
  jQuery('.edit-with-wow-builder').click(function (e) {
    ...
    $.post(wow_admin_ajax.ajax_url, {
      action: 'wow_switch_editor',
      post_id: post_id,
  ...
  var wppbGutenbergCompatibility = {
    ...
    addWPPBBtn: function addWPPBBtn() {
      var isBtnExists = this.toolbarSelector.find('#wow-edit-with-btn-in-gutenberg-toolbar').length;
      var btnHtmlWrap = $('#wow-edit-with-btn-in-gutenberg-toolbar');
