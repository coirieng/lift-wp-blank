	...
	class WP_Lightweight_Core_Setup {
		...
		private function ___tabCleanUp() {
			$data = array(
				...
				Field::make(
					'checkbox', 
					'___lift_wp_lightweight_disable_comments',
					__('Disable Comments on WordPress')
					)->set_option_value( 'yes' ),
					Field::make(
						'checkbox', 
						'___lift_wp_lightweight_remove_gutenberg_editor',
						__('Disable the Gutenberg Editor')
						)->set_option_value( 'yes' ),
					Field::make(
						'checkbox', 
						'___lift_wp_lightweight_remove_admin_bar',
						__('Remove Admin bar')
						)->set_option_value( 'yes' ),
					Field::make(
						'checkbox', 
						'___lift_wp_lightweight_remove_admin_text',
						__('Remove label \'WordPress\' from the title bar')
						)->set_option_value( 'yes' ),
					Field::make(
						'checkbox', 
						'___lift_wp_lightweight_remove_wp_logo',
						__('Remove WP Logo on Admin bar')
						)->set_option_value( 'yes' ),
					Field::make(
						'checkbox', 
						'___lift_wp_lightweight_remove_help_menu',
						__('Remove Admin Help Menu')
						)->set_option_value( 'yes' ),
					Field::make(
						'checkbox', 
						'___lift_wp_lightweight_remove_goto',
						__('Remove Go to link from Login page')
						)->set_option_value( 'yes' ),
					Field::make(
						'checkbox', 
						'___lift_wp_lightweight_disable_widget_block_editor',
						__('Disable Widget Block Editor')
						)->set_option_value( 'yes' ),
					Field::make( 'separator', 'crb_separator_2', __( 'Dashboard' ) ),
					Field::make(
						'checkbox', 
						'___lift_wp_lightweight_remove_dashboard_quick_press',
						__('Remove Quick Draft on Dashboard')
						)->set_option_value( 'yes' ),
					Field::make(
						'checkbox', 
						'___lift_wp_lightweight_remove_dashboard_primary',
						__('Remove Wordpress Events and News on Dashboard')
						)->set_option_value( 'yes' ),
					Field::make(
						'checkbox', 
						'___lift_wp_lightweight_remove_yoast_db_widget',
						__('Remove Yoast SEO on Dashboard')
						)->set_option_value( 'yes' ),
					Field::make(
						'checkbox', 
						'___lift_wp_lightweight_remove_dashboard_site_health',
						__('Remove Site Health on Dashboard')
						)->set_option_value( 'yes' ),
					Field::make(
						'checkbox', 
						'___lift_wp_lightweight_remove_dashboard_activity',
						__('Remove Wordpress Activity on Dashboard')
						)->set_option_value( 'yes' ),
					Field::make(
						'checkbox', 
						'___lift_wp_lightweight_remove_dashboard_right_now',
						__('Remove At a Glance on Dashboard')
						)->set_option_value( 'yes' ),
					Field::make(
						'checkbox', 
						'___lift_wp_lightweight_remove_welcome_panel',
						__('Remove Welcome Panel on Dashboard')
						)->set_option_value( 'yes' ),
					Field::make(
						'checkbox', 
						'___lift_wp_lightweight_remove_update_nag',
						__('Remove Admin Update on Dashboard')
						)->set_option_value( 'yes' ),
					Field::make(
						'checkbox', 
						'___lift_wp_lightweight_remove_gutenberg_panel',
						__('Remove Gutenberg Panel on Dashboard')
						)->set_option_value( 'yes' ),
					Field::make(
						'checkbox', 
						'___lift_wp_lightweight_remove_incoming_links',
						__('Remove Incoming links on Dashboard')
						)->set_option_value( 'yes' ),
					Field::make(
						'checkbox', 
						'___lift_wp_lightweight_remove_plugins',
						__('Remove Plugins on Dashboard')
						)->set_option_value( 'yes' ),
					Field::make(
						'checkbox', 
						'___lift_wp_lightweight_remove_secondary',
						__('Remove the secondary on Dashboard')
						)->set_option_value( 'yes' ),
					Field::make(
						'checkbox', 
						'___lift_wp_lightweight_remove_recent_drafts',
						__('Remove Recent Drafts on Dashboard')
						)->set_option_value( 'yes' ),
					Field::make(
						'checkbox', 
						'___lift_wp_lightweight_remove_recent_comments',
						__('Remove Recent Comments on Dashboard')
						)->set_option_value( 'yes' ),
					Field::make(
						'checkbox', 
						'___lift_wp_lightweight_remove_notice',
						__('Remove Wordpress Notifications')
						)->set_option_value( 'yes' ),
					Field::make(
						'text', 
						'___lift_wp_lightweight_add_copyright',
						__('Add text into Footer')
						)->set_width(6),
					Field::make(
						'textarea', 
						'___lift_wp_lightweight_remove_dashboardbyid',
		...
		private function ___tabUpdates() {
			$data = array(
				...
				Field::make(
					'checkbox', 
					'___lift_wp_lightweight_remove_core_update',
					__('Disable Automatic Core update')
					)->set_option_value( 'yes' ),
				Field::make(
					'checkbox', 
					'___lift_wp_lightweight_remove_plugins_update',
					__('Disable Automatic Plugins update')
					)->set_option_value( 'yes' ),
				Field::make(
					'checkbox', 
					'___lift_wp_lightweight_remove_theme_update',
					__('Disable Automatic Themes update')
					)->set_option_value( 'yes' ),
				Field::make( 'separator', 'crb_separator_5', __( 'Update Email Notification' ) ),
				Field::make(
					'checkbox', 
					'___lift_wp_lightweight_remove_core_email',
					__('Disable Update Core email notification')
					)->set_option_value( 'yes' ),
				Field::make(
					'checkbox', 
					'___lift_wp_lightweight_remove_plugins_email',
					__('Disable Update Plugins email notification')
					)->set_option_value( 'yes' ),
				Field::make(
					'checkbox', 
					'___lift_wp_lightweight_remove_theme_email',
		...
		private function ___tabSecurity() {
			...
			$data = array(
				...
				Field::make(
					'checkbox', 
					'___lift_wp_lightweight_disable_password_reset',
				...
				Field::make(
					'checkbox', 
					'___lift_wp_lightweight_disable_theme_plugin_edit',
		...
		private function ___tabScript() {
			$data = array();
			$data = array(
				Field::make( 'header_scripts', '___lift_wp_lightweight_header_scripts', __( 'Header Scripts' ) ),
				// Field::make( 'separator', 'crb_separator', __( 'Separator' ) ),,
				Field::make( 'footer_scripts', '___lift_wp_lightweight_footer_scripts', __( 'Footer Scripts' ) )
			);
			return $data;
		}
		private function ___tabSeometa() {
			...
			$data = array(
				...
				Field::make( 'header_scripts', '___lift_wp_lightweight_seo_meta', __( 'Header SEO Meta tags' ) )
				->set_rows(20)
		...
		function wp_lightweight_option_attach_theme_options() {
			Container::make( 'theme_options', __( 'LIFT Configure' ) )
				->set_page_menu_title( 'LIFT Configure' )
				...
				->add_tab( __( 'Login Screen' ), array(
					Field::make( 'image', '___lift_wp_lightweight_login_logo', __( 'Login Logo' ) )
					->set_value_type( 'url' )
					->set_visible_in_rest_api( $visible = true )
					->set_width(40),
					Field::make( 'text', '___lift_wp_lightweight_login_logo_width', __( 'Width' ) )
					->set_default_value('300px')
					->set_classes( 'wp-lightweight-cabon-width-class' )
					->set_width(20),
					Field::make( 'text', '___lift_wp_lightweight_login_logo_height', __( 'Height' ) )
					->set_default_value('80px')
					->set_classes( 'wp-lightweight-cabon-width-class' )
					->set_width(20),
					Field::make( 'text', '___lift_wp_lightweight_login_logo_margin', __( 'Margin' ) )
					->set_default_value('30px')
					->set_classes( 'wp-lightweight-cabon-width-class' )
					->set_width(20),
					Field::make( 'image', '___lift_wp_lightweight_login_bg', __( 'Login Background' ) )
					->set_value_type( 'url' )
					->set_visible_in_rest_api( $visible = true )
					->set_width(40),
					Field::make( 'color', '___lift_wp_lightweight_login_bg_color', 'Login Background color' )
					->set_alpha_enabled( true )
					->set_width(30),
					Field::make(
						'select', 
						'___lift_wp_lightweight_login_style',
						__( 'Choose Style' )
					)->set_options( array(
						'default' => 'Default',
						'style-1' => 'Style 1',
				...
				->add_tab( __( 'Images' ), array(
					Field::make( 'html', 'crb_html_1', __( 'Section Description' ) )
						->set_html('With the LIFT WP Configure, you can quickly rename all your image URLs based on the post title.'),
					Field::make(
						'checkbox', 
						'___lift_wp_lightweight_auto_rename_img',
