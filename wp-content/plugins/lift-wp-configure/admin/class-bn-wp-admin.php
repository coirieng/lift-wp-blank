 ...
 * @subpackage LIFT_WP_CONFIGURE/admin
 */
...
class LIFT_WP_CONFIGURE_Admin {
	...
	public function enqueue_styles() {
		 ...
		 * defined in LIFT_WP_CONFIGURE_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The LIFT_WP_CONFIGURE_Loader will then create the relationship
