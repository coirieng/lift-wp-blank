  ...
  return function e(t, n, i) {
    ...
    2: [function (t, e, n) {
      var i = t(4),
        ...
        var e;
        if ("string" == typeof t) {
          if (e = a.getRgba(t)) this.setValues("rgb", e);else if (e = a.getHsla(t)) this.setValues("hsl", e);else {
    ...
    6: [function (e, n, i) {
      !function (e, a) {
        "object" == _typeof(i) && "undefined" != typeof n ? n.exports = a() : "function" == typeof t && t.amd ? t(a) : e.moment = a();
      }(this, function () {
        "use strict";
        ...
        function P(t, e) {
          ...
          for (n in e) {
            d(e, n) && (r(t[n]) && r(e[n]) ? (i[n] = {}, c(i[n], t[n]), c(i[n], e[n])) : null != e[n] ? i[n] = e[n] : delete i[n]);
          }
        ...
        function ut(t, e, n) {
          ...
          if (!this._monthsParse) for (this._monthsParse = [], this._longMonthsParse = [], this._shortMonthsParse = [], i = 0; 12 > i; ++i) {
        ...
        function Wt(t, e, n) {
          var i,
              ...
              r,
              o = t.toLocaleLowerCase();
          if (!this._weekdaysParse) for (this._weekdaysParse = [], this._shortWeekdaysParse = [], this._minWeekdaysParse = [], i = 0; 7 > i; ++i) {
        ...
        function Ut() {
          ...
          for (o.sort(t), s.sort(t), l.sort(t), u.sort(t), e = 0; 7 > e; e++) {
        ...
        function de(t) {
          ...
          if (!t._d) {
            for (i = ue(t), t._w && null == t._a[ra] && null == t._a[aa] && ce(t), t._dayOfYear && (a = le(t._a[ia], i[ia]), t._dayOfYear > vt(a) && (g(t)._overflowDayOfYear = !0), n = kt(a, 0, t._dayOfYear), t._a[aa] = n.getUTCMonth(), t._a[ra] = n.getUTCDate()), e = 0; 3 > e && null == t._a[e]; ++e) {
              t._a[e] = r[e] = i[e];
            }
        ...
        function ce(t) {
          var e, n, i, a, r, o, s, l;
          if (e = t._w, null != e.GG || null != e.W || null != e.E) r = 1, o = 4, n = le(e.GG, t._a[ia], St(xe(), 1, 4).year), i = le(e.W, 1), a = le(e.E, 1), (1 > a || a > 7) && (l = !0);else {
        ...
        function he(e) {
          ...
          for (a = Q(e._f, e._locale).match(Ri) || [], n = 0; n < a.length; n++) {
            r = a[n], i = (s.match(tt(r, e)) || [])[0], i && (o = s.substr(0, s.indexOf(i)), o.length > 0 && g(e).unusedInput.push(o), s = s.slice(s.indexOf(i) + i.length), u += i.length), Vi[r] ? (i ? g(e).empty = !1 : g(e).unusedTokens.push(r), rt(r, i, e)) : e._strict && !i && g(e).unusedTokens.push(r);
          }
        ...
        function ge(t) {
          ...
          for (a = 0; a < t._f.length; a++) {
            r = 0, e = b({}, t), null != t._useUTC && (e._useUTC = t._useUTC), e._f = t._f[a], he(e), m(e) && (r += g(e).charsLeftOver, r += 10 * g(e).unusedTokens.length, g(e).score = r, (null == i || i > r) && (i = r, n = e));
          }
        ...
        function be(e) {
          ...
          }), de(e)) : "object" == _typeof(n) ? me(e) : s(n) ? e._d = new Date(n) : t.createFromInputFallback(e);
        }
        ...
        function He(t, e) {
          ...
          return Me(t) ? r = {
            ...
            m: Ee(o[7], n),
            s: Ee(o[8], n)
          }) : null == r ? r = {} : "object" == _typeof(r) && ("from" in r || "to" in r) && (a = je(xe(r.from), xe(r.to)), r = {}, r.ms = a.milliseconds, r.M = a.months), i = new Se(r), Me(t) && d(t, "_locale") && (i._locale = t._locale), i;
        }
        ...
        t.defaults.bar = {
          ...
          updateElement: function updateElement(t, n, i) {
            ...
            t._model = {
              ...
              var l = [[n.base, r], [n.base, a], [o, a], [o, r]],
        ...
        t.defaults.bubble = {
          ...
          updateElement: function updateElement(n, i, a) {
            ...
            e.extend(n, {
              ...
              _index: i,
              _model: {
                x: a ? s.getPixelForDecimal(.5) : s.getPixelForValue("object" == _typeof(c) ? c : NaN, i, f, r.chart.isCombo),
      ...
      e.exports = function (t) {
        ...
        t.defaults.line = {
          ...
          update: function update(t) {
            ...
            }, l.pivot()), i = 0, a = u.length; a > i; ++i) {
              o.updateElement(u[i], i, t);
            }

            for (g && 0 !== l._model.tension && o.updateBezierControlPoints(), i = 0, a = u.length; a > i; ++i) {
              u[i].pivot();
            }
          },
          ...
          updateElement: function updateElement(t, e, i) {
            ...
            void 0 !== u.radius && void 0 === u.pointRadius && (u.pointRadius = u.radius), void 0 !== u.hitRadius && void 0 === u.pointHitRadius && (u.pointHitRadius = u.hitRadius), a = f.getPixelForValue("object" == _typeof(c) ? c : NaN, e, d, p), r = i ? h.getBasePixel() : o.calculatePointY(c, e, d), t._xScale = f, t._yScale = h, t._datasetIndex = d, t._index = e, t._model = {
              x: a,
              y: r,
          ...
          updateBezierControlPoints: function updateBezierControlPoints() {
            ...
            })), "monotone" === l.dataset._model.cubicInterpolationMode) n.splineCurveMonotone(d);else for (e = 0, i = d.length; i > e; ++e) {
            ...
            if (s.chart.options.elements.line.capBezierPoints) for (e = 0, i = d.length; i > e; ++e) {
          ...
          draw: function draw(t) {
            ...
            for (e(a.getDataset(), a.chart.options) && r.dataset.transition(s).draw(), n = 0, i = o.length; i > n; ++n) {
              o[n].draw();
            }
          },
          setHoverStyle: function setHoverStyle(t) {
    ...
    19: [function (t, e, n) {
      ...
      e.exports = function (t) {
        ...
        t.defaults.polarArea = {
          ...
          updateElement: function updateElement(t, n, i) {
            for (var a = this, r = a.chart, o = a.getDataset(), s = r.options, l = s.animation, u = r.scale, d = e.getValueAtIndexOrDefault, c = r.data.labels, h = a.calculateCircumference(o.data[n]), f = u.xCenter, g = u.yCenter, m = 0, p = a.getMeta(), v = 0; n > v; ++v) {
    ...
    22: [function (t, e, n) {
      ...
      e.exports = function (t) {
        ...
        e.drawPoint = function (t, e, n, i, a) {
          var r, o, s, l, u, d;
          if ("object" == _typeof(e) && (r = e.toString(), "[object HTMLImageElement]" === r || "[object HTMLCanvasElement]" === r)) return void t.drawImage(e, i - e.width / 2, a - e.height / 2);
        ...
        t.types = {}, t.instances = {}, t.controllers = {}, t.Controller = function (e, n, i) {
          ...
          destroy: function destroy() {
            ...
            for (r.stop(), n = 0, a = r.data.datasets.length; a > n; ++n) {
              e = r.getDatasetMeta(n), e.controller && (e.controller.destroy(), e.controller = null);
            }
        ...
        t.elements = {}, t.Element = function (t) {
          ...
          transition: function transition(t) {
            ...
            return n._view || (n._view = e.clone(n._model)), 1 === t ? (n._view = n._model, n._start = null, n) : (n._start || n.pivot(), e.each(n._model, function (i, a) {
              if ("_" === a[0]) ;else if (n._view.hasOwnProperty(a)) {
                if (i === n._view[a]) ;else if ("string" == typeof i) try {
    ...
    26: [function (t, e, n) {
      ...
      e.exports = function (t) {
        ...
        r.each = function (t, e, n, i) {
          ...
          for (e = 0; s > e; ++e) {
            i = o[e], i.model.skip || (n = e > 0 ? o[e - 1] : null, a = s - 1 > e ? o[e + 1] : null, a && !a.model.skip && (i.deltaK = (a.model.y - i.model.y) / (a.model.x - i.model.x)), !n || n.model.skip ? i.mK = i.deltaK : !a || a.model.skip ? i.mK = n.deltaK : this.sign(n.deltaK) !== this.sign(i.deltaK) ? i.mK = 0 : i.mK = (n.deltaK + i.deltaK) / 2);
          }

          var l, u, d, c;

          for (e = 0; s - 1 > e; ++e) {
            i = o[e], a = o[e + 1], i.model.skip || a.model.skip || (r.almostEquals(i.deltaK, 0, this.EPSILON) ? i.mK = a.mK = 0 : (l = i.mK / i.deltaK, u = a.mK / i.deltaK, c = Math.pow(l, 2) + Math.pow(u, 2), 9 >= c || (d = 3 / Math.sqrt(c), i.mK = l * d * i.deltaK, a.mK = u * d * i.deltaK)));
          }

          var h;

          for (e = 0; s > e; ++e) {
            i = o[e], i.model.skip || (n = e > 0 ? o[e - 1] : null, a = s - 1 > e ? o[e + 1] : null, n && !n.model.skip && (h = (i.model.x - n.model.x) / 3, i.model.controlPointPreviousX = i.model.x - h, i.model.controlPointPreviousY = i.model.y - h * i.mK), a && !a.model.skip && (h = (a.model.x - i.model.x) / 3, i.model.controlPointNextX = i.model.x + h, i.model.controlPointNextY = i.model.y + h * i.mK));
          }
      ...
      e.exports = function (t) {
        ...
        t.Interaction = {
          modes: {
            ...
            label: a,
            index: a,
            dataset: function dataset(t, e, a) {
              var o = r.getRelativePosition(e, t.chart),
        ...
        t.defaults.global.legend = {
          ...
          fit: function fit() {
            var i = this,
                ...
                m = i.minSize,
                p = i.isHorizontal();
            if (p ? (m.width = i.maxWidth, m.height = o ? 10 : 0) : (m.width = o ? 10 : 0, m.height = i.maxHeight), o) if (s.font = f, p) {
          ...
          handleEvent: function handleEvent(t) {
            ...
            var o = n.getRelativePosition(t, e.chart.chart),
                s = o.x,
                l = o.y;
            if (s >= e.left && s <= e.right && l >= e.top && l <= e.bottom) for (var u = e.legendHitBoxes, d = 0; d < u.length; ++d) {
              var c = u[d];
        ...
        t.defaults.scale = {
          ...
          draw: function draw(n) {
            ...
            if (a.display) {
              ...
              if (g) {
                if (r = !1, h && (I /= 2), (I + u.autoSkipPadding) * i.ticks.length > i.width - (i.paddingLeft + i.paddingRight) && (r = 1 + Math.floor((I + u.autoSkipPadding) * i.ticks.length / (i.width - (i.paddingLeft + i.paddingRight)))), o && i.ticks.length > o) for (; !r || i.ticks.length / (r || 1) > o;) {
                  r || (r = 1), r += 1;
                }
                f || (r = !1);
              }
              ...
              if (e.each(i.ticks, function (t, o) {
                ...
                if (d.display && (s.save(), s.lineWidth = t.glWidth, s.strokeStyle = t.glColor, s.setLineDash && (s.setLineDash(t.glBorderDash), s.lineDashOffset = t.glBorderDashOffset), s.beginPath(), d.drawTicks && (s.moveTo(t.tx1, t.ty1), s.lineTo(t.tx2, t.ty2)), d.drawOnChartArea && (s.moveTo(t.x1, t.y1), s.lineTo(t.x2, t.y2)), s.stroke(), s.restore()), u.display) {
                  ...
                  var n = t.label;
                  if (e.isArray(n)) for (var i = 0, a = -(n.length - 1) * p * .75; i < n.length; ++i) {
                ...
                var W,
                    V,
                    Y = 0;
                if (g) W = i.left + (i.right - i.left) / 2, V = "bottom" === a.position ? i.bottom - S / 2 : i.top + S / 2;else {
    ...
    36: [function (t, e, n) {
      ...
      e.exports = function (t) {
        ...
        t.defaults.global.tooltips = {
          ...
          drawCaret: function drawCaret(t, n, i) {
            var a,
                r,
                o,
                s,
          ...
          inRange: function inRange(t, n) {
            ...
            if (i) {
              for (var a = e.getAngleFromPoint(i, {
                x: t,
                y: n
              }), r = a.angle, o = a.distance, s = i.startAngle, l = i.endAngle; s > l;) {
                l += 2 * Math.PI;
              }
          ...
          draw: function draw() {
            ...
            if (u.length && a.fill) {
              for (l.beginPath(), c = 0; c < u.length; ++c) {
                h = u[c], f = e.previousItem(u, c), g = h._view, 0 === c ? (s ? l.moveTo(o.x, o.y) : l.moveTo(g.x, o), g.skip || (d = c, l.lineTo(g.x, g.y))) : (f = -1 === d ? f : u[d], g.skip ? r || d !== c - 1 || (s ? l.lineTo(o.x, o.y) : l.lineTo(f._view.x, o)) : (d !== c - 1 ? r && -1 !== d ? t(f, h) : s ? l.lineTo(g.x, g.y) : (l.lineTo(g.x, o), l.lineTo(g.x, g.y)) : t(f, h), d = c));
              }
        ...
        i.elements.rectangle = {
          ...
          draw: function draw() {
            ...
            var e = this._chart.ctx,
                ...
                s = n.borderWidth / 2;
            n.borderWidth && (a += s, r -= s, o += s), e.beginPath(), e.fillStyle = n.backgroundColor, e.strokeStyle = n.borderColor, e.lineWidth = n.borderWidth;
            var l = [[a, n.base], [a, o], [r, o], [r, n.base]],
                u = ["bottom", "left", "top", "right"],
                d = u.indexOf(n.borderSkipped, 0);
            -1 === d && (d = 0);
            var c = t(0);
        ...
        var e = t.helpers,
          ...
          determineDataLimits: function determineDataLimits() {
            ...
            t.chart.data.labels && t.chart.data.labels.length > 0 ? (e.each(t.chart.data.labels, function (e) {
              ...
              "object" == _typeof(a.data[0]) && null !== a.data[0] ? e.each(a.data, function (e) {
          ...
          getLabelForIndex: function getLabelForIndex(t, e) {
            ...
            return "object" == _typeof(n.chart.data.datasets[e].data[0]) && (i = n.getRightValue(n.chart.data.datasets[e].data[t])), n.options.time.tooltipFormat && (i = n.parseTime(i).format(n.options.time.tooltipFormat)), i;
          },
          tickFormatFunction: function tickFormatFunction(t, n, i) {
