...
(function (root, factory) {
  ...
  function unbindEl(el) {
    ...
    el['data-simple-scrollbar'].unBind(); //Remove the elements property
  ...
  function ss(el) {
    ...
    this.bar = '<div class="ss-scroll">'; //Create a reference to the function binding to remove the event listeners
    ...
    this.unBind = function () {
      ...
      this.target.classList.remove('ss-container'); //Unwrap the initial content and remove remaining wrappers

      this.target.insertBefore(this.content, this.wrapper);
      this.target.removeChild(this.wrapper); //Remove the bar including its drag-dealer event listener
