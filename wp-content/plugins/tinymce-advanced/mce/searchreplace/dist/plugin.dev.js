...
(function () {
  var searchreplace = function () {
    ...
    var markAllMatches = function markAllMatches(editor, currentIndexState, regex) {
      var node, marker;
    ...
    var moveSelection = function moveSelection(editor, currentIndexState, forward) {
    ...
    var find = function find(editor, currentIndexState, text, matchCase, wholeWord) {
      text = text.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, '\\$&');
    ...
    var next = function next(editor, currentIndexState) {
    ...
    var prev = function prev(editor, currentIndexState) {
    ...
    var replace = function replace(editor, currentIndexState, text, forward, all) {
      var i,
          nodes,
          node,
          matchIndex,
    ...
    var done = function done(editor, currentIndexState, keepEditorSelection) {
    ...
    var hasNext = function hasNext(editor, currentIndexState) {
      return findSpansByIndex(editor, currentIndexState.get() + 1).length > 0;
    };

    var hasPrev = function hasPrev(editor, currentIndexState) {
      return findSpansByIndex(editor, currentIndexState.get() - 1).length > 0;
    };
    ...
    var get = function get(editor, currentIndexState) {
      var done = function done(keepEditorSelection) {
        return Actions.done(editor, currentIndexState, keepEditorSelection);
      };

      var find = function find(text, matchCase, wholeWord) {
      ...
      var replace = function replace(text, forward, all) {
    ...
    var open = function open(editor, currentIndexState) {
      var last = {},
          selectedText;
    ...
    var register = function register(editor, currentIndexState) {
    ...
    var showDialog = function showDialog(editor, currentIndexState) {
      return function () {
        Dialog.open(editor, currentIndexState);
      };
    };

    var register$1 = function register$1(editor, currentIndexState) {
