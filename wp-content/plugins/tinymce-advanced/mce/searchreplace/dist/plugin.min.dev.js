...
!function () {
  ...
  var u = {
    findAndReplaceDOMText: function findAndReplaceDOMText(t, n, r, a, i) {
      var o,
          d,
          m,
          f,
      ...
      if (m = n.ownerDocument, f = i.getBlockElements(), p = i.getWhiteSpaceElements(), g = i.getShortEndedElements(), d = function e(t) {
        var n;
        ...
        return c.length && (l = c.length, function (e, t, n) {
          ...
          if ("function" != typeof e) {
            ...
            h = function h(e, t) {
              var n = r.cloneNode(!1);
              return n.setAttribute("data-mce-index", t), e && n.appendChild(m.createTextNode(e)), n;
            };
          } else h = e;
          ...
          return function (e) {
            ...
            if (a === i) {
              var d = a;
              r = d.parentNode, 0 < e.startNodeIndex && (t = m.createTextNode(d.data.substring(0, e.startNodeIndex)), r.insertBefore(t, d));
              var c = h(e.match[0], o);
              return r.insertBefore(c, d), e.endNodeIndex < d.length && (n = m.createTextNode(d.data.substring(e.endNodeIndex)), r.insertBefore(n, d)), d.parentNode.removeChild(d), c;
            }

            t = m.createTextNode(a.data.substring(0, e.startNodeIndex)), n = m.createTextNode(i.data.substring(e.endNodeIndex));

            for (var l = h(a.data.substring(e.startNodeIndex), o), s = 0, u = e.innerNodes.length; s < u; ++s) {
            ...
            return (r = a.parentNode).insertBefore(t, a), r.insertBefore(l, a), r.removeChild(a), (r = i.parentNode).insertBefore(g, i), r.insertBefore(n, i), r.removeChild(i), g;
          };
        }(r))), l;
      }
    }
    ...
    find: function find(e, t, n, r, a) {
      ...
      var i,
          ...
          c,
          l,
          s = (i = e, o = t, d = new RegExp(n, r ? "g" : "gi"), (l = i.dom.create("span", {
        "data-mce-bogus": 1
    ...
    next: x,
    prev: b,
    replace: function replace(e, t, n, r, a) {
      var i,
          o,
          d,
          c,
