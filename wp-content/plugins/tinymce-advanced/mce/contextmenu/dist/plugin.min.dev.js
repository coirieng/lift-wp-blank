...
!function () {
  ...
  var o = function o(t) {
    ...
    return {
      ...
      i = function i(t) {
    return {
      isContextMenuVisible: function isContextMenuVisible() {
        return t.get();
      }
    };
  },
    ...
    var e,
        ...
        r,
        u,
        c = (e = t.getContentAreaContainer(), o = a((r = n).clientX, r.clientY), i = l.DOM.getPos(e), f(o, i.x, i.y));
    return m(s(t), c);
  },
      g = tinymce.util.Tools.resolve("tinymce.ui.Factory"),
      v = tinymce.util.Tools.resolve("tinymce.util.Tools"),
      y = function y(t, n, e, o) {
