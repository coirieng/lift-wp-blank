	...
	"use strict";
		...
		*/
		function initSF() {
			...
			if( nectarOptions && nectarOptions.ocm_remove_ext_menu_items && nectarOptions.ocm_remove_ext_menu_items == 'remove_images' ) {
		...
		*/
		function productCarouselInit() {
			...
			$('.nectar-woo-flickity').each(function (i) {
				...
				if( nectarOptions && nectarOptions.woo_related_upsell_carousel && nectarOptions.woo_related_upsell_carousel == 'true' && $(this).hasClass('related-upsell-carousel') ) {
					relatedUpsell = true;
					carouselWrap  = false;
					groupCellsBool = true;
			...
			*/
			function nectarPostGridInit() {
				...
				*/
				function OCM_slideOutRightHoverOpen() {
					...
					var alignmentPosition = (nectarOptions && nectarOptions.mobile_header_format && nectarOptions.mobile_header_format === 'centered-menu' && withinCustomBreakpoint) ? 'left' : 'right';
				...
				*/
				function clickToggleSubmenus() {
					...
					var lh_dropdown_func = ( nectarOptions && nectarOptions.left_header_dropdown_func ) ? nectarOptions.left_header_dropdown_func : 'default';
				...
				*/
				function wooCommerceEvents() {
					...
					$('.nectar-post-grid[data-shadow-hover="yes"]').length > 0) {
						...
						if( nectarOptions && nectarOptions.woo_minimal_product_effect && nectarOptions.woo_minimal_product_effect === 'default' ) {
					...
					function minimalProductHover() {
						...
						if( bindMobileHover && nectarOptions && nectarOptions.woo_minimal_product_effect && nectarOptions.woo_minimal_product_effect === 'default' ) {
					...
					$body.on('click', '#sidebar .widget.woocommerce:not(.widget_price_filter) h4', function () {
						...
						if(nectarOptions && nectarOptions.woo_sidebar_toggles !== 'false') {
					...
					// AJAX add to cart.
					if( nectarOptions && nectarOptions.ajax_add_to_cart === '1' ) {
						var ajaxAddToCart = new NectarWooCommerceCartAJAX();
					}

					if( nectarOptions && nectarOptions.woo_product_filter_toggle === '1' && $body.is('.archive.woocommerce') ) {
		     ...
		     */
				...
				function navigationSearchInit() {
					...
					if( nectarOptions && nectarOptions.quick_search && nectarOptions.quick_search === 'true' ) {
				...
				*/
				function stickySidebarInit() {
					...
					if( nectarOptions && nectarOptions.woo_sticky_sidebar && nectarOptions.woo_sticky_sidebar === '1' ) {
				...
				function select2Init() {
					...
					$('select:not(.state_select):not(.country_select):not(.comment-form-rating #rating):not(#tribe-bar-form select):not(.woocommerce-currency-switcher):not(.nectar-custom-product-attr select)').each(function () {
						...
						if ($(this).parents('#buddypress').length == 0) {
							...
							var woo_product_dropdown_style = (nectarOptions && nectarOptions.woo_product_variable_select ) ? nectarOptions.woo_product_variable_select : 'default';
