...
function lift_styles() {
	...
	$layout_size = $wow_theme['lift-theme-layout-size'];
	$layout_size_value = $wow_theme['lift-theme-layout-size-value'];
	$layout_scrollbar = $wow_theme['lift-theme-global-style-theme-scrollbar'];
	...
	$header_size = $wow_theme['lift-theme-header-layout-size'];
	$header_size_value = $wow_theme['lift-theme-header-layout-size-value'];
	$header_style_animation = $wow_theme['lift-theme-header-style-bg-animation'];
	...
	// CONTENT 
	$content_row = $wow_theme['lift-theme-layout-row-option'];
	$content_row_value = $wow_theme['lift-theme-layout-row-spacing'];
	$content_content = $wow_theme['lift-theme-layout-content-option'];
	$content_content_value = $wow_theme['lift-theme-layout-content-spacing'];
	...
	// BLOG
	$blog_columns_padding = $wow_theme['lift-theme-blog-style-content-columns-padding'];
	$blog_sidebar_columns_padding = $wow_theme['lift-theme-blog-style-sidebar-columns-padding'];
	...
	// ARCHIVE
	$archive_columns_padding = $wow_theme['lift-theme-blog-style-archive-content-columns-padding'];
	$archive_sidebar_columns_padding = $wow_theme['lift-theme-blog-style-archive-sidebar-columns-padding'];
	...
	$footer_size = $wow_theme['lift-theme-footer-layout-size'];
	$footer_size_value = $wow_theme['lift-theme-footer-layout-size-value'];
	$footer_fixed = $wow_theme['lift-theme-footer-layout-fixed'];
	...
	// BACKTOTOP
	$global_backtotop = $wow_theme['lift-theme-global-function-backtotop-spacing'];
	if($global_backtotop) {
	...
	// LAYOUT 
	$theme_style = $wow_theme['lift-theme-global-style-theme'];
