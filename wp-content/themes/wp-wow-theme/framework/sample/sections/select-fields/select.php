...
Redux::set_section(
	...
	array(
		...
		'id'         => 'select-select',
		'desc'       => esc_html__( 'For full documentation on this field, visit: ', 'your-textdomain-here' ) . '<a href="https://devs.wow-wp.com/core-fields/select.html" target="_blank">https://devs.wow-wp.com/core-fields/select.html</a>',
		'subsection' => true,
		'fields'     => array(
			array(
				'id'       => 'opt-select',
