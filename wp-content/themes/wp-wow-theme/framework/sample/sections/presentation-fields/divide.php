...
Redux::set_section(
	...
	array(
		...
		'desc'       => esc_html__( 'The spacer to the section menu as seen to the left (after this section block) is the divide "section". Also the divider below is the divide "field".', 'your-textdomain-here' ) . '<br />' . __( 'For full documentation on this field, visit: ', 'your-textdomain-here' ) . '<a href="https://devs.wow-wp.com/core-fields/divide.html" target="_blank">https://devs.wow-wp.com/core-fields/divide.html</a>',
		'subsection' => true,
		'fields'     => array(
			array(
				'id'   => 'opt-divide',
